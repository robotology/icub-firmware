...
typedef struct
{
    ...
    void*                               thenvs_vol;
    void*                               thenvs_rem;
    eOvoid_fp_uint16_voidp_voidp_t      thenvs_initialise;  // ep, vol, rem
    eOvoid_fp_uint16_voidp_voidp_t      thenvs_ramretrieve; // ep, vol, rem
    uint32_t                            thenvs_sizeof;
    eOuint16_fp_uint16_uint16_t         hashfn_epid2nvprogressivenumber;
    eOvoidp_fp_voidp_uint16_uint16_t    hashfn_dataepid2nvram;    
    eOvoidp_fp_uint16_uint16_t          hashfn_epid2nvrom; 
