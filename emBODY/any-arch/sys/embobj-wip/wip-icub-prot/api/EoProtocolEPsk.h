...
/** @fn         extern eObool_t eoprot_ep_sk_variables_id_isvalid(eOprotBRD_t brd, eOprotID32_t id)
...
/** @fn         extern eOprotID32_t eoprot_ep_sk_variable_idfromprognumber_Get(eOprotBRD_t brd, eOprotPROGnum_t prog)
...
/** @fn         extern eOprotPROGnum_t eoprot_ep_sk_variable_progressivenumber_Get(eOprotBRD_t brd, eOprotID32_t id)
