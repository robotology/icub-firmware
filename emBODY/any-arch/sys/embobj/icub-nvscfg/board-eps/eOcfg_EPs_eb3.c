...
const EOconstvector* const eo_cfg_EPs_vectorof_eb3 = &s_eo_cfg_EPs_vectorof_eb3;

const eOuint16_fp_uint16_t eo_cfg_nvsEP_eb3_fptr_hashfunction_ep2index = s_eo_cfg_nvsEP_eb3_hashfunction_ep2index;
