...
extern const EOconstvector eo_cfg_EPs_vectorof_eb5_object = 
{
...
const EOconstvector* const eo_cfg_EPs_vectorof_eb5 = &eo_cfg_EPs_vectorof_eb5_object;

const eOuint16_fp_uint16_t eo_cfg_nvsEP_eb5_fptr_hashfunction_ep2index = eo_cfg_nvsEP_eb5_hashfunction_ep2index;
...
extern uint16_t eo_cfg_nvsEP_eb5_hashfunction_ep2index(uint16_t ep)
{
