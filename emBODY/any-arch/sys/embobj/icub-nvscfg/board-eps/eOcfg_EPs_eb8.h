...
// - include guard ----------------------------------------------------------------------------------------------------
#ifndef _EOCFG_EPS_EB8_H_
#define _EOCFG_EPS_EB8_H_
...
/** @file       eOcfg_EPs_eb8.h
	@brief      This header file contains a const configuration for the endpoints of board EB6 (right leg, upper)
...
// if not NULL it contains a mapping from EPs to index inside eo_cfg_EPs_vectorof_eb8
...
/** @fn         extern void* eo_cfg_nvsEP_eb8_Get_remotelyownedRAM(eOnvEP_t ep, eOnvscfgOwnership_t ownership)
...
/** @fn         extern void* eo_cfg_nvsEP_eb8_Get_locallyownedRAM(eOnvEP_t ep)
