...
// endpoint mn
static void s_eoprot_b01_mn_ram_initialise(eOprotIP_t ip, void *ram);

// endpoint mc
static void s_eoprot_b01_mc_ram_initialise(eOprotIP_t ip, void *ram);

// endpoint as
static void s_eoprot_b01_as_ram_initialise(eOprotIP_t ip, void *ram);
...
{  
    {   // management
        ...
        EO_INIT(.fptr_getnvsnumberof)               eoprot_mn_numberofvariables_get,
        EO_INIT(.fptr_isidsupported)                eoprot_mn_id_isvalid,
        EO_INIT(.fptr_getid)                        eoprot_mn_prognum2id,
        EO_INIT(.fptr_getnvprognumber)              eoprot_mn_id2prognum,
        EO_INIT(.fptr_getnvrom)                     eoprot_mn_eonvrom_get,
        EO_INIT(.fptr_getnvram)                     eoprot_mn_ramofvariable_extract, 
        EO_INIT(.fptr_initialise)                   s_eoprot_b01_mn_ram_initialise
    },        
    ...
    {   // motion-control         
        ...
        EO_INIT(.fptr_getnvsnumberof)               eoprot_mc_numberofvariables_get,
        EO_INIT(.fptr_isidsupported)                eoprot_mc_id_isvalid,
        EO_INIT(.fptr_getid)                        eoprot_mc_prognum2id,
        EO_INIT(.fptr_getnvprognumber)              eoprot_mc_id2prognum,
        EO_INIT(.fptr_getnvrom)                     eoprot_mc_eonvrom_get,
        EO_INIT(.fptr_getnvram)                     eoprot_mc_ramofvariable_extract, 
        EO_INIT(.fptr_initialise)                   s_eoprot_b01_mc_ram_initialise        
    },
    ...
    {   // analog-sensors         
        ...
        EO_INIT(.fptr_getnvsnumberof)               eoprot_as_numberofvariables_get,
        EO_INIT(.fptr_isidsupported)                eoprot_as_id_isvalid,
        EO_INIT(.fptr_getid)                        eoprot_as_prognum2id,
        EO_INIT(.fptr_getnvprognumber)              eoprot_as_id2prognum,
        EO_INIT(.fptr_getnvrom)                     eoprot_as_eonvrom_get,
        EO_INIT(.fptr_getnvram)                     eoprot_as_ramofvariable_extract, 
        EO_INIT(.fptr_initialise)                   s_eoprot_b01_as_ram_initialise                
    }  
...
static void s_eoprot_b01_mn_ram_initialise(eOprotIP_t ip, void *ram)
{
    // 1. assign the ram of the endpoint
    eoprot_config_endpoint_ram(eoprot_b01_boardnumber, eoprot_endpoint_management, sizeof(eOprot_b01_management_t), ram);
        
    // 2. initialise the values of the ram   
    eoprot_fun_INITIALISE_mn(ip, ram);
}
...
{
    // 1. assign the ram of the endpoint
    eoprot_config_endpoint_ram(eoprot_b01_boardnumber, eoprot_endpoint_motioncontrol, sizeof(eOprot_b01_motioncontrol_t), ram);
        
    // 2. initialise the values of the ram   
    eoprot_fun_INITIALISE_mc(ip, ram);
}
...
{
    // 1. assign the ram of the endpoint
    eoprot_config_endpoint_ram(eoprot_b01_boardnumber, eoprot_endpoint_analogsensors, sizeof(eOprot_b01_analogsensors_t), ram);
          
    // 2. initialise the values of the ram   
    eoprot_fun_INITIALISE_as(ip, ram);
}
