...
#if !defined(OVERRIDE_eoprot_fun_INIT_mc_joint_config_minpositionofjoint)
__weak extern void eoprot_fun_INIT_mc_joint_config_minpositionofjoint(const EOnv* nv) {}
#endif

#if !defined(OVERRIDE_eoprot_fun_UPDT_mc_joint_config_minpositionofjoint)
__weak extern void eoprot_fun_UPDT_mc_joint_config_minpositionofjoint(const EOnv* nv, const eOropdescriptor_t* rd) {}
#endif
   

#if !defined(OVERRIDE_eoprot_fun_INIT_mc_joint_config_maxpositionofjoint)
__weak extern void eoprot_fun_INIT_mc_joint_config_maxpositionofjoint(const EOnv* nv) {}
#endif

#if !defined(OVERRIDE_eoprot_fun_UPDT_mc_joint_config_maxpositionofjoint)
__weak extern void eoprot_fun_UPDT_mc_joint_config_maxpositionofjoint(const EOnv* nv, const eOropdescriptor_t* rd) {}
#endif


#if !defined(OVERRIDE_eoprot_fun_INIT_mc_joint_config_velocitysetpointtimeout)
__weak extern void eoprot_fun_INIT_mc_joint_config_velocitysetpointtimeout(const EOnv* nv) {}
#endif

#if !defined(OVERRIDE_eoprot_fun_UPDT_mc_joint_config_velocitysetpointtimeout)
__weak extern void eoprot_fun_UPDT_mc_joint_config_velocitysetpointtimeout(const EOnv* nv, const eOropdescriptor_t* rd) {}
#endif
...
#if !defined(OVERRIDE_eoprot_fun_INIT_mc_joint_config_encoderconversionfactor)
__weak extern void eoprot_fun_INIT_mc_joint_config_encoderconversionfactor(const EOnv* nv) {}
#endif

#if !defined(OVERRIDE_eoprot_fun_UPDT_mc_joint_config_encoderconversionfactor)
__weak extern void eoprot_fun_UPDT_mc_joint_config_encoderconversionfactor(const EOnv* nv, const eOropdescriptor_t* rd) {}
#endif


#if !defined(OVERRIDE_eoprot_fun_INIT_mc_joint_config_encoderconversionoffset)
__weak extern void eoprot_fun_INIT_mc_joint_config_encoderconversionoffset(const EOnv* nv) {}
#endif

#if !defined(OVERRIDE_eoprot_fun_UPDT_mc_joint_config_encoderconversionoffset)
__weak extern void eoprot_fun_UPDT_mc_joint_config_encoderconversionoffset(const EOnv* nv, const eOropdescriptor_t* rd) {}
#endif
...
#if !defined(OVERRIDE_eoprot_fun_INIT_mc_joint_status_chamaleon04)
__weak extern void eoprot_fun_INIT_mc_joint_status_chamaleon04(const EOnv* nv) {}
#endif

#if !defined(OVERRIDE_eoprot_fun_UPDT_mc_joint_status_chamaleon04_updt)
__weak extern void eoprot_fun_UPDT_mc_joint_status_chamaleon04(const EOnv* nv, const eOropdescriptor_t* rd) {}
#endif
...
__weak extern void eoprot_fun_INIT_mc_motor_config_pidcurrent(const EOnv* nv) {}
#endif

#if !defined(OVERRIDE_eoprot_fun_UPDT_mc_motor_config_pidcurrent)
__weak extern void eoprot_fun_UPDT_mc_motor_config_pidcurrent(const EOnv* nv, const eOropdescriptor_t* rd) {}
#endif

#if !defined(OVERRIDE_eoprot_fun_INIT_mc_motor_config_maxvelocityofmotor)
__weak extern void eoprot_fun_INIT_mc_motor_config_maxvelocityofmotor(const EOnv* nv) {}
#endif

#if !defined(OVERRIDE_eoprot_fun_UPDT_mc_motor_config_maxvelocityofmotor)
__weak extern void eoprot_fun_UPDT_mc_motor_config_maxvelocityofmotor(const EOnv* nv, const eOropdescriptor_t* rd) {}
#endif
...
#if !defined(OVERRIDE_eoprot_fun_INIT_mc_motor_status_chamaleon04)
__weak extern void eoprot_fun_INIT_mc_motor_status_chamaleon04(const EOnv* nv) {}
#endif

#if !defined(OVERRIDE_eoprot_fun_UPDT_mc_motor_status_chamaleon04)
__weak extern void eoprot_fun_UPDT_mc_motor_status_chamaleon04(const EOnv* nv, const eOropdescriptor_t* rd) {}
#endif   
...
#if !defined(OVERRIDE_eoprot_fun_INIT_mc_controller_config_durationofctrlloop)
__weak extern void eoprot_fun_INIT_mc_controller_config_durationofctrlloop(const EOnv* nv) {}
#endif

#if !defined(OVERRIDE_eoprot_fun_UPDT_mc_controller_config_durationofctrlloop)
__weak extern void eoprot_fun_UPDT_mc_controller_config_durationofctrlloop(const EOnv* nv, const eOropdescriptor_t* rd) {}
#endif
...
#if !defined(OVERRIDE_eoprot_fun_INIT_mc_controller_status_alljomoinitted)
__weak extern void eoprot_fun_INIT_mc_controller_status_alljomoinitted(const EOnv* nv) {}
#endif

#if !defined(OVERRIDE_eoprot_fun_UPDT_mc_controller_status_alljomoinitted)
__weak extern void eoprot_fun_UPDT_mc_controller_status_alljomoinitted(const EOnv* nv, const eOropdescriptor_t* rd) {}
#endif

#if !defined(OVERRIDE_eoprot_fun_INIT_mc_controller_cmmnds_go2stateofcontroller)
__weak extern void eoprot_fun_INIT_mc_controller_cmmnds_go2stateofcontroller(const EOnv* nv) {}
#endif

#if !defined(OVERRIDE_eoprot_fun_UPDT_mc_controller_cmmnds_go2stateofcontroller)
__weak extern void eoprot_fun_UPDT_mc_controller_cmmnds_go2stateofcontroller(const EOnv* nv, const eOropdescriptor_t* rd) {}
#endif
