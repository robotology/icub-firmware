...
static EOMtheEMSapplCfg s_emsapplcfg_singleton = 
{
    ...
    {   // the same ipv4 addr and port as in applcfg ...
        ...
        .transprotection        = eo_trans_protection_enabled, //eo_trans_protection_none,
        .nvscfgprotection       = eo_nvscfg_protection_one_per_endpoint //eo_nvscfg_protection_none // eo_nvscfg_protection_one_per_netvar eo_nvscfg_protection_one_per_endpoint
    },
    .errobjcfg      =
    {
