...
#include "eOcfg_emsCanNetworkTopology.h"
      ...
      #include    "eOcfg_emsCanNetworkTopology_eb1.c"
 #elif   defined(EOMTHEEMSAPPLCFG_USE_EB2)
      #include    "eOcfg_emsCanNetworkTopology_eb2.c"  
#elif   defined(EOMTHEEMSAPPLCFG_USE_EB3)
      #include    "eOcfg_emsCanNetworkTopology_eb3.c"
#elif   defined(EOMTHEEMSAPPLCFG_USE_EB4)
      #include    "eOcfg_emsCanNetworkTopology_eb4.c"
#elif   defined(EOMTHEEMSAPPLCFG_USE_EB5)
      #include    "eOcfg_emsCanNetworkTopology_eb5.c" 
#elif  defined(EOMTHEEMSAPPLCFG_USE_EB6)
      #include    "eOcfg_emsCanNetworkTopology_eb6.c"
#elif   defined(EOMTHEEMSAPPLCFG_USE_EB7)
      #include    "eOcfg_emsCanNetworkTopology_eb7.c"
#elif   defined(EOMTHEEMSAPPLCFG_USE_EB8)
      #include    "eOcfg_emsCanNetworkTopology_eb8.c"
#elif   defined(EOMTHEEMSAPPLCFG_USE_EB9)
      #include    "eOcfg_emsCanNetworkTopology_eb9.c"
#else
