...
//per ora non usate: servono???

// extern eOresult_t eo_appTheCanBrdsMng_ConfigAllBoardsOfType(EOappTheCanBrdsMng *p, eObrd_types_t boardtype);

// extern eOresult_t eo_appTheCanBrdsMng_StartAllBoardsOfType(EOappTheCanBrdsMng *p, eObrd_types_t boardtype);

// extern eOresult_t eo_appTheCanBrdsMng_StopAllBoardsOfType(EOappTheCanBrdsMng *p, eObrd_types_t boardtype);
/** @}            
