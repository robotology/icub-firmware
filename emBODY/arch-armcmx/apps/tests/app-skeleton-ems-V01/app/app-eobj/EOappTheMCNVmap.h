...
/** @fn         extern eOresult_t eo_appTheMCNVmap_GetJointNVMemoryRef(EOappTheMCNVmap* p, eOmc_jointUniqueId_t jUiniqueId, uint8_t nvindex, void**memRef);
    @brief      given jointUnique id and network variable index about joint return a poiter to ram where there is nv's value.
    @param      
    @return     
