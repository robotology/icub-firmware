...
extern const EOconstvector  s_eo_cfg_nvsEP_joint_usr_rem_anydev_constvector_of_EOnv_usr;
...
{              
    ...
    {   // 02-joint
        ...
        EO_INIT(.constvector_of_EOnv_usr)           &s_eo_cfg_nvsEP_joint_usr_rem_board_constvector_of_EOnv_usr, //eo_cfg_nvsEP_mngmnt_usr_loc_board_constvector_of_EOnv_usr,
        EO_INIT(.endpoint_data_init)                eo_cfg_nvsEP_joint_usr_rem_board_initialise
    }        
};
