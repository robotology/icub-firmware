...
{   
    ...
    .extfn                  =
    {
        ...
        .osal_system_scheduling_suspend     = osal_system_scheduling_suspend, //system_scheduling_suspend, //
        .osal_system_scheduling_restart     = osal_system_scheduling_restart   //system_scheduling_resume //
    }
