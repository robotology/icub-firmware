...
/** @fn         extern eOresult_t eo_appCanSP_GetConnectedSkin(EOappCanSP *p, EOfifoWord *connectedSkinList)
    ...
    @return     eores_OK or eores_NOK_nullpointer if p or connectedJointsList are null, or eores_NOK_nodata if no joint are connected to ems
 **/
extern eOresult_t eo_appCanSP_GetConnectedSkin(EOappCanSP *p, EOfifoWord *connectedSkinList);
