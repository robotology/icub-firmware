...
// --------------------------------------------------------------------------------------------------------------------
static eo_icubCanProto_msgCommand_cmdId_t s_eo_icubCanProto_getCmdId_fromFrame_ofPeriodicClass(eOcanframe_t *frame);
static eo_icubCanProto_msgCommand_cmdId_t s_eo_icubCanProto_getCmdId_fromFrame_ofPollingClass(eOcanframe_t *frame);
static eo_icubCanProto_msgCommand_cmdId_t s_eo_icubCanProto_getCmdId_fromFrame_ofSkinClass(eOcanframe_t *frame);
...
__inline static eo_icubCanProto_msgCommand_cmdId_t s_eo_icubCanProto_getCmdId_fromFrame_ofPeriodicClass(eOcanframe_t *frame)
{
    return((eo_icubCanProto_msgCommand_cmdId_t)(frame->id & 0x00F));    

}



__inline static eo_icubCanProto_msgCommand_cmdId_t s_eo_icubCanProto_getCmdId_fromFrame_ofPollingClass(eOcanframe_t *frame)
{
    if(frame->size == 0)
    {
        return(0xFF);
    ...
    return((eo_icubCanProto_msgCommand_cmdId_t)frame->data[0]);
}



__inline static eo_icubCanProto_msgCommand_cmdId_t s_eo_icubCanProto_getCmdId_fromFrame_ofSkinClass(eOcanframe_t *frame)
{
