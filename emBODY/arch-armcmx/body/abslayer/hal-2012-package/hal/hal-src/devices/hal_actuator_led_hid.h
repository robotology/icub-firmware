...
// - include guard ----------------------------------------------------------------------------------------------------
#ifndef _HAL_ACTUATOR_LED_HID_H_
#define _HAL_ACTUATOR_LED_HID_H_


/* @file       hal_stm32_led_hid.h
...
typedef struct
{
    ...
    hal_gpio_cfg_t          gpiocfg[hal_actuator_leds_num];
} hal_actuator_led_hid_brdcfg_t;
