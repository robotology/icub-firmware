...
#include "hal_stm32_sensor_accel_hid.h"
...
static hal_result_t s_hal_sensor_accel_hw_init(const hal_sensor_accel_cfg_t *cfg);

// --------------------------------------------------------------------------------------------------------------------
// - definition (and initialisation) of static variables
// --------------------------------------------------------------------------------------------------------------------

static hal_boolval_t s_hal_sensor_accel_initted[hal_sensor_accel_number] = { hal_false };

static hal_sensor_accel_info_t s_hal_sensor_accel_info[hal_sensor_accel_number] = { 0 };
...
extern hal_result_t hal_sensor_accel_init(hal_sensor_accel_t sensor, const hal_sensor_accel_cfg_t *cfg)
{
    ...
    if(hal_res_OK != s_hal_sensor_accel_hw_init(cfg))
    {
        return(hal_res_NOK_generic);
    }
...
extern hal_result_t hal_sensor_accel_read(hal_sensor_accel_t sensor, hal_sensor_accel_acceleration_t* acceler)
{
    ...
    res = hal_device_st_lis3dh_accel_get(&xac, &yac, &zac);
...
#warning --> put hal_brdcfg_sensor_accel__supported_mask elsewhere
extern const uint8_t hal_brdcfg_sensor_accel__supported_mask = 0x1;

static hal_boolval_t s_hal_sensor_accel_supported_is(hal_sensor_accel_t sensor)
{
    return(hal_base_hid_byte_bitcheck(hal_brdcfg_sensor_accel__supported_mask, HAL_sensor_accel_sensor2index(sensor)) );
}
...
static hal_result_t s_hal_sensor_accel_hw_init(const hal_sensor_accel_cfg_t *cfg)
{
    return(hal_device_st_lis3dh_init(NULL));
}
