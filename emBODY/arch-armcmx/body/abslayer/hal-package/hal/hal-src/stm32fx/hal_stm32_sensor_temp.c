...
#include "hal_stm32_sensor_temp_hid.h"
...
static hal_boolval_t s_hal_sensor_temp_initted[hal_sensor_temp_number] = { hal_false };

static hal_sensor_temp_info_t s_hal_sensor_temp_info[hal_sensor_temp_number] = { 0 };
...
extern hal_result_t hal_sensor_temp_init(hal_sensor_temp_t sensor, const hal_sensor_temp_cfg_t *cfg)
{
    ...
    if(hal_res_OK != s_hal_sensor_temp_hw_init(cfg))
    {
        return(hal_res_NOK_generic);
    }
...
#warning --> put hal_brdcfg_sensor_temp__supported_mask elsewhere
extern const uint8_t hal_brdcfg_sensor_temp__supported_mask = 0x1;

static hal_boolval_t s_hal_sensor_temp_supported_is(hal_sensor_temp_t sensor)
{
    return(hal_base_hid_byte_bitcheck(hal_brdcfg_sensor_temp__supported_mask, HAL_sensor_temp_sensor2index(sensor)) );
}
