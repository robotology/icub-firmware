...
// - include guard ----------------------------------------------------------------------------------------------------
#ifndef _IPAL_TFTP_HID_H_
#define _IPAL_TFTP_HID_H_


/* @file       ipal_tftp_hid.h
	@brief      This file implements hidden interface of the ipal tftp module
...
extern uint8_t ipal_tftp_hid_active;
