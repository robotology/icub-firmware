...
{   
    ...
    EO_INIT(.typ)       EO_nv_TYP(EOK_cfg_nvsEP_mc_jxx_NVFUNTYP__jstatus),
    EO_INIT(.fun)       EO_nv_FUN(EOK_cfg_nvsEP_mc_jxx_NVFUNTYP__jstatus)
};
...
{   
    ...
    EO_INIT(.typ)       EO_nv_TYP(EOK_cfg_nvsEP_mc_jxx_NVFUNTYP__calibrator),
    EO_INIT(.fun)       EO_nv_FUN(EOK_cfg_nvsEP_mc_jxx_NVFUNTYP__calibrator)
};
...
{   
    ...
    EO_INIT(.typ)       EO_nv_TYP(EOK_cfg_nvsEP_mc_jxx_NVFUNTYP__setpoint),
    EO_INIT(.fun)       EO_nv_FUN(EOK_cfg_nvsEP_mc_jxx_NVFUNTYP__setpoint)
};
...
{   
    ...
    EO_INIT(.typ)       EO_nv_TYP(EOK_cfg_nvsEP_mc_jxx_NVFUNTYP__controlmode),
    EO_INIT(.fun)       EO_nv_FUN(EOK_cfg_nvsEP_mc_jxx_NVFUNTYP__controlmode)
};
...
//    EO_INIT(.typ)       EO_nv_TYP(EOK_cfg_nvsEP_mc_jxx_NVFUNTYP_filler03),
//    EO_INIT(.fun)       EO_nv_FUN(EOK_cfg_nvsEP_mc_jxx_NVFUNTYP_filler03)
//};
