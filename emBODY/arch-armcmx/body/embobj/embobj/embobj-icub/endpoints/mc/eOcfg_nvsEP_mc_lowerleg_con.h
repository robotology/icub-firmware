...
/** @typedef    typedef eo_cfg_nvsEP_mc_jointNVindex_t eo_cfg_nvsEP_mc_lowerleg_con_jointNVindex_t
    @brief      It contains an index for all the network variables in a joint of the left leg. use the same type as in bodypart
 **/
typedef eo_cfg_nvsEP_mc_jointNVindex_t eo_cfg_nvsEP_mc_lowerleg_con_jointNVindex_t;
...
/** @fn         extern eOnvID_t eo_cfg_nvsEP_mc_lowerleg_NVID_for_joint_var_Get(eo_cfg_nvsEP_mc_lowerleg_con_jointNumber_t j, eo_cfg_nvsEP_mc_lowerleg_con_jointNVindex_t jnvindex)
...
/** @fn         extern eOnvID_t eo_cfg_nvsEP_mc_lowerleg_NVID_for_motor_var_Get(eo_cfg_nvsEP_mc_lowerleg_con_motorNumber_t m, eo_cfg_nvsEP_mc_lowerleg_con_motorNVindex_t mnvindex)
