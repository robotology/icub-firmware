 ...
 **/
typedef eo_cfg_nvsEP_mc_any_con_bodypart_jointNVindex_t eo_cfg_nvsEP_mc_upperleg_con_jointNVindex_t;
 ...
 **/
typedef eo_cfg_nvsEP_mc_any_con_bodypart_motorNVindex_t eo_cfg_nvsEP_mc_upperleg_con_motorNVindex_t;
