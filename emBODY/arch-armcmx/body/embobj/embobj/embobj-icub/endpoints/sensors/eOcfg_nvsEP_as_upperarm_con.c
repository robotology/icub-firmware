...
extern eOnvID_t eo_cfg_nvsEP_as_upperarm_strain_NVID_Get(eo_cfg_nvsEP_as_upperarm_con_strainNumber_t s, eo_cfg_nvsEP_as_upperarm_con_strainNVindex_t snvindex)
{
    ...
    return(EO_nv_ID(eo_cfg_nvsEP_as_any_con_sxx_funtyp[snvindex], EOK_cfg_nvsEP_as_upperarm_con_NVIDoff_of_strain(s, snvindex)));    
}
...
//    {
        return(EOK_uint16dummy);
//    }
//    return(EO_nv_ID(eo_cfg_nvsEP_as_any_con_mxx_funtyp[mnvindex], EOK_cfg_nvsEP_as_upperarm_con_NVIDoff_of_mais(m, mnvindex)));    
}
