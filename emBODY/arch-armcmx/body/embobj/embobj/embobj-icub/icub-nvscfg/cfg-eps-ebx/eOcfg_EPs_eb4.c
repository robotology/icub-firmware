...
{  
    ...
    {   // as-rightlowerarm: a mais
        EO_INIT(.endpoint)                          endpoint_as_rightlowerarm,
...
const EOconstvector* const eo_cfg_EPs_vectorof_eb4 = &eo_cfg_EPs_vectorof_eb4_object;

const eOuint16_fp_uint16_t eo_cfg_nvsEP_eb4_fptr_hashfunction_ep2index = eo_cfg_nvsEP_eb4_hashfunction_ep2index;
