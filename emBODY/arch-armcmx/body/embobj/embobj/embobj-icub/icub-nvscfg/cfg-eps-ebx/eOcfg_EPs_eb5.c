...
static uint16_t s_eo_cfg_nvsEP_eb5_hashfunction_ep2index(uint16_t ep);
...
extern const EOconstvector  s_eo_cfg_nvsEP_mc_torso_constvector_of_treenodes_EOnv_con;
extern const EOconstvector  s_eo_cfg_nvsEP_mc_torso_usr_constvector_of_EOnv_usr;



static const eOnvscfg_EP_t s_eo_cfg_EPs_vectorof_eb5_data[] =
{  
    {   // mngmnt
    ...
    {   // mc-leftleg-lower
        ...
        EO_INIT(.constvector_of_treenodes_EOnv_con) &s_eo_cfg_nvsEP_mc_torso_constvector_of_treenodes_EOnv_con, 
        EO_INIT(.constvector_of_EOnv_usr)           &s_eo_cfg_nvsEP_mc_torso_usr_constvector_of_EOnv_usr, 
        EO_INIT(.endpoint_data_init)                eo_cfg_nvsEP_mc_torso_usr_initialise,
        EO_INIT(.endpoint_data_retrieve)            s_eocfg_eps_ebx_ram_retrieve
    }
...
static const EOconstvector s_eo_cfg_EPs_vectorof_eb5 = 
{
    EO_INIT(.size)                  sizeof(s_eo_cfg_EPs_vectorof_eb5_data)/sizeof(const eOnvscfg_EP_t),
    EO_INIT(.item_size)             sizeof(eOnvscfg_EP_t),
    EO_INIT(.item_array_data)       s_eo_cfg_EPs_vectorof_eb5_data
};
...
extern const EOconstvector* const eo_cfg_EPs_vectorof_eb5 = &s_eo_cfg_EPs_vectorof_eb5;

extern const eOuint16_fp_uint16_t eo_cfg_nvsEP_eb5_fptr_hashfunction_ep2index = s_eo_cfg_nvsEP_eb5_hashfunction_ep2index;
...
extern void* eo_cfg_nvsEP_eb5_Get_remotelyownedRAM(eOnvEP_t ep, eOnvscfgOwnership_t ownership)
{
...
extern void* eo_cfg_nvsEP_eb5_Get_locallyownedRAM(eOnvEP_t ep)
{
    uint16_t i = s_hash(ep);
...
static uint8_t s_hashtable[64] = 
{
    ...
    // 16-31: MC endpoint_mc_torso is 0x15 and is in pos 1
    0xff, 0xff, 0xff, 0xff, 0xff, 1,    0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 
    // 32-47: 
...
static uint16_t s_eo_cfg_nvsEP_eb5_hashfunction_ep2index(uint16_t ep)
{
    ...
    { 
        endpoint_mn_mngmnt,        endpoint_mc_torso
    };
