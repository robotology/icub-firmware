...
extern const EOconstvector eo_cfg_EPs_vectorof_eb6_object = 
{
...
const EOconstvector* const eo_cfg_EPs_vectorof_eb6 = &eo_cfg_EPs_vectorof_eb6_object;

const eOuint16_fp_uint16_t eo_cfg_nvsEP_eb6_fptr_hashfunction_ep2index = eo_cfg_nvsEP_eb6_hashfunction_ep2index;
...
extern uint16_t eo_cfg_nvsEP_eb6_hashfunction_ep2index(uint16_t ep)
{
    ...
    { 
        endpoint_mn_comm,        endpoint_mn_appl,          endpoint_mc_leftupperleg,       endpoint_as_leftupperleg
    };
...
static uint8_t s_hashtable[64] = 
{
    ...
    // 16-31: MC endpoint_mc_leftupperleg is 0x16 and is in pos 2
    0xff, 0xff, 0xff, 0xff, 0xff, 0xff,    2, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 
    // 32-47: AS endpoint_as_leftupperleg is 0x26 and is in pos 3.
    0xff, 0xff, 0xff, 0xff, 0xff, 0xff,    3, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
    // 48-63: 
