...
#ifndef _EOCFG_NVSEP_AS_UPPERARM_CON_H_
#define _EOCFG_NVSEP_AS_UPPERARM_CON_H_


#error --> obsolete. dont use.

/** @file       eOcfg_nvsEP_as_upperarm_con.h
...
/** @typedef    typedef enum eo_cfg_nvsEP_as_upperarm_con_strainNumber_t
    @brief      It contains an index for all the strain in the body.
 **/
typedef enum
{
    strainUpperArm_00 = 0
} eo_cfg_nvsEP_as_upperarm_con_strainNumber_t;

enum { strainUpperArm_TOTALnumber = 1}; 


/** @typedef    typedef eo_cfg_nvsEP_as_strainNVindex_t eo_cfg_nvsEP_as_upperarm_con_strainNVindex_t
    @brief      It contains an index for all the network variables in a strain of the upper arm.
 **/
typedef eo_cfg_nvsEP_as_strainNVindex_t eo_cfg_nvsEP_as_upperarm_con_strainNVindex_t;


/** @typedef    typedef eo_cfg_nvsEP_as_maisNVindex_t eo_cfg_nvsEP_as_upperarm_con_maisNVindex_t
    @brief      It contains an index for all the network variables in a mais of the upper arm: none
 **/
typedef eo_cfg_nvsEP_as_maisNVindex_t eo_cfg_nvsEP_as_upperarm_con_maisNVindex_t;



typedef uint16_t eo_cfg_nvsEP_as_upperarm_con_maisNumber_t; // just to have it

enum { maisUpperArm_TOTALnumber = 0}; 



/** @typedef    enum varsASupperarm_TOTALnumber;
    @brief      It contains the total number of network variables managed by the endpoint leftleg
 **/
enum {varsASupperarm_TOTALnumber = strainUpperArm_TOTALnumber*strainNVindex_TOTALnumber + maisUpperArm_TOTALnumber*maisNVindex_TOTALnumber };


/** @typedef    typedef struct eo_cfg_nvsEP_as_upperarm_t;
    @brief      contains all the variables in the upperarm of kind analog sensors
 **/
typedef struct                      // size is 56*1 = 56                
{
    eOsnsr_strain_t                 strains[1];
} eo_cfg_nvsEP_as_upperarm_t;       EO_VERIFYsizeof(eo_cfg_nvsEP_as_upperarm_t, 56);
...
/** @fn         extern eOnvID_t eo_cfg_nvsEP_as_upperarm_strain_NVID_Get(eo_cfg_nvsEP_as_upperarm_con_strainNumber_t s, eo_cfg_nvsEP_as_upperarm_con_strainNVindex_t snvindex)
...
/** @fn         extern eOnvID_t eo_cfg_nvsEP_as_upperarm_mais_NVID_Get(eo_cfg_nvsEP_as_upperarm_con_maisNumber_t m, eo_cfg_nvsEP_as_upperarm_con_maisNVindex_t mnvindex)
...
extern const EOconstvector* const eo_cfg_nvsEP_as_upperarm_constvector_of_treenodes_EOnv_con;

// if not NULL it contains a mapping from IDs to index inside eo_cfg_nvsEP_as_upperarm_constvector_of_treenodes_EOnv_con
extern const eOuint16_fp_uint16_t eo_cfg_nvsEP_as_upperarm_fptr_hashfunction_id2index;

// the size of the ram to be used
#define EOK_cfg_nvsEP_as_upperarm_RAMSIZE                                            (sizeof(eo_cfg_nvsEP_as_upperarm_t));
