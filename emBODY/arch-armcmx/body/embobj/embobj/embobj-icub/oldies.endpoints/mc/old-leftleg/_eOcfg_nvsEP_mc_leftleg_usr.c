...
//extern void eo_cfg_nvsEP_mc_leftleg_usr_hid_INIT__x1x2x3(const EOnv* nv);
//extern void eo_cfg_nvsEP_mc_leftleg_usr_hid_update__x1x2x3(const EOnv* nv, const eOabstime_t time, const uint32_t sign);
...
#define JXXMACRO_INIT        leftleg_usr_hid_INIT_Jxx
#define JXXMACRO_UPDT        leftleg_usr_hid_UPDT_Jxx
...
#define MXXMACRO_INIT        leftleg_usr_hid_INIT_Mxx
#define MXXMACRO_UPDT        leftleg_usr_hid_UPDT_Mxx
...
static const EOnv_usr_t s_eo_cfg_nvsEP_mc_leftleg_usr_array_of_EOnv_usr[varsMCleftleg_TOTALnumber] =
{
    {   // j00 
...
const EOconstvector  s_eo_cfg_nvsEP_mc_leftleg_usr_constvector_of_EOnv_usr = 
{
    EO_INIT(.size)              sizeof(s_eo_cfg_nvsEP_mc_leftleg_usr_array_of_EOnv_usr)/sizeof(EOnv_usr_t), 
    EO_INIT(.item_size)         sizeof(EOnv_usr_t),
    EO_INIT(.item_array_data)   s_eo_cfg_nvsEP_mc_leftleg_usr_array_of_EOnv_usr
};


extern const EOconstvector* const nvsEP_mc_leftleg_usr_constvector_of_EOnv_usr = &s_eo_cfg_nvsEP_mc_leftleg_usr_constvector_of_EOnv_usr;

extern eo_cfg_nvsEP_mc_leftleg_t* nvsEP_mc_leftleg_usr_mem_local    = NULL;
extern eo_cfg_nvsEP_mc_leftleg_t* nvsEP_mc_leftleg_usr_mem_remote   = NULL;
...
{ 
    ...
    nvsEP_mc_leftleg_usr_mem_local      = (eo_cfg_nvsEP_mc_leftleg_t*)loc;
    nvsEP_mc_leftleg_usr_mem_remote     = (eo_cfg_nvsEP_mc_leftleg_t*)rem;
    
    // launch a specialised initialisation
    eo_cfg_nvsEP_mc_leftleg_usr_hid_INITIALISE(nvsEP_mc_leftleg_usr_mem_local, nvsEP_mc_leftleg_usr_mem_remote);
...
__weak extern void eo_cfg_nvsEP_mc_leftleg_usr_hid_INITIALISE(void *loc, void *rem)
{
...
// jxx-init:
__weak extern void eo_cfg_nvsEP_mc_leftleg_usr_hid_INIT_Jxx_jconfig(uint16_t n, const EOnv* nv)
{
    
}

__weak extern void eo_cfg_nvsEP_mc_leftleg_usr_hid_INIT_Jxx_jconfig__pidposition(uint16_t n, const EOnv* nv)
{
    
}

__weak extern void eo_cfg_nvsEP_mc_leftleg_usr_hid_INIT_Jxx_jconfig__pidvelocity(uint16_t n, const EOnv* nv)
{
    
}


__weak extern void eo_cfg_nvsEP_mc_leftleg_usr_hid_INIT_Jxx_jconfig__pidtorque(uint16_t n, const EOnv* nv)
{
    
}


__weak extern void eo_cfg_nvsEP_mc_leftleg_usr_hid_INIT_Jxx_jconfig__minpositionofjoint(uint16_t n, const EOnv* nv)
{
    
}


__weak extern void eo_cfg_nvsEP_mc_leftleg_usr_hid_INIT_Jxx_jconfig__maxpositionofjoint(uint16_t n, const EOnv* nv)
{
    
}


__weak extern void eo_cfg_nvsEP_mc_leftleg_usr_hid_INIT_Jxx_jconfig__velocitysetpointtimeout(uint16_t n, const EOnv* nv)
{
    
}


__weak extern void eo_cfg_nvsEP_mc_leftleg_usr_hid_INIT_Jxx_jconfig__upto02descrforchameleon02(uint16_t n, const EOnv* nv)
{
    
}


__weak extern void eo_cfg_nvsEP_mc_leftleg_usr_hid_INIT_Jxx__jstatus(uint16_t n, const EOnv* nv)
{
    
}


__weak extern void eo_cfg_nvsEP_mc_leftleg_usr_hid_INIT_Jxx__calibrator(uint16_t n, const EOnv* nv)
{
    
}


__weak extern void eo_cfg_nvsEP_mc_leftleg_usr_hid_INIT_Jxx__setpoint(uint16_t n, const EOnv* nv)
{
    
}


__weak extern void eo_cfg_nvsEP_mc_leftleg_usr_hid_INIT_Jxx__controlmode(uint16_t n, const EOnv* nv)
{
    
}

__weak extern void eo_cfg_nvsEP_mc_leftleg_usr_hid_INIT_Jxx__signalwhenmotionisdone(uint16_t n, const EOnv* nv)
{
    
}


__weak extern void eo_cfg_nvsEP_mc_leftleg_usr_hid_INIT_Jxx__motionisdone(uint16_t n, const EOnv* nv)
{
    
}

__weak extern void eo_cfg_nvsEP_mc_leftleg_usr_hid_INIT_Jxx__externalvalueoftorque(uint16_t n, const EOnv* nv)
{
    
}

// jxx-updt: all the nvs
__weak extern void eo_cfg_nvsEP_mc_leftleg_usr_hid_UPDT_Jxx_jconfig(uint16_t n, const EOnv* nv, const eOabstime_t time, const uint32_t sign)
{
    
}


__weak extern void eo_cfg_nvsEP_mc_leftleg_usr_hid_UPDT_Jxx_jconfig__pidposition(uint16_t n, const EOnv* nv, const eOabstime_t time, const uint32_t sign)
{
    
}


__weak extern void eo_cfg_nvsEP_mc_leftleg_usr_hid_UPDT_Jxx_jconfig__pidvelocity(uint16_t n, const EOnv* nv, const eOabstime_t time, const uint32_t sign)
{
    
}


__weak extern void eo_cfg_nvsEP_mc_leftleg_usr_hid_UPDT_Jxx_jconfig__pidtorque(uint16_t n, const EOnv* nv, const eOabstime_t time, const uint32_t sign)
{
    
}


__weak extern void eo_cfg_nvsEP_mc_leftleg_usr_hid_UPDT_Jxx_jconfig__minpositionofjoint(uint16_t n, const EOnv* nv, const eOabstime_t time, const uint32_t sign)
{
    
}


__weak extern void eo_cfg_nvsEP_mc_leftleg_usr_hid_UPDT_Jxx_jconfig__maxpositionofjoint(uint16_t n, const EOnv* nv, const eOabstime_t time, const uint32_t sign)
{
    
}


__weak extern void eo_cfg_nvsEP_mc_leftleg_usr_hid_UPDT_Jxx_jconfig__velocitysetpointtimeout(uint16_t n, const EOnv* nv, const eOabstime_t time, const uint32_t sign)
{
    
}


__weak extern void eo_cfg_nvsEP_mc_leftleg_usr_hid_UPDT_Jxx_jconfig__upto02descrforchameleon02(uint16_t n, const EOnv* nv, const eOabstime_t time, const uint32_t sign)
{
    
}


__weak extern void eo_cfg_nvsEP_mc_leftleg_usr_hid_UPDT_Jxx__jstatus(uint16_t n, const EOnv* nv, const eOabstime_t time, const uint32_t sign)
{
    
}


__weak extern void eo_cfg_nvsEP_mc_leftleg_usr_hid_UPDT_Jxx__calibrator(uint16_t n, const EOnv* nv, const eOabstime_t time, const uint32_t sign)
{
    
}


__weak extern void eo_cfg_nvsEP_mc_leftleg_usr_hid_UPDT_Jxx__setpoint(uint16_t n, const EOnv* nv, const eOabstime_t time, const uint32_t sign)
{
    
}


__weak extern void eo_cfg_nvsEP_mc_leftleg_usr_hid_UPDT_Jxx__controlmode(uint16_t n, const EOnv* nv, const eOabstime_t time, const uint32_t sign)
{
    
}


__weak extern void eo_cfg_nvsEP_mc_leftleg_usr_hid_UPDT_Jxx__signalwhenmotionisdone(uint16_t n, const EOnv* nv, const eOabstime_t time, const uint32_t sign)
{
    
}

__weak extern void eo_cfg_nvsEP_mc_leftleg_usr_hid_UPDT_Jxx__motionisdone(uint16_t n, const EOnv* nv, const eOabstime_t time, const uint32_t sign)
{
    
}

__weak extern void eo_cfg_nvsEP_mc_leftleg_usr_hid_UPDT_Jxx__externalvalueoftorque(uint16_t n, const EOnv* nv, const eOabstime_t time, const uint32_t sign)
{
    
}


__weak extern void eo_cfg_nvsEP_mc_leftleg_usr_hid_INIT_Mxx_mconfig(uint16_t n, const EOnv* nv)
{
    
}

__weak extern void eo_cfg_nvsEP_mc_leftleg_usr_hid_INIT_Mxx_mconfig__pidcurrent(uint16_t n, const EOnv* nv)
{
    
}


__weak extern void eo_cfg_nvsEP_mc_leftleg_usr_hid_INIT_Mxx_mconfig__maxvelocityofmotor(uint16_t n, const EOnv* nv)
{
    
}


__weak extern void eo_cfg_nvsEP_mc_leftleg_usr_hid_INIT_Mxx_mconfig__maxcurrentofmotor(uint16_t n, const EOnv* nv)
{
    
}


__weak extern void eo_cfg_nvsEP_mc_leftleg_usr_hid_INIT_Mxx_mconfig__upto02descrforchameleon06(uint16_t n, const EOnv* nv)
{
    
}


__weak extern void eo_cfg_nvsEP_mc_leftleg_usr_hid_INIT_Mxx__mstatus(uint16_t n, const EOnv* nv)
{
...
__weak extern void eo_cfg_nvsEP_mc_leftleg_usr_hid_UPDT_Mxx_mconfig(uint16_t n, const EOnv* nv, const eOabstime_t time, const uint32_t sign)
{
    
}


__weak extern void eo_cfg_nvsEP_mc_leftleg_usr_hid_UPDT_Mxx_mconfig__pidcurrent(uint16_t n, const EOnv* nv, const eOabstime_t time, const uint32_t sign)
{
    
}


__weak extern void eo_cfg_nvsEP_mc_leftleg_usr_hid_UPDT_Mxx_mconfig__maxvelocityofmotor(uint16_t n, const EOnv* nv, const eOabstime_t time, const uint32_t sign)
{
    
}


__weak extern void eo_cfg_nvsEP_mc_leftleg_usr_hid_UPDT_Mxx_mconfig__maxcurrentofmotor(uint16_t n, const EOnv* nv, const eOabstime_t time, const uint32_t sign)
{
    
}


__weak extern void eo_cfg_nvsEP_mc_leftleg_usr_hid_UPDT_Mxx_mconfig__upto02descrforchameleon06(uint16_t n, const EOnv* nv, const eOabstime_t time, const uint32_t sign)
{
    
}


__weak extern void eo_cfg_nvsEP_mc_leftleg_usr_hid_UPDT_Mxx__mstatus(uint16_t n, const EOnv* nv, const eOabstime_t time, const uint32_t sign)
{
