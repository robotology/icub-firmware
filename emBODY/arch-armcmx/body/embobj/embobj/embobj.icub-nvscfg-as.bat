...
:: here are core files
set SOURCE_API=.\embobj-icub\icub-nvscfg\ep-analogsensors\api
set SOURCE_SRC=.\embobj-icub\icub-nvscfg\ep-analogsensors\src
...
set TYP=icub-nvscfg\ep-analogsensors
