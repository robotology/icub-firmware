...
:: here are core files
set SOURCE_API=.\embobj-icub\icub-nvscfg\ep-motioncontrol\api
set SOURCE_SRC=.\embobj-icub\icub-nvscfg\ep-motioncontrol\src
...
set TYP=icub-nvscfg\ep-motioncontrol
