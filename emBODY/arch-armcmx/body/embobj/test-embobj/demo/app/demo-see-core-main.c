...
{  
    ...
    snprintf(str, sizeof(str)-1, "s_eos_test_eossys_user_init() just called\n");
    hal_trace_puts(str);
}
...
static void s_eos_test_on_event(uint32_t evtpos, eOevent_t evtmsk)
{
    ...
    snprintf(str, sizeof(str)-1, "executed action on evtpos %d at time %d msec\n", evtpos, (uint32_t)(tt/1000));
    hal_trace_puts(str);
...
static void s_eos_test_on_message(eOmessage_t msg)
{
    ...
    snprintf(str, sizeof(str)-1, "executed action on msg 0x%x at time %d msec\n", msg, (uint32_t)(tt/1000));
    hal_trace_puts(str);
...
static void s_eos_test_callback10(void *arg)
{
    ...
    snprintf(str, sizeof(str)-1, "executed callback at time %d msec, and my32 is %d\n", (uint32_t)(tt/1000), (NULL == my32) ? (0): *my32);
    hal_trace_puts(str);
