...
//1) Setup timer 2 registers for CNV
   ...
   hal_timer_cfg_t tmr_cfg = 
    ...
    hal_timer_offset_write(hal_timer2, 3300, hal_timer_measurement_nanosec); // reset timer. 3.3 us phase vs timer 5.
...
//2) Setup timer 5 registers for SPI
    ...
    hal_timer_offset_write(hal_timer5, 0, hal_timer_measurement_microsec);
