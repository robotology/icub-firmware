...
// --------------------------------------------------------------------------------------------------------------------
    ...
    const uint8_t hal_brdcfg_led__supported_mask           = (1 << hal_led0) | (1 << hal_led1); //0x03
...
extern void hal_brdcfg_can__phydevices_enable(hal_can_port_t port)
{
    ...
    RPINR26bits.C1RXR = 8;      // RX: Connect ECAN1 Receive to RP8
}
