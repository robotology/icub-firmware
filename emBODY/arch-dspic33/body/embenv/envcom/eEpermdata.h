...
/** @fn         extern eEresult_t ee_permdata_erase(const eEpermdataInfo_t *pdatainfo)
    @brief      erase a permanent data object module according to what is specified in the eEpermdataInfo_t object.
    @param      pdatainfo           pointer to the permanent data information
    @return     ee_res_OK or ee_res_NOK_generic upon failure
    @warning    hal_eeprom and hal-crc must be properly initted
 **/
