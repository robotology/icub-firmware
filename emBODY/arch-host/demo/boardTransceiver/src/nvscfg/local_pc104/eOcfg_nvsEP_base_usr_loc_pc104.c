...
static void s_eo_cfg_nvsEP_base_usr_loc_anydev_action_update__boardinfo(const EOnv* nv, const eOabstime_t time, const uint32_t sign);
static void s_eo_cfg_nvsEP_base_usr_loc_anydev_action_update__applicationinfo(const EOnv* nv, const eOabstime_t time, const uint32_t sign);
...
{
    EO_INIT(.init)      NULL,
    EO_INIT(.update)    s_eo_cfg_nvsEP_base_usr_loc_anydev_action_update__boardinfo
};
...
{
    EO_INIT(.init)      NULL,
    EO_INIT(.update)    s_eo_cfg_nvsEP_base_usr_loc_anydev_action_update__applicationinfo
};
...
{
    {   // 00 __boardinfo
        EO_INIT(.peripheralinterface)   &s_eo_cfg_nvsEP_base_usr_loc_anydev_action_peripheralinterface__boardinfo,
        EO_INIT(.on_rop_reception)      NULL,
        EO_INIT(.stg_address)           EOK_uint32dummy
    },
    {   // 01 __applicationinfo
        EO_INIT(.peripheralinterface)   &s_eo_cfg_nvsEP_base_usr_loc_anydev_action_peripheralinterface__applicationinfo,
        EO_INIT(.on_rop_reception)      NULL, //&s_eo_cfg_nvsEP_base_usr_loc_anydev_action_update__applicationinfo,
        EO_INIT(.stg_address)           EOK_uint32dummy
    },    
    {   // 02  _ipnetwork
...
#else
    // simple init, just print out the function name
    eo_cfg_nvsEP_base_t *vol = (eo_cfg_nvsEP_base_t*)loc;
    strcpy(vol->applicationinfo.info.name, "ciao");
...
static void s_eo_cfg_nvsEP_base_usr_loc_anydev_action_update__boardinfo(const EOnv* nv, const eOabstime_t time, const uint32_t sign)
{
	printf("s_eo_cfg_nvsEP_base_usr_loc_anydev_action_update__boardinfo");
}

static void s_eo_cfg_nvsEP_base_usr_loc_anydev_action_update__applicationinfo(const EOnv* nv, const eOabstime_t time, const uint32_t sign)
{
	printf("s_eo_cfg_nvsEP_base_usr_loc_anydev_action_update__applicationinfo");
//	eEmoduleInfo_t *info = nv->loc;
//	info->extra[0]=0xEE;
//	info->extra[1]=0x55;
//	info->extra[2]=0x11;
//	info->extra[3]=0xCC;
...
static void s_eo_cfg_nvsEP_base_usr_loc_anydev_action_update__bootprocess(const EOnv* nv, const eOabstime_t time, const uint32_t sign)
{
	printf("s_eo_cfg_nvsEP_base_usr_loc_anydev_action_update__bootprocess");
}

static void s_eo_cfg_nvsEP_base_usr_loc_anydev_action_update__gotoprocess(const EOnv* nv, const eOabstime_t time, const uint32_t sign)
{
	printf("s_eo_cfg_nvsEP_base_usr_loc_anydev_action_update__gotoprocess");
}

static void s_eo_cfg_nvsEP_base_usr_loc_anydev_action_update__forcerestart(const EOnv* nv, const eOabstime_t time, const uint32_t sign)
{
	printf("s_eo_cfg_nvsEP_base_usr_loc_anydev_action_update__forcerestart");
}

static void s_eo_cfg_nvsEP_base_usr_loc_anydev_action_update__localise(const EOnv* nv, const eOabstime_t time, const uint32_t sign)
{
	printf("s_eo_cfg_nvsEP_base_usr_loc_anydev_action_update__localise");
}

static void s_eo_cfg_nvsEP_base_usr_loc_anydev_action_update_ipnetwork__macaddress(const EOnv* nv, const eOabstime_t time, const uint32_t sign)
{
	printf("s_eo_cfg_nvsEP_base_usr_loc_anydev_action_update_ipnetwork__macaddress");
}

static void s_eo_cfg_nvsEP_base_usr_loc_anydev_action_update_ipnetwork__ipaddress(const EOnv* nv, const eOabstime_t time, const uint32_t sign)
{
	printf("s_eo_cfg_nvsEP_base_usr_loc_anydev_action_update_ipnetwork__ipaddress");
}

static void s_eo_cfg_nvsEP_base_usr_loc_anydev_action_update_ipnetwork__ipnetmask(const EOnv* nv, const eOabstime_t time, const uint32_t sign)
{
	printf("s_eo_cfg_nvsEP_base_usr_loc_anydev_action_update_ipnetwork__ipnetmask");
}

static void s_eo_cfg_nvsEP_base_usr_loc_anydev_action_update__remoteipaddress(const EOnv* nv, const eOabstime_t time, const uint32_t sign)
{
	printf("s_eo_cfg_nvsEP_base_usr_loc_anydev_action_update__remoteipaddress");
}

static void s_eo_cfg_nvsEP_base_usr_loc_anydev_action_update__remoteipport(const EOnv* nv, const eOabstime_t time, const uint32_t sign)
{
	printf("s_eo_cfg_nvsEP_base_usr_loc_anydev_action_update__remoteipport");
}

static void s_eo_cfg_nvsEP_base_usr_loc_anydev_action_gotoprocess_or_forcerestart_callback(void *p)
{
	printf("s_eo_cfg_nvsEP_base_usr_loc_anydev_action_gotoprocess_or_forcerestart_callback");
}

static void s_eo_cfg_nvsEP_base_usr_loc_anydev_action_localise_callback(void *p)
{
	printf("s_eo_cfg_nvsEP_base_usr_loc_anydev_action_localise_callback");
}
