...
/* @file       eOcfg_nvsEP_mc_leftleg_usr_rem_ebx.c
...
//static void s_eo_cfg_nvsEP_mc_leftleg_usr_rem_ebx_action_INIT__x1x2x3(const EOnv* nv);
//static void s_eo_cfg_nvsEP_mc_leftleg_usr_rem_ebx_action_update__x1x2x3(const EOnv* nv, const eOabstime_t time, const uint32_t sign);


// jxx-init:
static void s_eo_cfg_nvsEP_mc_leftleg_usr_rem_ebx_action_INIT_Jxx_jconfig(uint16_t n, const EOnv* nv);
static void s_eo_cfg_nvsEP_mc_leftleg_usr_rem_ebx_action_INIT_Jxx_jconfig__pidposition(uint16_t n, const EOnv* nv);
static void s_eo_cfg_nvsEP_mc_leftleg_usr_rem_ebx_action_INIT_Jxx_jconfig__pidvelocity(uint16_t n, const EOnv* nv);
static void s_eo_cfg_nvsEP_mc_leftleg_usr_rem_ebx_action_INIT_Jxx_jconfig__pidtorque(uint16_t n, const EOnv* nv);
static void s_eo_cfg_nvsEP_mc_leftleg_usr_rem_ebx_action_INIT_Jxx_jconfig__minpositionofjoint(uint16_t n, const EOnv* nv);
static void s_eo_cfg_nvsEP_mc_leftleg_usr_rem_ebx_action_INIT_Jxx_jconfig__maxpositionofjoint(uint16_t n, const EOnv* nv);
static void s_eo_cfg_nvsEP_mc_leftleg_usr_rem_ebx_action_INIT_Jxx_jconfig__velocitysetpointtimeout(uint16_t n, const EOnv* nv);
static void s_eo_cfg_nvsEP_mc_leftleg_usr_rem_ebx_action_INIT_Jxx_jconfig__upto02descrforchameleon02(uint16_t n, const EOnv* nv);
static void s_eo_cfg_nvsEP_mc_leftleg_usr_rem_ebx_action_INIT_Jxx__jstatus(uint16_t n, const EOnv* nv);
static void s_eo_cfg_nvsEP_mc_leftleg_usr_rem_ebx_action_INIT_Jxx__calibrator(uint16_t n, const EOnv* nv);
static void s_eo_cfg_nvsEP_mc_leftleg_usr_rem_ebx_action_INIT_Jxx__setpoint(uint16_t n, const EOnv* nv);
static void s_eo_cfg_nvsEP_mc_leftleg_usr_rem_ebx_action_INIT_Jxx__controlmode(uint16_t n, const EOnv* nv);
// jxx-updt: all the nvs
static void s_eo_cfg_nvsEP_mc_leftleg_usr_rem_ebx_action_UPDT_Jxx_jconfig(uint16_t n, const EOnv* nv, const eOabstime_t time, const uint32_t sign);
static void s_eo_cfg_nvsEP_mc_leftleg_usr_rem_ebx_action_UPDT_Jxx_jconfig__pidposition(uint16_t n, const EOnv* nv, const eOabstime_t time, const uint32_t sign);
static void s_eo_cfg_nvsEP_mc_leftleg_usr_rem_ebx_action_UPDT_Jxx_jconfig__pidvelocity(uint16_t n, const EOnv* nv, const eOabstime_t time, const uint32_t sign);
static void s_eo_cfg_nvsEP_mc_leftleg_usr_rem_ebx_action_UPDT_Jxx_jconfig__pidtorque(uint16_t n, const EOnv* nv, const eOabstime_t time, const uint32_t sign);
static void s_eo_cfg_nvsEP_mc_leftleg_usr_rem_ebx_action_UPDT_Jxx_jconfig__minpositionofjoint(uint16_t n, const EOnv* nv, const eOabstime_t time, const uint32_t sign);
static void s_eo_cfg_nvsEP_mc_leftleg_usr_rem_ebx_action_UPDT_Jxx_jconfig__maxpositionofjoint(uint16_t n, const EOnv* nv, const eOabstime_t time, const uint32_t sign);
static void s_eo_cfg_nvsEP_mc_leftleg_usr_rem_ebx_action_UPDT_Jxx_jconfig__velocitysetpointtimeout(uint16_t n, const EOnv* nv, const eOabstime_t time, const uint32_t sign);
static void s_eo_cfg_nvsEP_mc_leftleg_usr_rem_ebx_action_UPDT_Jxx_jconfig__upto02descrforchameleon02(uint16_t n, const EOnv* nv, const eOabstime_t time, const uint32_t sign);
static void s_eo_cfg_nvsEP_mc_leftleg_usr_rem_ebx_action_UPDT_Jxx__jstatus(uint16_t n, const EOnv* nv, const eOabstime_t time, const uint32_t sign);
static void s_eo_cfg_nvsEP_mc_leftleg_usr_rem_ebx_action_UPDT_Jxx__calibrator(uint16_t n, const EOnv* nv, const eOabstime_t time, const uint32_t sign);
static void s_eo_cfg_nvsEP_mc_leftleg_usr_rem_ebx_action_UPDT_Jxx__setpoint(uint16_t n, const EOnv* nv, const eOabstime_t time, const uint32_t sign);
static void s_eo_cfg_nvsEP_mc_leftleg_usr_rem_ebx_action_UPDT_Jxx__controlmode(uint16_t n, const EOnv* nv, const eOabstime_t time, const uint32_t sign);


// mxx-init:
static void s_eo_cfg_nvsEP_mc_leftleg_usr_rem_ebx_action_INIT_Mxx_mconfig(uint16_t n, const EOnv* nv);
static void s_eo_cfg_nvsEP_mc_leftleg_usr_rem_ebx_action_INIT_Mxx_mconfig__pidcurrent(uint16_t n, const EOnv* nv);
static void s_eo_cfg_nvsEP_mc_leftleg_usr_rem_ebx_action_INIT_Mxx_mconfig__maxvelocityofmotor(uint16_t n, const EOnv* nv);
static void s_eo_cfg_nvsEP_mc_leftleg_usr_rem_ebx_action_INIT_Mxx_mconfig__maxcurrentofmotor(uint16_t n, const EOnv* nv);
static void s_eo_cfg_nvsEP_mc_leftleg_usr_rem_ebx_action_INIT_Mxx_mconfig__upto02descrforchameleon06(uint16_t n, const EOnv* nv);
static void s_eo_cfg_nvsEP_mc_leftleg_usr_rem_ebx_action_INIT_Mxx__mstatus(uint16_t n, const EOnv* nv);
// mxx-updt: all the nvs
static void s_eo_cfg_nvsEP_mc_leftleg_usr_rem_ebx_action_UPDT_Mxx_mconfig(uint16_t n, const EOnv* nv, const eOabstime_t time, const uint32_t sign);
static void s_eo_cfg_nvsEP_mc_leftleg_usr_rem_ebx_action_UPDT_Mxx_mconfig__pidcurrent(uint16_t n, const EOnv* nv, const eOabstime_t time, const uint32_t sign);
static void s_eo_cfg_nvsEP_mc_leftleg_usr_rem_ebx_action_UPDT_Mxx_mconfig__maxvelocityofmotor(uint16_t n, const EOnv* nv, const eOabstime_t time, const uint32_t sign);
static void s_eo_cfg_nvsEP_mc_leftleg_usr_rem_ebx_action_UPDT_Mxx_mconfig__maxcurrentofmotor(uint16_t n, const EOnv* nv, const eOabstime_t time, const uint32_t sign);
static void s_eo_cfg_nvsEP_mc_leftleg_usr_rem_ebx_action_UPDT_Mxx_mconfig__upto02descrforchameleon06(uint16_t n, const EOnv* nv, const eOabstime_t time, const uint32_t sign);
static void s_eo_cfg_nvsEP_mc_leftleg_usr_rem_ebx_action_UPDT_Mxx__mstatus(uint16_t n, const EOnv* nv, const eOabstime_t time, const uint32_t sign);
...
// the generic entry
//static const eOnv_fn_peripheral_t s_eo_cfg_nvsEP_mc_leftleg_usr_rem_ebx_action_peripheralinterface__x1x2x3 =
//{
//    EO_INIT(.init)      s_eo_cfg_nvsEP_mc_leftleg_usr_rem_ebx_action_INIT__x1x2x3,
//    EO_INIT(.update)    s_eo_cfg_nvsEP_mc_leftleg_usr_rem_ebx_action_UPDT__x1x2x3
//};

#define JXXMACRO_INIT        eo_cfg_nvsEP_mc_leftleg_usr_rem_ebx_action_INIT_Jxx
#define JXXMACRO_UPDT        eo_cfg_nvsEP_mc_leftleg_usr_rem_ebx_action_UPDT_Jxx
...
#define MXXMACRO_INIT        eo_cfg_nvsEP_mc_leftleg_usr_rem_ebx_action_INIT_Mxx
#define MXXMACRO_UPDT        eo_cfg_nvsEP_mc_leftleg_usr_rem_ebx_action_UPDT_Mxx
...
// the generic entry
//    {   // 00 __x1x2x3
//        EO_INIT(.peripheralinterface)   &s_eo_cfg_nvsEP_mc_leftleg_usr_rem_ebx_action_peripheralinterface__x1x2x3,
...
static const EOnv_usr_t s_eo_cfg_nvsEP_mc_leftleg_usr_rem_ebx_array_of_EOnv_usr[varsMCleftleg_TOTALnumber] =
{
    {   // j00 
...
const EOconstvector  s_eo_cfg_nvsEP_mc_leftleg_usr_rem_ebx_constvector_of_EOnv_usr = 
{
    EO_INIT(.size)              sizeof(s_eo_cfg_nvsEP_mc_leftleg_usr_rem_ebx_array_of_EOnv_usr)/sizeof(EOnv_usr_t), 
    EO_INIT(.item_size)         sizeof(EOnv_usr_t),
    EO_INIT(.item_array_data)   s_eo_cfg_nvsEP_mc_leftleg_usr_rem_ebx_array_of_EOnv_usr
};


extern const EOconstvector* const nvsEP_mc_leftleg_usr_rem_ebx_constvector_of_EOnv_usr = &s_eo_cfg_nvsEP_mc_leftleg_usr_rem_ebx_constvector_of_EOnv_usr;

// _AC_  Puntatore di fine di mondo!!
extern eo_cfg_nvsEP_mc_leftleg_t* eo_cfg_nvsEP_mc_leftleg_usr_rem_ebx_mem_local  = NULL;
extern eo_cfg_nvsEP_mc_leftleg_t* eo_cfg_nvsEP_mc_leftleg_usr_rem_ebx_mem_remote  = NULL;
...
{ 
    ...
    // 0. init the extern variable which can be directly used by the application
    eo_cfg_nvsEP_mc_leftleg_usr_rem_ebx_mem_local = lloc;
    
    
    
    // in here we initialize the ram allocated by the EOnvscfg object:
    // 1. at least put it at its default value. 
    // 2. if you need to initialize other peripherals or objects linked to the values do it.
    //    HOWEVER: initialization of NVs is done on specific functions
