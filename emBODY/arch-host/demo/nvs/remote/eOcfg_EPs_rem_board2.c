...
#include "eOcfg_EPs_rem_board2.h"
...
extern uint16_t eo_cfg_nvsEP_mc_leg_hashfunction_id2index(uint16_t nvid);
...
{                 
    {   // 16-mc-leg
        ...
        EO_INIT(.constvector_of_EOnv_usr)           &s_eo_cfg_nvsEP_mc_leg_usr_constvector_of_EOnv_usr, //eo_cfg_nvsEP_mngmnt_usr_loc_ebx_constvector_of_EOnv_usr,
