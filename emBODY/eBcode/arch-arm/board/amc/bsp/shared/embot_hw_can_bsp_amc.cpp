...
#warning TBD: do the bsp for CAN in the amc
...
namespace embot::hw::can {
    ...
    void hwdriver_init(embot::hw::CAN h)
    {
        constexpr std::array<embot::hw::GPIO, 2> candrivergpiosstandby = { {
            ...
            {embot::hw::GPIO::PORT::A, embot::hw::GPIO::PIN::ten}      // CAN2_STBY_GPIO_Port, CAN2_STBY_Pin
        } }; 

        constexpr embot::hw::GPIO candrivergpioshutdown = 
            {embot::hw::GPIO::PORT::A, embot::hw::GPIO::PIN::three};     // CAN_SHDN_GPIO_Port, CAN_SHDN_Pin, GPIO_PIN_RESET    
