...
#warning TO DO: add functions required by EOMtheEMSappl
...
//#warning -> carefully see why the eth monitor should alert ...    
...
//    #warning -> carefully see to have all the leds blinking correctly ... 
// //   eo_ledpulser_Start(eo_ledpulser_GetHandle(), eo_ledpulser_led_three, EOK_reltime1sec/1, 0);
////    embot::app::theLEDmanager::getInstance().get(embot::hw::LED::three).pulse(1*embot::core::time1second, 0);
//    
...
//  
//    
//    // stop services which were started before on_entry_RUN()
//    
////    // motion-control
...
////    embot::app::theLEDmanager::getInstance().get(embot::hw::LED::three).pulse(embot::core::time1second/4, 0);
//   
