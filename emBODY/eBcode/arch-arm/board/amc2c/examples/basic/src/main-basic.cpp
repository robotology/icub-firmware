...
extern "C" {    
    ...
    {
        relocatevectortable(128*1024);        
    }      
}

#endif

extern void info_use();
...
{ 
    ...
    bsp_basic_itm_puts("CM4: hello world");
    
    bsp_basic_led_init();
    bsp_basic_itm_puts("CM4: led initted");
        
    for(;;)
    {
        HAL_Delay(500);
        bsp_basic_led_toggle();
        bsp_basic_itm_puts("CM4: led toggled");
    }    
}
