...
//        embot::core::print(tf.to_string() + ": the cm4 is alive");
    }
    // in here... 
...
embot::hw::motor::Currents cURRENTs {};
...
void embot::app::board::amc2c::theMBD::Impl::onCurrents_FOC_innerloop(void *owner, const embot::hw::motor::Currents * const currents)
{
    ...
    cURRENT01 = currents->u;
    cURRENT02 = currents->v;
    cURRENT03 = currents->w;
