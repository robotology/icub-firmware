...
#elif ((EENV_MEMMAP_SHARSERV_BASE_RAMADDR) == 0x1003FFC0)
...
// --- emaintainer: 512K [0x08160000, 0x08160000 + 0x00080000 = 0x081E0000]
...
#if ((EENV_MEMMAP_EMAINTAINER_ROMADDR+EENV_MODULEINFO_OFFSET) == 0x08160400)
#define EENV_MODULEINFO_MAINTAINER_AT ".ARM.__at_0x08160400"
#else
