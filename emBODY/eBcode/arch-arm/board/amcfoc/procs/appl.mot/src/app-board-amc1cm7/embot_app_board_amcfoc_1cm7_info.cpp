...
namespace embot::app::board::amcfoc::cm7::info { 
    ...
    static constexpr embot::app::icc::Signature signature __attribute__((section(".ARM.__at_0x08000800"))) =
    {
        ...
        {1, 1, 0, 0},   // application version
        {2, 0},         // protocol version
        {2025, embot::app::eth::Month::Oct, embot::app::eth::Day::eight, 10, 14}
    };
    ...
    .moduleinfo     =
    {
        .info           =
        {
            .entity     =
            {
                ...
                .version    = 
                { 
                    .major = embot::app::board::amcfoc::cm7::info::signature.application.major, 
                    .minor = embot::app::board::amcfoc::cm7::info::signature.application.minor
                },  
                .builddate  = 
                {
                    .year  = embot::app::board::amcfoc::cm7::info::signature.date.year,
                    .month = embot::app::board::amcfoc::cm7::info::signature.date.month,
                    .day   = embot::app::board::amcfoc::cm7::info::signature.date.day,
                    .hour  = embot::app::board::amcfoc::cm7::info::signature.date.hour,
                    .min   = embot::app::board::amcfoc::cm7::info::signature.date.minute
                }
            },
            .rom        = 
            {   
