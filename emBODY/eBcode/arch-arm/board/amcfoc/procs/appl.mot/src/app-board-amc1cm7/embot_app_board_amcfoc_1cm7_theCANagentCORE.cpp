...
struct embot::app::board::amcfoc::cm7::theCANagentCORE::Impl
{  
...
bool embot::app::board::amcfoc::cm7::theCANagentCORE::Impl::initialise(const Config &config)
{
    _config = config;
...
bool embot::app::board::amcfoc::cm7::theCANagentCORE::Impl::setcanaddress(const std::uint8_t adr, const std::uint16_t randominvalidmask)
{
...
embot::app::board::amcfoc::cm7::theCANagentCORE& embot::app::board::amcfoc::cm7::theCANagentCORE::getInstance()
{
    static theCANagentCORE* p = new theCANagentCORE();
    return *p;
}

embot::app::board::amcfoc::cm7::theCANagentCORE::theCANagentCORE()
{
...
bool embot::app::board::amcfoc::cm7::theCANagentCORE::initialise(const Config &config)
{
...
const embot::prot::can::applicationInfo & embot::app::board::amcfoc::cm7::theCANagentCORE::applicationinfo() const
{    
    return pImpl->_applicationinfo;
}

embot::hw::CAN embot::app::board::amcfoc::cm7::theCANagentCORE::bus() const
{ 
    return pImpl->_canbus;
}

embot::prot::can::Address embot::app::board::amcfoc::cm7::theCANagentCORE::address() const
{    
    return pImpl->_storedinfo.address;
}


bool embot::app::board::amcfoc::cm7::theCANagentCORE::get(const embot::prot::can::bootloader::Message_BROADCAST::Info &info, embot::prot::can::bootloader::Message_BROADCAST::ReplyInfo &replyinfo) 
{   
...
bool embot::app::board::amcfoc::cm7::theCANagentCORE::get(const embot::prot::can::bootloader::Message_GET_ADDITIONAL_INFO::Info &info, embot::prot::can::bootloader::Message_GET_ADDITIONAL_INFO::ReplyInfo &replyinfo)
{
...
bool embot::app::board::amcfoc::cm7::theCANagentCORE::get(const embot::prot::can::shared::Message_GET_VERSION::Info &info, embot::prot::can::shared::Message_GET_VERSION::ReplyInfo &replyinfo)
{    
    replyinfo.board = pImpl->_board;
    replyinfo.firmware = {pImpl->_applicationinfo.version.major, pImpl->_applicationinfo.version.minor, pImpl->_applicationinfo.version.build};
...
bool embot::app::board::amcfoc::cm7::theCANagentCORE::get(const embot::prot::can::bootloader::Message_GET_TIMEOFLIFE::Info &info, embot::prot::can::bootloader::Message_GET_TIMEOFLIFE::ReplyInfo &replyinfo)
{
...
bool embot::app::board::amcfoc::cm7::theCANagentCORE::set(const embot::prot::can::bootloader::Message_BOARD::Info &info)
{
...
bool embot::app::board::amcfoc::cm7::theCANagentCORE::set(const embot::prot::can::bootloader::Message_SET_ADDITIONAL_INFO2::Info &info)
{
    if(true == info.valid)
...
bool embot::app::board::amcfoc::cm7::theCANagentCORE::set(const embot::prot::can::shared::Message_SET_ID::Info &info)
{
...
bool embot::app::board::amcfoc::cm7::theCANagentCORE::set(const embot::prot::can::bootloader::Message_SETCANADDRESS::Info &info)
{
