...
static_assert(0x08160000 == EENV_MEMMAP_EMAINTAINER_ROMADDR, "see EENV_MEMMAP_EMAINTAINER_ROMADDR");
constexpr uint32_t offset {EENV_MEMMAP_EMAINTAINER_ROMADDR};  
...
void initSystem(embot::os::Thread *t, void* initparam)
{
    embot::core::print("eMaintainer: this is me");    
    ...
    embot::core::print("eMaintainer: quitting the INIT thread. Normal scheduling starts");    
}
