...
bool embot::hw::bsp::specialize() { return true; }
    ...
    bool embot::hw::bsp::specialize()
    {
        ...
        switch(amcfocm7::defOnSpec.cm4mode)
        {
            case amcfocm7::OnSpecialize::CM4MODE::activateandhold:
            {
            ...
            case amcfocm7::OnSpecialize::CM4MODE::release:
            {
        ...
        if(true == amcfocm7::defOnSpec.enableJ5spi_123_at_startup)
        {
//            prepare_connector_j5_spi123();
        }
        
        if(true == amcfocm7::defOnSpec.enableJ5powersupply_at_startup)
        {
//           J5power(true);
        }
