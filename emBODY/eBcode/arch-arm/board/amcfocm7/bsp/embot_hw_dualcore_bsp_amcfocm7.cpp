...
namespace embot::hw::dualcore::bsp {         
    ...
    constexpr PROP _cm7 = { embot::hw::dualcore::CORE::cm7, embot::hw::dualcore::BOOT::cm7master };  
    ...
    constexpr PROP _cm7 = { embot::hw::dualcore::CORE::cm7, embot::hw::dualcore::BOOT::cm4master };
