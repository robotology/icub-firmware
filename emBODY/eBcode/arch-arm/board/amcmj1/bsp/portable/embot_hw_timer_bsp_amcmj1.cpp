...
namespace embot::hw::timer::bsp::impl {
...
namespace embot::hw::timer::bsp::stm32 {
    ...
    void HAL_TIM_Base_MspInit(void* p)      { embot::hw::timer::bsp::impl::HAL_TIM_Base_MspInit(p); }
    void HAL_TIM_Base_MspDeInit(void* p)    { embot::hw::timer::bsp::impl::HAL_TIM_Base_MspDeInit(p); }
