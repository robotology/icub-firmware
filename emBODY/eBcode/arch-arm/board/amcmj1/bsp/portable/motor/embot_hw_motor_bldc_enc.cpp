...
namespace embot::hw::motor::bldc::enc {
    ...
    {
        #warning TOBE reviewed
        embot::hw::motor::bldc::enc::bsp::init(m);
    ...
    { 
        embot::hw::motor::bldc::enc::bsp::deinit(m);
    ...
    bool start(embot::hw::MOTOR m, const Mode& mode)
    {
        ...
        ret = embot::hw::motor::bldc::enc::bsp::init(m);
    ...
    {
        float r = 0.0;
        int32_t anglenew = embot::hw::motor::bldc::enc::bsp::counter(m);
...
#define REMOVE_ENC_BSP
#if defined(REMOVE_ENC_BSP)
#else
remove everything as it in now in bsp_amcmj1
...
//            anglenew = __HAL_TIM_GetCounter(&htimEnc1);
//            r = static_cast <float> (anglenew)*_enc_internals._items[embot::core::tointegral(m)].conversionfactor;
//        }
//        else if (1 == embot::core::tointegral(m))
//        {
//            anglenew = __HAL_TIM_GetCounter(&htimEnc2);
//            r = static_cast <float> (anglenew)*_enc_internals._items[embot::core::tointegral(m)].conversionfactor;
//        }
    }
}
...
#if !defined(STM32HAL_BOARD_AMCMJ1_1CM7) && !defined(STM32HAL_BOARD_AMCMJ1_2CM4)
#error this implemnettaion of hw::motor::bldc::hall is for amcmj1 only
#endif


#if defined(STM32HAL_BOARD_AMCMJ1_1CM7) || defined(STM32HAL_BOARD_AMCMJ1_2CM4)
#include "embot_hw_motor_bldc_bsp_amcmj1.h"
#endif

    constexpr auto QEncoder1Mode TIM_ENCODERMODE_TI12;
    constexpr auto QEncoder2Mode TIM_ENCODERMODE_TI12;
    
    std::array<uint8_t, embot::hw::motor::bldc::MAXnumber> QEncMode {QEncoder1Mode, QEncoder2Mode};
    ...
    static_assert(ENC_STATUS_IDLE == embot::hw::motor::bldc::enc::enc_Data::STATUS_IDLE, "");
    static_assert(ENC_STATUS_WAIT == embot::hw::motor::bldc::enc::enc_Data::STATUS_WAIT, "");
    static_assert(ENC_STATUS_READY == embot::hw::motor::bldc::enc::enc_Data::STATUS_READY, "");
...
#endif // #if defined(REMOVE_ENC_BSP)
