...
#ifndef __EMBOT_HW_FLASH_BSP_AMCMJ1_H_
#define __EMBOT_HW_FLASH_BSP_AMCMJ1_H_


#include "embot_hw_flash_bsp.h"

namespace embot::hw::flash::bsp::amcmj1 {
...
namespace embot::hw::flash::bsp {
    ...
    {        
        switch(id)
        {
            case embot::hw::flash::Partition::ID::eloader:          { return amcmj1::ldr; } break; 
            case embot::hw::flash::Partition::ID::eupdater:         { return amcmj1::upd; } break;
            case embot::hw::flash::Partition::ID::eapplication00:   { return amcmj1::a00; } break;
            case embot::hw::flash::Partition::ID::buffer00:         { return amcmj1::b00; } break;
            case embot::hw::flash::Partition::ID::eapplication01:   { return amcmj1::a01; } break;
            case embot::hw::flash::Partition::ID::buffer01:         { return amcmj1::b01; } break;
            default:                                                { return amcmj1::dummy;} break;
        }
    ...
    {        
        switch(id)
        {
            case Bank::ID::one:             { return amcmj1::bank01; } break; 
            case Bank::ID::two:             { return amcmj1::bank02; } break;
            default:                        { return amcmj1::bank01;} break;
        }
