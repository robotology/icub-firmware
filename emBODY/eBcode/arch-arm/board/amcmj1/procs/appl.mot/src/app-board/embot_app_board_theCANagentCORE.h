...
#ifndef __EMBOT_APP_BOARD_THECANAGENTCORE_H_
#define __EMBOT_APP_BOARD_THECANAGENTCORE_H_
...
namespace embot::app::board {
       
    class theCANagentCORE : public embot::app::application::CANagentCORE
    {    
    public:
        static theCANagentCORE& getInstance();
#warning dont use amc2c    
        struct Config
        {
            embot::prot::can::Board board {embot::prot::can::Board::amc2c}; 
            ...
            const char *boardinfo {"hello, i am an amc*"};            
