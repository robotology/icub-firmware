...
#define BT_CONFIG         GPIOE, GPIO_PIN_0
...
#define LED_CAN_ON        HAL_GPIO_WritePin(CAN1_LED, GPIO_PIN_RESET);
#define LED_CAN_OFF       HAL_GPIO_WritePin(CAN1_LED, GPIO_PIN_SET);

#define BT_CONFIG_ON      HAL_GPIO_WritePin(BT_CONFIG, GPIO_PIN_SET);
#define BT_CONFIG_OFF     HAL_GPIO_WritePin(BT_CONFIG, GPIO_PIN_RESET);
