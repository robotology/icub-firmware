...
#define EOMTHEEMSAPPLCFG_ID_OF_EMSBOARD     0
    ...
    #if (emBODYrobot_BOARD_NUMBER != boardnumberANY) && (emBODYrobot_BOARD_NUMBER != boardnumberNONE)
        //#warning --> compiling using emBODYrobot_BOARD_NUMBER
        #define EOMTHEEMSAPPLCFG_ID_OF_EMSBOARD emBODYrobot_BOARD_NUMBER
    #else
...
//  <i> default: 512
#define EOMTHEEMSAPPLCFG_CFGOBJ_TASK_STACKSIZEof   4096
...
#define EOMTHEEMSAPPLCFG_RUNOBJ_TIMER_N_ALERTRX   5
...
#define EOMTHEEMSAPPLCFG_RUNOBJ_TIMER_N_ALERTDO   6
...
#define EOMTHEEMSAPPLCFG_RUNOBJ_TIMER_N_ALERTTX   7
