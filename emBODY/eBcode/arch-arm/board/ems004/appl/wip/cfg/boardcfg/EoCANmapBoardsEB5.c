...
static const eOcanmap_board_properties_t s_boardprops[] = 
{
    ...
    {
        .type               = eobrd_cantype_none, //eobrd_cantype_1foc,
        .location =
        {
            .port   = eOcanport1,
            .addr   = 2         
...
static EOconstvector s_eo_vectorof_boardprops_eb5 = 
{
...
EOconstvector* eo_vectorof_boardprops_eb5 = &s_eo_vectorof_boardprops_eb5;
...
EOconstvector s_eo_vectorof_des_jomo_eb5 = 
{
...
EOconstvector* eo_vectorof_descriptor_jomo_eb5 = &s_eo_vectorof_des_jomo_eb5;
