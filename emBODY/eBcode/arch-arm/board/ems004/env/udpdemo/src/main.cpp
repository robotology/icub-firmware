...
embot::os::Timer *conntmt {nullptr};

constexpr eOmessage_t msgConnect = 0x00000002;

static void sendConnectRequest(void *p)
{
    EOMtask *t = reinterpret_cast<EOMtask*>(p);
    eom_task_SendMessage(t, msgConnect, 0);    
}
...
static void s_ethcommand_startup(EOMtask *p, uint32_t t)
{
    ...
    conntmt = new embot::os::Timer;
    embot::os::Action act(embot::os::CallbackToThread(sendConnectRequest, p, nullptr));
