...
enum { eoprot_b06_mn_comms_numberof = 1, eoprot_b06_mn_appls_numberof = 1, eoprot_b06_mn_infos_numberof = 1 };
...
typedef struct                  // 124+24+40 = 168              
{
    ...
    eOmn_info_t                 info;
} eOprot_b06_management_t;      //EO_VERIFYsizeof(eOprot_b06_management_t, 168); 
