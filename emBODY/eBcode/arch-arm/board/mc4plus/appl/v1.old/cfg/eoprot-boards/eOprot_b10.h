...
enum { eoprot_b10_mn_comms_numberof = 1, eoprot_b10_mn_appls_numberof = 1, eoprot_b10_mn_infos_numberof = 1 };
...
typedef struct                  // 124+24+40 = 168              
{
    ...
    eOmn_info_t                 info;
} eOprot_b10_management_t;      //EO_VERIFYsizeof(eOprot_b10_management_t, 168); 
...
/** @fn         extern eOresult_t eoprot_b10_Initialise(void* p, eObool_t islocal)
    @brief      Initialises the endpoints of this board by loading the number of 
                ...
                with brd = eoprot_b10_boardnumber.
