...
static const std::uint32_t address = embot::hw::flash::getpartition(embot::hw::flash::ID::application).address;
static const std::uint32_t defaultvectorlocation = embot::hw::flash::bankproperties(address).address;
