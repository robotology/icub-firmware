...
#else
    #error this file is only for STM32HAL_BOARD_MTB4C
#endif
...
#if defined(STM32HAL_BOARD_MTB4C) | defined(STM32HAL_BOARD_STRAIN2) | defined(STM32HAL_BOARD_RFE)
...
namespace embot { namespace hw { namespace bno055 {
    ...
    #if defined(STM32HAL_BOARD_MTB4C) || defined(STM32HAL_BOARD_STRAIN2)
