...
#include "embot_hw_bsp_mtb4fap.h"
...
void mySYS::userdefInit_Extra(embot::os::EventThread* evtsk, void *initparam) const
{
    ...
    embot::app::application::theIMU::Config configimu(embot::hw::bsp::mtb4fap::imuBOSCH, embot::hw::bsp::mtb4fap::imuBOSCHconfig, evIMUtick, evIMUdataready, evtsk);
    ...
    embot::app::application::theTHERMO::Config configthermo(embot::hw::bsp::mtb4fap::thermometer, embot::hw::bsp::mtb4fap::thermometerconfig, evTHERMOtick, evTHERMOdataready, evtsk);
