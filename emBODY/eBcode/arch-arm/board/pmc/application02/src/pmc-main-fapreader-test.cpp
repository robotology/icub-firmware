...
embot::app::ctrl::tCTRL *t_ctrl {nullptr};
    ...
    using namespace embot::app::application;
        ...
        constexpr theFAPreader::Sensor s2 {
            ...
            embot::hw::tlv493d::Config{ embot::hw::i2c::Descriptor{embot::hw::I2C::two, embot::hw::i2c::Speed::standard100} }, 
            evtSNSR02_askdata,
            evtSNSR02_dataready,
            evtSNSR02_noreply,
        ...
        constexpr theFAPreader::Sensor s3 {
            ...
            embot::hw::tlv493d::Config{ embot::hw::i2c::Descriptor{embot::hw::I2C::three, embot::hw::i2c::Speed::standard100} }, 
            evtSNSR03_askdata,
            evtSNSR03_dataready,
            evtSNSR03_noreply,
            0 //5*embot::core::time1millisec // timeout  
        ...
        constexpr theFAPreader::Sensor s4 {
            ...
            embot::hw::tlv493d::Config{ embot::hw::i2c::Descriptor{embot::hw::I2C::four, embot::hw::i2c::Speed::standard100} }, 
            evtSNSR04_askdata,
            evtSNSR04_dataready,
            evtSNSR04_noreply,
            0 //5*embot::core::time1millisec // timeout  
        ...
        constexpr std::array<theFAPreader::Sensor,theFAPreader::numberofpositions> sfaps { s1, s2, s3, s4, {}, {} };
//        constexpr std::array<theFAPreader::Sensor,theFAPreader::numberofpositions> sfaps { s3, s4, s5, s6, {}, {} };
