...
embot::app::ctrl::tCTRL *t_ctrl {nullptr};
    ...
    constexpr thePOSreader2::Sensor s1 {
        ...
        embot::prot::can::analog::posLABEL::zero, // as eobrd_portpos_hand_thumb_oc = 0
    ...
    constexpr thePOSreader2::Sensor s2 {
        ...
        embot::prot::can::analog::posLABEL::one,  // as eobrd_portpos_hand_index_oc = 1
    ...
    constexpr thePOSreader2::Sensor s5 {
        ...
        embot::prot::can::analog::posLABEL::four, // as eobrd_portpos_hand_thumb_add = 4
    ...
    constexpr thePOSreader2::Sensor s6 {
        ...
        embot::prot::can::analog::posLABEL::six, // as eobrd_portpos_hand_index_add = 6
        {embot::prot::can::analog::polling::deciDegCalib({})},
        evtSNSR06_askdata,
        evtSNSR06_dataready,
        evtSNSR06_noreply,
