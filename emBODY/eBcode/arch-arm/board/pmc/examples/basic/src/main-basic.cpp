...
// the led section. we use PB0
    ...
    #warning we are using board pmc, led is on pd6
    // led1 is on PG9
    static GPIO_TypeDef * GPIOLED = GPIOD;
    static const uint16_t PinLED = GPIO_PIN_6;
    static void clockEnableLED() {  __HAL_RCC_GPIOD_CLK_ENABLE(); }
