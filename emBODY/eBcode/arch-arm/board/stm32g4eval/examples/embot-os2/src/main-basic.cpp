...
{          
    ...
    embot::hw::sys::puts("taking mutex @ time = " + tf.to_string(embot::core::TimeFormatter::Mode::full));  
    bool resu = true;
//    resu = embot::os::rtos::mutex_take(mutex, 10*1000*1000);
    
    embot::core::TimeFormatter tf1(embot::core::now());
    embot::hw::sys::puts("mutex result is " + std::to_string(resu) + "@ time = " + tf1.to_string(embot::core::TimeFormatter::Mode::full)); 
