...
// marco.accame@iit.it: revised on aug 2020.
// - removed osal
...
// evaluates if to stay in updater or to jump to application now or after a timeout
...
//    uncomment one of the two only if you want to debug      
    #warning CAVEAT: we are debugging and we have infinite time2stay. normally it is 5 secs
