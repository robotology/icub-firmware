...
/** @fn         ipal_udpsocket_t* ipal_udpsocket_new(ipal_tos_t tos)
...
/** @fn         ipal_result_t ipal_udpsocket_delete(ipal_udpsocket_t* skt)
...
/** @fn         ipal_result_t ipal_udpsocket_bind(ipal_udpsocket_t* skt, ipal_ipv4addr_t locaddr, ipal_port_t locport)
