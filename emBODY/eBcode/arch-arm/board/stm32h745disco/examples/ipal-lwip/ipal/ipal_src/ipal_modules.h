...
#define     IPAL_USE_BASE				/* IPAL KERNEL		*/ 
#define     IPAL_USE_SYS				/* IPAL KERNEL		*/
#define     IPAL_USE_ETH				/* IPAL KERNEL		*/
#define     IPAL_USE_ARP				/* IPAL SERVICES 	*/
//#define     IPAL_USE_DHCP
//#define     IPAL_USE_FTP
//#define     IPAL_USE_TCP
//#define     IPAL_USE_TELNET
//#define     IPAL_USE_TFTP
#define     IPAL_USE_IGMP				/* IPAL SERVICES 	*/
#define     IPAL_USE_UDP				/* IPAL SERVICES 	*/
