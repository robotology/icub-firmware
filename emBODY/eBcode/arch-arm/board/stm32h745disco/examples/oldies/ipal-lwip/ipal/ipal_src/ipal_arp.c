 ...
 * See header file for details
 */
uint32_t ipal_arp_hid_getsize(const ipal_cfg_t *cfg)
{
	/* No memory needed */
	return(0);
}
 ...
 * See header file for details
 */
ipal_result_t ipal_arp_hid_setmem(const ipal_cfg_t *cfg, uint32_t *memory)
{
	/* No memory needed */
	return(ipal_res_OK); 
}
 ...
 * See header file for details
 */
ipal_result_t ipal_arp_hid_init(ipal_cfg_t *cfg)
{
	/* Nothing is required */
	return(ipal_res_OK); 
}
 ...
 * See header file for details
 */
ipal_result_t ipal_arp_hid_vars_init(const ipal_cfg_t *cfg)
{
