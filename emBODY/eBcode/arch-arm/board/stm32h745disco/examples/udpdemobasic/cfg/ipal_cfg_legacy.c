...
ipal_result_t hal_eth_init(void *p) 
{ 
    return ipal_res_OK; 
}

ipal_result_t hal_eth_enable(void *p) 
{ 
    return ipal_res_OK; 
}

ipal_result_t hal_eth_disable(void *p) 
{ 
    return ipal_res_OK; 
}

ipal_result_t hal_eth_sendframe(void *p) 
{ 
    return ipal_res_OK; 
}
