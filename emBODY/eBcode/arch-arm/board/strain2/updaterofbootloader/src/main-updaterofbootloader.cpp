...
static const embot::app::canprotocol::versionOfAPPLICATION vAP = {100, 3 , 0};
...
#else    
    embot::hw::sys::relocatevectortable(embot::hw::sys::addressOfApplication);
#endif
...
static void bl_activity(void* param)
{
    ...
    ledconfig.led_enable_mask   = (1 << eo_ledpulser_led_zero) | (1 << eo_ledpulser_led_one);
    ...
    eo_ledpulser_Start(eo_ledpulser_GetHandle(), eo_ledpulser_led_one, period, 0);    
