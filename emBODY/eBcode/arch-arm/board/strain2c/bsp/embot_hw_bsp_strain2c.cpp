...
#else
    #error this file is only for STM32HAL_BOARD_STRAIN2C
#endif
...
namespace embot { namespace hw { namespace si7051 {
    ...
    // added support for second sensor D.T.
    constexpr PROP prop01 { embot::hw::i2c::Descriptor{embot::hw::I2C::one, 0x80} }; 
    constexpr PROP prop02 { embot::hw::i2c::Descriptor{embot::hw::I2C::two, 0x80} }; 

    constexpr BSP thebsp {        
        // maskofsupported
        mask::pos2mask<uint32_t>(SI7051::one)| mask::pos2mask<uint32_t>(SI7051::two),        
        // properties
        {{
            &prop01, &prop02             
        }}        
...
#if defined(STM32HAL_BOARD_MTB4) | defined(STM32HAL_BOARD_STRAIN2C) | defined(STM32HAL_BOARD_RFE)
