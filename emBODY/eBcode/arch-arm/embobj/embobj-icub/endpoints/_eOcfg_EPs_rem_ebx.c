...
static uint16_t s_eo_cfg_nvsEP_rem_ebx_hashfunction_ep2index(uint16_t ep);
...
static const eOnvscfg_EP_t s_eo_cfg_EPs_vectorof_rem_ebx_data[] =
{  
    {   // mngmnt
...
static const EOconstvector s_eo_cfg_EPs_vectorof_rem_ebx = 
{
    EO_INIT(.size)                  sizeof(s_eo_cfg_EPs_vectorof_rem_ebx_data)/sizeof(const eOnvscfg_EP_t),
    EO_INIT(.item_size)             sizeof(eOnvscfg_EP_t),
    EO_INIT(.item_array_data)       s_eo_cfg_EPs_vectorof_rem_ebx_data
};
...
extern const EOconstvector* const eo_cfg_EPs_vectorof_rem_ebx = &s_eo_cfg_EPs_vectorof_rem_ebx;

extern const eOuint16_fp_uint16_t eo_cfg_nvsEP_rem_ebx_fptr_hashfunction_ep2index = s_eo_cfg_nvsEP_rem_ebx_hashfunction_ep2index;
