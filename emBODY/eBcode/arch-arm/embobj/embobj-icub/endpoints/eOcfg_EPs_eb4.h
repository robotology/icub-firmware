...
/** @fn         extern void* eo_cfg_nvsEP_eb4_Get_RAM(eOnvEP_t ep, eOnvscfgOwnership_t ownership)
 ...
 **/
extern void* eo_cfg_nvsEP_eb4_Get_RAM(eOnvEP_t ep, eOnvscfgOwnership_t ownership);
