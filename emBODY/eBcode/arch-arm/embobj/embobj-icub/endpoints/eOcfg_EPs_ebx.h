...
// - include guard ----------------------------------------------------------------------------------------------------
#ifndef _EOCFG_EPS_EBX_H_
#define _EOCFG_EPS_EBX_H_




/** @file       eOcfg_EPs_ebx.h
...
/** @fn         extern void* eo_cfg_nvsEP_ebx_Get_remotelyownedRAM(eOnvEP_t ep, eOnvscfgOwnership_t ownership)
 ...
 **/
extern void* eo_cfg_nvsEP_ebx_Get_remotelyownedRAM(eOnvEP_t ep, eOnvscfgOwnership_t ownership);


/** @fn         extern void* eo_cfg_nvsEP_ebx_Get_locallyownedRAM(eOnvEP_t ep)
    ...
    @return     The pointer to teh memory or NULL if the memory is not initialised yet or if the ep is not recognised
 **/
extern void* eo_cfg_nvsEP_ebx_Get_locallyownedRAM(eOnvEP_t ep);
...
extern const EOconstvector* const eo_cfg_EPs_vectorof_ebx;

// if not NULL it contains a mapping from EPs to index inside eo_cfg_EPs_vectorof_ebx
extern const eOuint16_fp_uint16_t eo_cfg_nvsEP_ebx_fptr_hashfunction_ep2index;
