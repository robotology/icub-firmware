...
#define EOK_cfg_nvsEP_mc_lowerleg_NUMofJOINTS                                        (2)
//the number of motors used in the endpoint
#define EOK_cfg_nvsEP_mc_lowerleg_NUMofMOTORS                                        (2)
...
extern EOtreenode eo_cfg_nvsEP_mc_lowerleg_tree_con[] =
{
    ...
    {   // 0
        ...
        EO_INIT(.pchildren) {&eo_cfg_nvsEP_mc_lowerleg_tree_con[Jindex( 0, 1)], &eo_cfg_nvsEP_mc_lowerleg_tree_con[Jindex( 0, 2)], &eo_cfg_nvsEP_mc_lowerleg_tree_con[Jindex( 0, 3)], 
                             &eo_cfg_nvsEP_mc_lowerleg_tree_con[Jindex( 0, 4)], &eo_cfg_nvsEP_mc_lowerleg_tree_con[Jindex( 0, 5)], &eo_cfg_nvsEP_mc_lowerleg_tree_con[Jindex( 0, 6)],
                             &eo_cfg_nvsEP_mc_lowerleg_tree_con[Jindex( 0, 7)], &eo_cfg_nvsEP_mc_lowerleg_tree_con[Jindex( 0, 8)], &eo_cfg_nvsEP_mc_lowerleg_tree_con[Jindex( 0, 9)],
                             &eo_cfg_nvsEP_mc_lowerleg_tree_con[Jindex( 0,10)], &eo_cfg_nvsEP_mc_lowerleg_tree_con[Jindex( 0,11)], &eo_cfg_nvsEP_mc_lowerleg_tree_con[Jindex( 0,12)],
                             &eo_cfg_nvsEP_mc_lowerleg_tree_con[Jindex( 0,13)], &eo_cfg_nvsEP_mc_lowerleg_tree_con[Jindex( 0,14)]}
    },
        {   // 1
    ...
    {   //15
        ...
        EO_INIT(.pchildren) {&eo_cfg_nvsEP_mc_lowerleg_tree_con[Jindex( 0,16)], &eo_cfg_nvsEP_mc_lowerleg_tree_con[Jindex( 0,17)], &eo_cfg_nvsEP_mc_lowerleg_tree_con[Jindex( 0,18)]}
    ...
    {   // 0
        ...
        EO_INIT(.pchildren) {&eo_cfg_nvsEP_mc_lowerleg_tree_con[Jindex( 1, 1)], &eo_cfg_nvsEP_mc_lowerleg_tree_con[Jindex( 1, 2)], &eo_cfg_nvsEP_mc_lowerleg_tree_con[Jindex( 1, 3)], 
                             &eo_cfg_nvsEP_mc_lowerleg_tree_con[Jindex( 1, 4)], &eo_cfg_nvsEP_mc_lowerleg_tree_con[Jindex( 1, 5)], &eo_cfg_nvsEP_mc_lowerleg_tree_con[Jindex( 1, 6)],
                             &eo_cfg_nvsEP_mc_lowerleg_tree_con[Jindex( 1, 7)], &eo_cfg_nvsEP_mc_lowerleg_tree_con[Jindex( 1, 8)], &eo_cfg_nvsEP_mc_lowerleg_tree_con[Jindex( 1, 9)],
                             &eo_cfg_nvsEP_mc_lowerleg_tree_con[Jindex( 1,10)], &eo_cfg_nvsEP_mc_lowerleg_tree_con[Jindex( 1,11)], &eo_cfg_nvsEP_mc_lowerleg_tree_con[Jindex( 1,12)],
                             &eo_cfg_nvsEP_mc_lowerleg_tree_con[Jindex( 1,13)], &eo_cfg_nvsEP_mc_lowerleg_tree_con[Jindex( 1,14)]}
    },
        {   // 1
    ...
    {   //15
        ...
        EO_INIT(.pchildren) {&eo_cfg_nvsEP_mc_lowerleg_tree_con[Jindex( 1,16)], &eo_cfg_nvsEP_mc_lowerleg_tree_con[Jindex( 1,17)], &eo_cfg_nvsEP_mc_lowerleg_tree_con[Jindex( 1,18)]}
    ...
    {   // 0
        ...
        EO_INIT(.pchildren) {&eo_cfg_nvsEP_mc_lowerleg_tree_con[Mindex( 0, 1)], &eo_cfg_nvsEP_mc_lowerleg_tree_con[Mindex( 0, 2)], &eo_cfg_nvsEP_mc_lowerleg_tree_con[Mindex( 0, 3)], 
                             &eo_cfg_nvsEP_mc_lowerleg_tree_con[Mindex( 0, 4)]}
    },
        {   // 1
    ...
    {   // 5
        ...
        EO_INIT(.pchildren) {&eo_cfg_nvsEP_mc_lowerleg_tree_con[Mindex( 0, 6)], &eo_cfg_nvsEP_mc_lowerleg_tree_con[Mindex( 0, 7)]}
    },  
         {   // 6
    ...
    {   // 0
        ...
        EO_INIT(.pchildren) {&eo_cfg_nvsEP_mc_lowerleg_tree_con[Mindex( 1, 1)], &eo_cfg_nvsEP_mc_lowerleg_tree_con[Mindex( 1, 2)], &eo_cfg_nvsEP_mc_lowerleg_tree_con[Mindex( 1, 3)], 
                             &eo_cfg_nvsEP_mc_lowerleg_tree_con[Mindex( 1, 4)]}
    },
        {   // 1
    ...
    {   // 5
        ...
        EO_INIT(.pchildren) {&eo_cfg_nvsEP_mc_lowerleg_tree_con[Mindex( 1, 6)], &eo_cfg_nvsEP_mc_lowerleg_tree_con[Mindex( 1, 7)]}
    },  
         {   // 6
...
extern const EOconstvector* const eo_cfg_nvsEP_mc_lowerleg_constvector_of_treenodes_EOnv_con = &s_eo_cfg_nvsEP_mc_lowerleg_constvector_of_treenodes_EOnv_con;


extern const eOuint16_fp_uint16_t eo_cfg_nvsEP_mc_lowerleg_fptr_hashfunction_id2index = eo_cfg_nvsEP_mc_lowerleg_hashfunction_id2index;
...
extern eOnvID_t eo_cfg_nvsEP_mc_lowerleg_NVID_for_joint_var_Get(eo_cfg_nvsEP_mc_lowerleg_con_jointNumber_t j, eo_cfg_nvsEP_mc_lowerleg_con_jointNVindex_t jnvindex)
{
...
extern eOnvID_t eo_cfg_nvsEP_mc_lowerleg_NVID_for_motor_var_Get(eo_cfg_nvsEP_mc_lowerleg_con_motorNumber_t m, eo_cfg_nvsEP_mc_lowerleg_con_motorNVindex_t mnvindex)
{
