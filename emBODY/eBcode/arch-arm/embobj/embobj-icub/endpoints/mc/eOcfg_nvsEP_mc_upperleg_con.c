...
#define EOK_cfg_nvsEP_mc_upperleg_NUMofJOINTS                                        (4)
//the number of motors used in the endpoint
#define EOK_cfg_nvsEP_mc_upperleg_NUMofMOTORS                                        (4)

//the total number of nvs in the endpoint
#define EOK_cfg_nvsEP_upperleg_NUMofVARS                                             ((EOK_cfg_nvsEP_mc_any_con_jxx_jnvindex_TOTALnumber*EOK_cfg_nvsEP_mc_upperleg_NUMofJOINTS)+(EOK_cfg_nvsEP_mc_any_con_mxx_mnvindex_TOTALnumber*EOK_cfg_nvsEP_mc_upperleg_NUMofMOTORS))
...
extern const eOmc_joint_t* eo_cfg_nvsEP_mc_upperleg_joint_defaultvalue = &eo_cfg_nvsEP_mc_any_con_jxxdefault_defaultvalue;
extern const eOmc_motor_t* eo_cfg_nvsEP_mc_upperleg_motor_defaultvalue = &eo_cfg_nvsEP_mc_any_con_mxxdefault_defaultvalue;
...
extern EOtreenode eo_cfg_nvsEP_mc_upperleg_tree_con[] =
{
    // joint-j00
    // jconfig
    {   // 0
...
extern const EOconstvector* const eo_cfg_nvsEP_mc_upperleg_constvector_of_treenodes_EOnv_con = &s_eo_cfg_nvsEP_mc_upperleg_constvector_of_treenodes_EOnv_con;


extern const eOuint16_fp_uint16_t eo_cfg_nvsEP_mc_upperleg_fptr_hashfunction_id2index = eo_cfg_nvsEP_mc_upperleg_hashfunction_id2index;
