...
// - include guard ----------------------------------------------------------------------------------------------------
#ifndef _EOCFG_EPS_EB4_H_
#define _EOCFG_EPS_EB4_H_
...
/** @file       eOcfg_EPs_eb4.h
	@brief      This header file contains a const configuration for the endpoints of board EB4 (rigth arm, lower)
...
extern const EOconstvector eo_cfg_EPs_vectorof_eb4_object;

// EOconstvector where each element is a eOnvscfg_EP_t
extern const EOconstvector* const eo_cfg_EPs_vectorof_eb4;

// if not NULL it contains a mapping from EPs to index inside eo_cfg_EPs_vectorof_eb4
extern const eOuint16_fp_uint16_t eo_cfg_nvsEP_eb4_fptr_hashfunction_ep2index;


// - declaration of extern public functions ---------------------------------------------------------------------------

extern uint16_t eo_cfg_nvsEP_eb4_hashfunction_ep2index(uint16_t ep);

/** @fn         extern void* eo_cfg_nvsEP_eb4_Get_remotelyownedRAM(eOnvEP_t ep, eOnvscfgOwnership_t ownership)
 ...
 **/
extern void* eo_cfg_nvsEP_eb4_Get_remotelyownedRAM(eOnvEP_t ep, eOnvscfgOwnership_t ownership);

/** @fn         extern void* eo_cfg_nvsEP_eb4_Get_locallyownedRAM(eOnvEP_t ep)
    ...
    @return     The pointer to teh memory or NULL if the memory is not initialised yet or if the ep is not recognised
 **/
extern void* eo_cfg_nvsEP_eb4_Get_locallyownedRAM(eOnvEP_t ep);
