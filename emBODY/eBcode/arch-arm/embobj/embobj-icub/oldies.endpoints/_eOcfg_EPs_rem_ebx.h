...
// - include guard ----------------------------------------------------------------------------------------------------
#ifndef _EOCFG_EPS_REM_EBX_H_
#define _EOCFG_EPS_REM_EBX_H_




/** @file       eOcfg_EPs_rem_ebx.h
...
//#include "eOcfg_nvsEP_mngmnt_usr_rem_ebx.h"
...
extern const EOconstvector* const eo_cfg_EPs_vectorof_rem_ebx;

// if not NULL it contains a mapping from EPs to index inside eo_cfg_EPs_vectorof_rem_ebx
extern const eOuint16_fp_uint16_t eo_cfg_nvsEP_rem_ebx_fptr_hashfunction_ep2index;
