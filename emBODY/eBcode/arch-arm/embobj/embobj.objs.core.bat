...
set TYP=core
set LST=(EOaction EOarray EoCommon EOconstarray EOconstvector EOdeque EOfifo EOfifoByte EOfifoWord EOlist EOtheErrorManager EOtheMemoryPool EOtimer EOvector)
