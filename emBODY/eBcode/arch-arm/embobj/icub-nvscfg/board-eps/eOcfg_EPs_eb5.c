...
static uint8_t s_hashtable[64] = 
{
    ...
    // 16-31: MC endpoint_mc_torso is 0x15 and is in pos 2
    0xff, 0xff, 0xff, 0xff, 0xff,    2, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 
    // 32-47: 
...
static uint16_t s_eo_cfg_nvsEP_eb5_hashfunction_ep2index(uint16_t ep)
{
    ...
    { 
        endpoint_mn_comm,        endpoint_mn_appl,      endpoint_mc_torso
    };
