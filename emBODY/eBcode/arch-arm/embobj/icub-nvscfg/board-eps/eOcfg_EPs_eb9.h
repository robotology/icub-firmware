...
extern const EOconstvector eo_cfg_EPs_vectorof_eb9_object;

// EOconstvector where each element is a eOnvscfg_EP_t
extern const EOconstvector* const eo_cfg_EPs_vectorof_eb9;

// if not NULL it contains a mapping from EPs to index inside eo_cfg_EPs_vectorof_eb9
