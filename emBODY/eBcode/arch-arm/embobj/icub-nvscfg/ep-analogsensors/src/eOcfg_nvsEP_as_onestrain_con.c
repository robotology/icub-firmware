...
EOtreenode eo_cfg_nvsEP_as_onestrain_tree_con[] =
{
    // strain s00
    {   // 0
...
const EOconstvector* const eo_cfg_nvsEP_as_onestrain_constvector_of_treenodes_EOnv_con = &s_eo_cfg_nvsEP_as_onestrain_constvector_of_treenodes_EOnv_con;


const eOuint16_fp_uint16_t eo_cfg_nvsEP_as_onestrain_fptr_hashfunction_id2index = eo_cfg_nvsEP_as_onestrain_hashfunction_id2index;
