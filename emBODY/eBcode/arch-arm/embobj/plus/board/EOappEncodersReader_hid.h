...
typedef enum
{
    hal_encoder_spistream0      = 0,
    hal_encoder_spistream1      = 1,
    hal_encoder_spistreamNONE   = 255   
} hal_encoder_spistream_t; 
...
typedef struct
{
    ...
    uint8_t     maskofsupported[hal_encoders_number];
    uint8_t     usedstream[hal_encoders_number];
    uint8_t     indexinstream[hal_encoders_number];
} hal_encoder_spimapping_t;
