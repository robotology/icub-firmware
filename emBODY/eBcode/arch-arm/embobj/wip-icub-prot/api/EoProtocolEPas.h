...
/** @fn         extern eObool_t eoprot_ep_as_variables_id_isvalid(eOprotBRD_t brd, eOnvID32_t id)
...
/** @fn         extern eOprotID32_t eoprot_ep_as_variable_idfromprognumber_Get(eOprotBRD_t brd, eOprotID32_t prog)
  ...
  */
extern eOprotID32_t eoprot_ep_as_variable_idfromprognumber_Get(eOprotBRD_t brd, eOprotID32_t prog);


/** @fn         extern uint16_t eoprot_ep_as_variable_progressivenumber_Get(eOprotBRD_t brd, eOprotID32_t id)
  ...
  */
extern eOprotID32_t eoprot_ep_as_variable_progressivenumber_Get(eOprotBRD_t brd, eOprotID32_t id);
