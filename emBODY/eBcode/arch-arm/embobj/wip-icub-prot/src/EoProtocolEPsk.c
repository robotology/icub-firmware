...
typedef enum
{
    eoprot_ep_sk_vars_numberof_leftlowerarm   = eoprot_ep_sk_skins_numberof_leftlowerarm*eoprot_ep_sk_skin_tags_numberof,                                                    
    eoprot_ep_sk_vars_numberof_rightlowerarm  = eoprot_ep_sk_skins_numberof_rightlowerarm*eoprot_ep_sk_skin_tags_numberof,                                               
...
static const uint8_t s_eoprot_ep_sk_number_of_skins[] = 
{   
    eoprot_ep_sk_skins_numberof_leftlowerarm,
    eoprot_ep_sk_skins_numberof_rightlowerarm
};    
...
{
    return(s_eoprot_ep_sk_number_of_skins[s_eoprot_ep_sk_ep2arrayindex(ep)]);
}
