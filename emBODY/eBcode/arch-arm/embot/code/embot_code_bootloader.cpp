...
namespace embot { namespace code { namespace bootloader {
    ...
    struct ActivityParam
    {
        ...
        embot::common::relTime blinkingperiod {BlinkFastPeriod};
        const embot::app::theCANboardInfo::bootloaderInfo *info {nullptr};
        
        ActivityParam() = default;
        ActivityParam(embot::common::relTime ti, const embot::app::theCANboardInfo::bootloaderInfo *in) : blinkingperiod(ti), info(in) {}
    };
...
namespace embot { namespace code { namespace bootloader {
    ...
    constexpr embot::common::relTime timebeforeJump = 5 * embot::common::time1second;
...
namespace embot { namespace code { namespace bootloader {
    ...
    constexpr embot::common::Event evRXcanframe = 0x00000001;
    ...
    void activity_function(void* param)
    {
        ...
        embot::sys::EventTask* eventbasedtask = new embot::sys::EventTask; 
        eventbasedtask->start(configEV);
            
        // start the canparser
        embot::app::bootloader::theCANparser &canparser = embot::app::bootloader::theCANparser::getInstance();
        embot::app::bootloader::theCANparser::Config config {embot::app::canprotocol::Process::bootloader};
        ...
        canconfig.onrxframe = embot::common::Callback(alerteventbasedtask, eventbasedtask); 
