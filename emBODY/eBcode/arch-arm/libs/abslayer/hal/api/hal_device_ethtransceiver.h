...
#ifndef _HAL_DEVICE_ETHTRANSCEIVER_H_
#define _HAL_DEVICE_ETHTRANSCEIVER_H_

// - doxy begin -------------------------------------------------------------------------------------------------------

/** @file       hal_device_ethtransceiver.h
    @brief      This header file implements public interface to the hal ethtransceiver module.
    @author     valentina.gaggero@iit.it, marco.accame@iit.it
    @date       10/18/2011
**/

/** @defgroup arm_hal_device_ethtransceiver HAL ETHTRANSCEIVER
...
/** @typedef    typedef struct hal_device_ethtransceiver_cfg_t;
    @brief      contains configuration data of ethtransceiver.
 **/
typedef struct
{
    uint8_t dummy;          /**< dummy...     */
} hal_device_ethtransceiver_cfg_t;

 
// - declaration of extern public variables, ... but better using use _get/_set instead -------------------------------

extern const hal_device_ethtransceiver_cfg_t hal_device_ethtransceiver_cfg_default;   // = { .dummy = 0};


// - declaration of extern public functions ---------------------------------------------------------------------------

/** @fn			extern hal_result_t hal_device_ethtransceiver_init(const hal_device_ethtransceiver_cfg_t *cfg)
...
/** @fn			extern hal_bool_t hal_device_ethtransceiver_initted_is(void)
...
/** @}            
    end of group arm_hal_device_ethtransceiver  
 **/
