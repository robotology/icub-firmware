...
//add: it is hl_i2c.c revision 26951
...
//rem #include "hl_cfg_plus_modules.h"
...
#include "string.h"
#include "stdio.h"
//rem #include "hl_core.h"        // contains the required stm32f10x_*.h or stm32f4xx*.h header files

//rem #include "hl_gpio.h"
//rem #include "hl_sys.h"

//rem #include "hl_bits.h" 

//rem #include "hl_arch.h"
...
//rem static const uint32_t s_hl_i2c_hw_rcc[] = { RCC_APB1Periph_I2C1, RCC_APB1Periph_I2C2, 0 };
...
{ 
    ...
    //add
    hal_base_hid_on_fatalerror(hal_fatalerror_runtimefault, str);
    return(hl_res_NOK_generic);
}
