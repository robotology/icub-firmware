...
// - include guard ----------------------------------------------------------------------------------------------------
#ifndef _IPAL_TELNET_HID_H_
#define _IPAL_TELNET_HID_H_


/* @file       ipal_telnet_hid.h
	@brief      This file implements hidden interface of the ipal telnet module
...
extern uint8_t ipal_telnet_hid_active;
