...
// - number of  -------------------------------------------------------------------------------------------------------
    ...
    #define IPAL_NUMBEROF_SYSMEMPOOLMAXSIZE          (6*1024) //vale modificato!
    #define IPAL_NUMBEROF_ARPCACHETABLEMAXSIZE       8
    #define IPAL_NUMBEROF_IGMPMAXGROUPS              4
    #define IPAL_NUMBEROF_UDPMAXSOCKETS              6 //vale modificato!
    ...
    #define IPAL_NUMBEROF_IGMPMAXGROUPS              0 //vale modificato!
    #define IPAL_NUMBEROF_UDPMAXSOCKETS              6
    #define IPAL_NUMBEROF_TCPMAXSOCKETS              0 //vale modificato!
    #define IPAL_NUMBEROF_TFTPMAXSESSIONS            0 //vale modificato!
    #define IPAL_NUMBEROF_FTPMAXSESSIONS             0 //vale modificato!
    #define IPAL_NUMBEROF_TELNETMAXSESSIONS          0 //vale modificato!
    #define IPAL_NUMBEROF_DNSCACHETABLEMAXSIZE       0 //vale modificato!
