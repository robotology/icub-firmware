...
typedef struct
{
    ...
    hal_spiencoder_type_t       type;	        /**< Encoder model. type 1: AEA, type 2: AMO Board */
...
typedef struct
{
    uint8_t                 totalnumberofencoders;                                  /**< number of total supported encoders in teh given board */
    uint8_t                 stream2numberofencoders[hal_spiencoder_streams_number];    /**< number of encoders in a given stream */
    hal_spiencoder_stream_t    encoder2stream[hal_spiencoders_number];                    /**< look up table whihc gives the stream given the encoder */
