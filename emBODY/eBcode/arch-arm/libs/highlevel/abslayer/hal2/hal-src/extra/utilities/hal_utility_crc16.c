...
/* @file       hal_utility_crc16.c
    @brief      This file contains implementation of hal_utility_crc16 using lut, as described by Sven Reifegerste
...
extern hal_result_t hal_utility_crc16_hid_static_memory_init(void)
{
    return(hal_res_OK); 
}
