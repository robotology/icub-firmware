...
// -- shared by many
...
#if     !defined(MC2PLUS_USE_MICREL_AS_MANAGED_DEVICE) 
    ...
    #warning --> using micrel as managed device w/ MC2PLUS_USE_MICREL_AS_MANAGED_DEVICE
...
// -- devices
    ...
    // that means: we do not need to do any action on pin to init and drive H or L.
...
//        hal_gpio_setval(map->gpio, hal_gpio_valHIGH);
    ...
    {
        .supportedmask              =  (1 << hal_quadencoder1) | (1 << hal_quadencoder2) | (0 << hal_quadencoder3) | (0 << hal_quadencoder4)
    };
...
#elif   defined(MC2PLUS_USE_MICREL_AS_MANAGED_DEVICE)  
...
#endif//defined(MC2PLUS_USE_MICREL_AS_MANAGED_DEVICE)    
}
