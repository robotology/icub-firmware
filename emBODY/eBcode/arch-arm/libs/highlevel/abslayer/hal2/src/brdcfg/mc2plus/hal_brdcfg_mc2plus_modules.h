...
#ifndef _HAL_BRDCFG_MC2PLUS_MODULES_H_
#define _HAL_BRDCFG_MC2PLUS_MODULES_H_

// - doxy begin -------------------------------------------------------------------------------------------------------

/* @file       hal_brdcfg_mc2plus_modules.h
...
#define HL_USE_UTIL_DMA
#define HL_USE_UTIL_ADC
#undef HL_USE_CHIP_ST_LIS3X
#undef HL_USE_CHIP_ST_L3G4200D

#if     defined(MC2PLUS_ETHDBG)
#define MC2PLUS_USE_MICREL_AS_MANAGED_DEVICE
#endif
