...
ipal_result_t ipal_sys_start(void)
{
	...
	if(ipal_base_hid_cfg2.system->sys_timetick == 0)
	{
	 ...
	 */ 
	s_ipal_sys_timetick_ms = ipal_base_hid_cfg2.system->sys_timetick/1000;
 ...
 * See header file for details
 */
ipal_reltime_t ipal_sys_timetick_get(void)
{
//	if(0 == ipal_base_hid_cfg2.system.sys_timetick)
//	{
//		return(0);
//	}

	return(ipal_base_hid_cfg2.system->sys_timetick);
}
