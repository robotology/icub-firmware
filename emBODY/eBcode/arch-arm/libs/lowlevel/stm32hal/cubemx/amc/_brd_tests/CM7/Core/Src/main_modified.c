...
void TestCM7(void const * argument);
...
///* Overrides the HAL_Delay() function in file stm32h7xx_hal.c */
//void HAL_Delay(uint32_t Delay)
//{
//    osDelay(Delay);
//}

///* Overrides the HAL_GetTick() function in file stm32h7xx_hal.c */
...
/* USER CODE END Boot_Mode_Sequence_2 */
  ...
  /* Create the thread(s) */
  /* definition and creation of TestCM7_Task */
  osThreadDef(TestCM7_Task, TestCM7, osPriorityNormal, 0, 2048);
  TestCM7_TaskHandle = osThreadCreate(osThread(TestCM7_Task), NULL);
...
void MX_CRC_Init(void)
{
  ...
  if (ResMgr_Request(RESMGR_ID_CRC, RESMGR_FLAGS_ACCESS_NORMAL | \
                  RESMGR_FLAGS_CPU2 , 0, NULL) != RESMGR_OK)
  {
    /* USER CODE BEGIN RESMGR_UTILITY_CRC */
    Error_Handler();
    /* USER CODE END RESMGR_UTILITY_CRC */
  }
...
void MX_ETH_Init(void)
{
  ...
  if (ResMgr_Request(RESMGR_ID_ETH, RESMGR_FLAGS_ACCESS_NORMAL | \
                  RESMGR_FLAGS_CPU1 , 0, NULL) != RESMGR_OK)
  {
    /* USER CODE BEGIN RESMGR_UTILITY_ETH */
    Error_Handler();
    /* USER CODE END RESMGR_UTILITY_ETH */
  }
...
void MX_RTC_Init(void)
{
  ...
  if (ResMgr_Request(RESMGR_ID_RTC, RESMGR_FLAGS_ACCESS_NORMAL | \
                  RESMGR_FLAGS_CPU1 , 0, NULL) != RESMGR_OK)
  {
    /* USER CODE BEGIN RESMGR_UTILITY_RTC */
    Error_Handler();
    /* USER CODE END RESMGR_UTILITY_RTC */
  }
...
void MX_SPI5_Init(void)
{
  ...
  if (ResMgr_Request(RESMGR_ID_SPI5, RESMGR_FLAGS_ACCESS_NORMAL | \
                  RESMGR_FLAGS_CPU1 , 0, NULL) != RESMGR_OK)
  {
    /* USER CODE BEGIN RESMGR_UTILITY_SPI5 */
    Error_Handler();
    /* USER CODE END RESMGR_UTILITY_SPI5 */
  }
...
void MX_SPI6_Init(void)
{
  ...
  if (ResMgr_Request(RESMGR_ID_SPI6, RESMGR_FLAGS_ACCESS_NORMAL | \
                  RESMGR_FLAGS_CPU1 , 0, NULL) != RESMGR_OK)
  {
    /* USER CODE BEGIN RESMGR_UTILITY_SPI6 */
    Error_Handler();
    /* USER CODE END RESMGR_UTILITY_SPI6 */
  }
...
void MX_TIM17_Init(void)
{
  ...
  if (ResMgr_Request(RESMGR_ID_TIM17, RESMGR_FLAGS_ACCESS_NORMAL | \
                  RESMGR_FLAGS_CPU1 , 0, NULL) != RESMGR_OK)
  {
    /* USER CODE BEGIN RESMGR_UTILITY_TIM17 */
    Error_Handler();
    /* USER CODE END RESMGR_UTILITY_TIM17 */
  }
...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : CAN2_STBY_Pin CAN1_STBY_Pin CAN_SHDN_Pin */
  ...
  /*Configure GPIO pins : EE_nHOLD_Pin EE_nWP_Pin */
  GPIO_InitStruct.Pin = EE_nHOLD_Pin|EE_nWP_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_MEDIUM;
...
/* USER CODE BEGIN Header_TestCM7 */
/**
  * @brief  Function implementing the TestCM7_Task thread.
  * @param  argument: Not used
  * @retval None
  */
/* USER CODE END Header_TestCM7 */
__weak void TestCM7(void const * argument)
{
  /* USER CODE BEGIN 5 */
    /* Infinite loop */
    for(;;)
