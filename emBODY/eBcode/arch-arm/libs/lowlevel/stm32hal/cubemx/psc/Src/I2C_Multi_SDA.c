...
#define	ACK			0
#define	NACK		1
unsigned int I2Cbit=5; //the duration of a bit 10 is about 28Khz, 1 is about 500KHz


#define	MCO_0_on		HAL_GPIO_WritePin(I2C_CLK_GPIO_Port, I2C_CLK_Pin, GPIO_PIN_SET);
#define	MCO_0_off   HAL_GPIO_WritePin(I2C_CLK_GPIO_Port, I2C_CLK_Pin, GPIO_PIN_RESET);

#define DO_0on      HAL_GPIO_WritePin(I2C_SDA0_GPIO_Port, I2C_SDA0_Pin, GPIO_PIN_SET);\
                    HAL_GPIO_WritePin(I2C_SDA1_GPIO_Port, I2C_SDA1_Pin, GPIO_PIN_SET);\
                    HAL_GPIO_WritePin(I2C_SDA2_GPIO_Port, I2C_SDA2_Pin, GPIO_PIN_SET);\
                    HAL_GPIO_WritePin(I2C_SDA3_GPIO_Port, I2C_SDA3_Pin, GPIO_PIN_SET);

#define DO_0off     HAL_GPIO_WritePin(I2C_SDA0_GPIO_Port, I2C_SDA0_Pin, GPIO_PIN_RESET);\
                    HAL_GPIO_WritePin(I2C_SDA1_GPIO_Port, I2C_SDA1_Pin, GPIO_PIN_RESET);\
                    HAL_GPIO_WritePin(I2C_SDA2_GPIO_Port, I2C_SDA2_Pin, GPIO_PIN_RESET);\
                    HAL_GPIO_WritePin(I2C_SDA3_GPIO_Port, I2C_SDA3_Pin, GPIO_PIN_RESET);

#define DE_0input   DO_0on;\
                    LL_GPIO_SetPinMode(I2C_SDA0_GPIO_Port, I2C_SDA0_Pin, LL_GPIO_MODE_INPUT);\
                    LL_GPIO_SetPinMode(I2C_SDA1_GPIO_Port, I2C_SDA1_Pin, LL_GPIO_MODE_INPUT);\
                    LL_GPIO_SetPinMode(I2C_SDA2_GPIO_Port, I2C_SDA2_Pin, LL_GPIO_MODE_INPUT);\
                    LL_GPIO_SetPinMode(I2C_SDA3_GPIO_Port, I2C_SDA3_Pin, LL_GPIO_MODE_INPUT);\
                    LL_GPIO_SetPinPull(I2C_SDA0_GPIO_Port, I2C_SDA0_Pin, LL_GPIO_PULL_UP);\
                    LL_GPIO_SetPinPull(I2C_SDA1_GPIO_Port, I2C_SDA1_Pin, LL_GPIO_PULL_UP);\
                    LL_GPIO_SetPinPull(I2C_SDA2_GPIO_Port, I2C_SDA2_Pin, LL_GPIO_PULL_UP);\
                    LL_GPIO_SetPinPull(I2C_SDA3_GPIO_Port, I2C_SDA3_Pin, LL_GPIO_PULL_UP);

#define DE_0output  LL_GPIO_SetPinMode(I2C_SDA0_GPIO_Port, I2C_SDA0_Pin, LL_GPIO_MODE_OUTPUT);\
                    LL_GPIO_SetPinMode(I2C_SDA1_GPIO_Port, I2C_SDA1_Pin, LL_GPIO_MODE_OUTPUT);\
                    LL_GPIO_SetPinMode(I2C_SDA2_GPIO_Port, I2C_SDA2_Pin, LL_GPIO_MODE_OUTPUT);\
                    LL_GPIO_SetPinMode(I2C_SDA3_GPIO_Port, I2C_SDA3_Pin, LL_GPIO_MODE_OUTPUT);\
                    LL_GPIO_SetPinOutputType(I2C_SDA0_GPIO_Port, I2C_SDA0_Pin, LL_GPIO_OUTPUT_PUSHPULL);\
                    LL_GPIO_SetPinOutputType(I2C_SDA1_GPIO_Port, I2C_SDA1_Pin, LL_GPIO_OUTPUT_PUSHPULL);\
                    LL_GPIO_SetPinOutputType(I2C_SDA2_GPIO_Port, I2C_SDA2_Pin, LL_GPIO_OUTPUT_PUSHPULL);\
                    LL_GPIO_SetPinOutputType(I2C_SDA3_GPIO_Port, I2C_SDA3_Pin, LL_GPIO_OUTPUT_PUSHPULL);

#define MCE_0input  LL_GPIO_SetPinMode(I2C_CLK_GPIO_Port, I2C_CLK_Pin, LL_GPIO_MODE_INPUT);\
                    LL_GPIO_SetPinOutputType(I2C_CLK_GPIO_Port, I2C_CLK_Pin, LL_GPIO_PULL_UP);

#define MCE_0output LL_GPIO_SetPinMode(I2C_CLK_GPIO_Port, I2C_CLK_Pin, LL_GPIO_MODE_OUTPUT);\
                    LL_GPIO_SetPinOutputType(I2C_CLK_GPIO_Port, I2C_CLK_Pin, LL_GPIO_OUTPUT_PUSHPULL);
...
void SetValReg(i2c_sda_num_t sdaNum, unsigned char val) {
	...
	case sda0: {
      ...
      HAL_GPIO_WritePin(I2C_SDA0_GPIO_Port, I2C_SDA0_Pin, GPIO_PIN_RESET);
		else
			//SET_BIT(GPIOA->ODR, (1 << 9)); //I2C_SDA0
      HAL_GPIO_WritePin(I2C_SDA0_GPIO_Port, I2C_SDA0_Pin, GPIO_PIN_SET);
	}
		break;
	case sda1: {
		if (val == 0)
...
//			ReceivedByte[3] |= ((GPIOA->IDR &(1<<6))>>6);       //Read SDA3 -> data
			ReceivedByte[0] |= HAL_GPIO_ReadPin(I2C_SDA0_GPIO_Port, I2C_SDA0_Pin);  //Read I2C_SDA0 -> data
			ReceivedByte[1] |= HAL_GPIO_ReadPin(I2C_SDA1_GPIO_Port, I2C_SDA1_Pin);  //Read I2C_SDA1 -> data
			ReceivedByte[2] |= HAL_GPIO_ReadPin(I2C_SDA2_GPIO_Port, I2C_SDA2_Pin);  //Read I2C_SDA2 -> data
			ReceivedByte[3] |= HAL_GPIO_ReadPin(I2C_SDA3_GPIO_Port, I2C_SDA3_Pin);  //Read I2C_SDA3 -> data
			Wait(I2Cbit);    //Wait(I2Cbit);
			MCO_0_off
			//Reset SCL
		}
