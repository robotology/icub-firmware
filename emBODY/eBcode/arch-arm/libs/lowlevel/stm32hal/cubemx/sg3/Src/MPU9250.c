...
void MPU9250_Read(uint8_t REGISTER_ADDRESS){
  ...
  HAL_I2C_Master_Transmit_DMA(&hi2c1, (uint16_t)MPU9250_I2C_ADDRESS, (uint8_t*)MPU9250_TxBuffer, sizeof(MPU9250_TxBuffer));
}
...
void MPU9250_Registers(uint8_t REGISTER_ADDRESS, uint8_t VALUE, uint8_t DIM){
  ...
  HAL_I2C_Master_Transmit_DMA(&hi2c1, (uint16_t)MPU9250_I2C_ADDRESS, (uint8_t*)MPU9250_TxBuffer, DIM);
}
