# 1 "../src/board/amcbldc/v120/src/crc.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 373 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../src/board/amcbldc/v120/src/crc.c" 2
# 21 "../src/board/amcbldc/v120/src/crc.c"
# 1 "../src/board/amcbldc/v120/inc\\crc.h" 1
# 28 "../src/board/amcbldc/v120/inc\\crc.h"
...
# 22 "../src/board/amcbldc/v120/src/crc.c" 2
...
void MX_CRC_Init(void)
{
  ...
  hcrc.Init.DefaultPolynomialUse = ((uint8_t)0x00U);
  hcrc.Init.DefaultInitValueUse = ((uint8_t)0x00U);
  hcrc.Init.InputDataInversionMode = 0x00000000U;
  hcrc.Init.OutputDataInversionMode = 0x00000000U;
  hcrc.InputDataFormat = 0x00000003U;
...
void HAL_CRC_MspInit(CRC_HandleTypeDef* crcHandle)
{
  ...
  if(crcHandle->Instance==((CRC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x3000UL)))
  {
    ...
    do { volatile uint32_t tmpreg; ((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->AHB1ENR) |= ((0x1UL << (12U)))); tmpreg = ((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->AHB1ENR) & ((0x1UL << (12U)))); (void)tmpreg; } while(0);
...
void HAL_CRC_MspDeInit(CRC_HandleTypeDef* crcHandle)
{
  ...
  if(crcHandle->Instance==((CRC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x3000UL)))
  {
    ...
    ((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->AHB1ENR) &= ~((0x1UL << (12U))));
