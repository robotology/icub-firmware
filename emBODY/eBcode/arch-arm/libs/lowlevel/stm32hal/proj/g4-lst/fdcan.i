# 1 "../src/board/amcbldc/v120/src/fdcan.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 373 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../src/board/amcbldc/v120/src/fdcan.c" 2
# 21 "../src/board/amcbldc/v120/src/fdcan.c"
# 1 "../src/board/amcbldc/v120/inc\\fdcan.h" 1
# 28 "../src/board/amcbldc/v120/inc\\fdcan.h"
...
# 22 "../src/board/amcbldc/v120/src/fdcan.c" 2
...
void MX_FDCAN2_Init_160mhz(void)
{
  ...
  hfdcan2.Instance = ((FDCAN_GlobalTypeDef *) ((0x40000000UL) + 0x6800UL));
  hfdcan2.Init.FrameFormat = ((uint32_t)((0x1UL << (8U)) | (0x1UL << (9U))));
  hfdcan2.Init.Mode = ((uint32_t)0x00000000U);
  ...
  hfdcan2.Init.TxFifoQueueMode = ((uint32_t)0x00000000U);
...
void MX_FDCAN2_Init(void)
{
  ...
  hfdcan2.Instance = ((FDCAN_GlobalTypeDef *) ((0x40000000UL) + 0x6800UL));
  hfdcan2.Init.FrameFormat = ((uint32_t)0x00000000U);
  hfdcan2.Init.Mode = ((uint32_t)0x00000000U);
  hfdcan2.Init.AutoRetransmission = ENABLE;
  hfdcan2.Init.TransmitPause = ENABLE;
  hfdcan2.Init.ProtocolException = DISABLE;
...
void HAL_FDCAN_MspInit(FDCAN_HandleTypeDef* fdcanHandle)
{
  ...
  if(fdcanHandle->Instance==((FDCAN_GlobalTypeDef *) ((0x40000000UL) + 0x6800UL)))
  {
...
void HAL_FDCAN_MspDeInit(FDCAN_HandleTypeDef* fdcanHandle)
{
  ...
  if(fdcanHandle->Instance==((FDCAN_GlobalTypeDef *) ((0x40000000UL) + 0x6800UL)))
  {
    ...
    ((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->APB1ENR1) &= ~((0x1UL << (25U))));





    HAL_GPIO_DeInit(((GPIO_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x0400UL)), ((uint16_t)0x1000)|((uint16_t)0x2000));
