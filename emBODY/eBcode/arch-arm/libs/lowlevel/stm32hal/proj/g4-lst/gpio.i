# 1 "../src/board/amcbldc/v120/src/gpio.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 373 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../src/board/amcbldc/v120/src/gpio.c" 2
# 21 "../src/board/amcbldc/v120/src/gpio.c"
# 1 "../src/board/amcbldc/v120/inc\\gpio.h" 1
# 28 "../src/board/amcbldc/v120/inc\\gpio.h"
...
# 22 "../src/board/amcbldc/v120/src/gpio.c" 2
# 43 "../src/board/amcbldc/v120/src/gpio.c"
void MX_GPIO_Init(void)
{
  ...
  do { volatile uint32_t tmpreg; ((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->AHB2ENR) |= ((0x1UL << (6U)))); tmpreg = ((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->AHB2ENR) & ((0x1UL << (6U)))); (void)tmpreg; } while(0);
  ...
  HAL_GPIO_WritePin(((GPIO_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x0800UL)), ((uint16_t)0x8000)|((uint16_t)0x0400)|((uint16_t)0x0800), GPIO_PIN_RESET);


  HAL_GPIO_WritePin(((GPIO_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x0400UL)), ((uint16_t)0x0004)|((uint16_t)0x8000)|((uint16_t)0x0020)|((uint16_t)0x0040)
                          |((uint16_t)0x0100)|((uint16_t)0x0200), GPIO_PIN_RESET);


  HAL_GPIO_WritePin(((GPIO_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x0400UL)), ((uint16_t)0x4000), GPIO_PIN_SET);
  ...
  GPIO_InitStruct.Pin = ((uint16_t)0x0004)|((uint16_t)0x8000)|((uint16_t)0x0020);
  GPIO_InitStruct.Mode = (0x00000001U);
  GPIO_InitStruct.Pull = (0x00000000U);
  ...
  GPIO_InitStruct.Pin = ((uint16_t)0x4000)|((uint16_t)0x0040)|((uint16_t)0x0100)|((uint16_t)0x0200);
  GPIO_InitStruct.Mode = (0x00000001U);
  GPIO_InitStruct.Pull = (0x00000000U);
