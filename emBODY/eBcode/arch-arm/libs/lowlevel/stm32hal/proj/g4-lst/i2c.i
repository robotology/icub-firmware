# 1 "../src/board/amcbldc/v120/src/i2c.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 373 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../src/board/amcbldc/v120/src/i2c.c" 2
# 21 "../src/board/amcbldc/v120/src/i2c.c"
# 1 "../src/board/amcbldc/v120/inc\\i2c.h" 1
# 28 "../src/board/amcbldc/v120/inc\\i2c.h"
...
# 22 "../src/board/amcbldc/v120/src/i2c.c" 2
...
void MX_I2C4_Init(void)
{
  ...
  hi2c4.Instance = ((I2C_TypeDef *) ((0x40000000UL) + 0x8400UL));
  hi2c4.Init.Timing = 0x10A0A4F8;
  hi2c4.Init.OwnAddress1 = 0;
  hi2c4.Init.AddressingMode = (0x00000001U);
  hi2c4.Init.DualAddressMode = (0x00000000U);
  hi2c4.Init.OwnAddress2 = 0;
  hi2c4.Init.OwnAddress2Masks = ((uint8_t)0x00U);
  hi2c4.Init.GeneralCallMode = (0x00000000U);
  hi2c4.Init.NoStretchMode = (0x00000000U);
  ...
  if (HAL_I2CEx_ConfigAnalogFilter(&hi2c4, 0x00000000U) != HAL_OK)
  {
    Error_Handler();
  }
...
void HAL_I2C_MspInit(I2C_HandleTypeDef* i2cHandle)
{
  ...
  if(i2cHandle->Instance==((I2C_TypeDef *) ((0x40000000UL) + 0x8400UL)))
  {
    ...
    do { volatile uint32_t tmpreg; ((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->APB1ENR2) |= ((0x1UL << (1U)))); tmpreg = ((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->APB1ENR2) & ((0x1UL << (1U)))); (void)tmpreg; } while(0);
...
void HAL_I2C_MspDeInit(I2C_HandleTypeDef* i2cHandle)
{
  ...
  if(i2cHandle->Instance==((I2C_TypeDef *) ((0x40000000UL) + 0x8400UL)))
  {
    ...
    ((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->APB1ENR2) &= ~((0x1UL << (1U))));





    HAL_GPIO_DeInit(((GPIO_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x0800UL)), ((uint16_t)0x0040));
