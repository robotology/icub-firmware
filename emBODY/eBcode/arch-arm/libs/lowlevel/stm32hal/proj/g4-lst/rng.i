# 1 "../src/board/amcbldc/v120/src/rng.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 373 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../src/board/amcbldc/v120/src/rng.c" 2
# 21 "../src/board/amcbldc/v120/src/rng.c"
# 1 "../src/board/amcbldc/v120/inc\\rng.h" 1
# 28 "../src/board/amcbldc/v120/inc\\rng.h"
...
# 22 "../src/board/amcbldc/v120/src/rng.c" 2
...
void MX_RNG_Init(void)
{
  ...
  hrng.Instance = ((RNG_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x08060800UL));
  hrng.Init.ClockErrorDetection = 0x00000000U;
...
void HAL_RNG_MspInit(RNG_HandleTypeDef* rngHandle)
{
  ...
  if(rngHandle->Instance==((RNG_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x08060800UL)))
  {




    do { volatile uint32_t tmpreg; ((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->AHB2ENR) |= ((0x1UL << (26U)))); tmpreg = ((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->AHB2ENR) & ((0x1UL << (26U)))); (void)tmpreg; } while(0);
...
void HAL_RNG_MspDeInit(RNG_HandleTypeDef* rngHandle)
{
  ...
  if(rngHandle->Instance==((RNG_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x08060800UL)))
  {
    ...
    ((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->AHB2ENR) &= ~((0x1UL << (26U))));
