# 1 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_adc_ex.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 373 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_adc_ex.c" 2
# 43 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_adc_ex.c"
...
# 44 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_adc_ex.c" 2
# 136 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_adc_ex.c"
HAL_StatusTypeDef HAL_ADCEx_Calibration_Start(ADC_HandleTypeDef *hadc, uint32_t SingleDiff)
{
...
# 210 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_adc_ex.c"
uint32_t HAL_ADCEx_Calibration_GetValue(ADC_HandleTypeDef *hadc, uint32_t SingleDiff)
{
...
# 230 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_adc_ex.c"
...
# 286 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_adc_ex.c"
HAL_StatusTypeDef HAL_ADCEx_InjectedStart(ADC_HandleTypeDef *hadc)
{
  HAL_StatusTypeDef tmp_hal_status;
  ...
  else
  {
    ...
    if (tmp_hal_status == HAL_OK)
    {
      ...
      do{ (hadc)->Lock = HAL_UNLOCKED; }while (0U);
# 382 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_adc_ex.c"
      if ((( ( ((hadc->Instance) == ((ADC_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x08000100UL))) )? (((ADC_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x08000000UL))) : ( ( ((hadc->Instance) == ((ADC_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x08000500UL))) )? (((ADC_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x08000400UL))) : (hadc->Instance) ) ) == hadc->Instance)
          || (tmp_multimode_config == (0x00000000UL))
...
# 407 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_adc_ex.c"
    }
    else
    {
...
# 435 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_adc_ex.c"
HAL_StatusTypeDef HAL_ADCEx_InjectedStop(ADC_HandleTypeDef *hadc)
{
  HAL_StatusTypeDef tmp_hal_status;
...
# 490 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_adc_ex.c"
HAL_StatusTypeDef HAL_ADCEx_InjectedPollForConversion(ADC_HandleTypeDef *hadc, uint32_t Timeout)
{
  uint32_t tickstart;
...
# 627 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_adc_ex.c"
HAL_StatusTypeDef HAL_ADCEx_InjectedStart_IT(ADC_HandleTypeDef *hadc)
{
  HAL_StatusTypeDef tmp_hal_status;
  uint32_t tmp_config_injected_queue;
...
# 744 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_adc_ex.c"
      if ((( ( ((hadc->Instance) == ((ADC_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x08000100UL))) )? (((ADC_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x08000000UL))) : ( ( ((hadc->Instance) == ((ADC_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x08000500UL))) )? (((ADC_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x08000400UL))) : (hadc->Instance) ) ) == hadc->Instance)
          || (tmp_multimode_config == (0x00000000UL))
          || (tmp_multimode_config == ( (0x04UL << (0U)) | (0x02UL << (0U)) ))
          || (tmp_multimode_config == ( (0x04UL << (0U)) | (0x02UL << (0U)) | (0x01UL << (0U))))
...
# 769 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_adc_ex.c"
    }
    else
    {
...
# 800 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_adc_ex.c"
HAL_StatusTypeDef HAL_ADCEx_InjectedStop_IT(ADC_HandleTypeDef *hadc)
{
  HAL_StatusTypeDef tmp_hal_status;
...
# 867 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_adc_ex.c"
HAL_StatusTypeDef HAL_ADCEx_MultiModeStart_DMA(ADC_HandleTypeDef *hadc, uint32_t *pData, uint32_t Length)
{
  HAL_StatusTypeDef tmp_hal_status;
  ...
  else
  {
    ...
    ( ((hadc)->Instance == ((ADC_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x08000000UL))) ? ((&tmphadcSlave)->Instance = ((ADC_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x08000100UL))) : ((hadc)->Instance == ((ADC_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x08000400UL))) ? ((&tmphadcSlave)->Instance = ((ADC_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x08000500UL))) : ((&tmphadcSlave)->Instance = 0) );
    ...
    if (tmp_hal_status == HAL_OK)
    {
      ...
      tmpADC_Common = ((((hadc->Instance) == ((ADC_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x08000000UL))) || ((hadc->Instance) == ((ADC_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x08000100UL)))) ? ( (((ADC_Common_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x08000300UL))) ) : ( (((ADC_Common_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x08000700UL))) ) );
...
# 982 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_adc_ex.c"
HAL_StatusTypeDef HAL_ADCEx_MultiModeStop_DMA(ADC_HandleTypeDef *hadc)
{
  HAL_StatusTypeDef tmp_hal_status;
  uint32_t tickstart;
...
# 1142 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_adc_ex.c"
uint32_t HAL_ADCEx_InjectedGetValue(ADC_HandleTypeDef *hadc, uint32_t InjectedRank)
{
  uint32_t tmp_jdr;
...
# 1196 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_adc_ex.c"
...
# 1259 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_adc_ex.c"
HAL_StatusTypeDef HAL_ADCEx_RegularStop(ADC_HandleTypeDef *hadc)
{
  HAL_StatusTypeDef tmp_hal_status;
...
# 1317 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_adc_ex.c"
HAL_StatusTypeDef HAL_ADCEx_RegularStop_IT(ADC_HandleTypeDef *hadc)
{
  HAL_StatusTypeDef tmp_hal_status;
...
# 1377 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_adc_ex.c"
HAL_StatusTypeDef HAL_ADCEx_RegularStop_DMA(ADC_HandleTypeDef *hadc)
{
  HAL_StatusTypeDef tmp_hal_status;
...
# 1464 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_adc_ex.c"
HAL_StatusTypeDef HAL_ADCEx_RegularMultiModeStop_DMA(ADC_HandleTypeDef *hadc)
{
  HAL_StatusTypeDef tmp_hal_status;
  uint32_t tickstart;
...
# 1638 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_adc_ex.c"
HAL_StatusTypeDef HAL_ADCEx_InjectedConfigChannel(ADC_HandleTypeDef *hadc, ADC_InjectionConfTypeDef *sConfigInjected)
{
  HAL_StatusTypeDef tmp_hal_status = HAL_OK;
  ...
  do{ if((hadc)->Lock == HAL_LOCKED) { return HAL_BUSY; } else { (hadc)->Lock = HAL_LOCKED; } }while (0U);
# 1715 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_adc_ex.c"
  if ((hadc->Init.ScanConvMode == (0x00000000UL)) ||
  ...
  {
# 1762 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_adc_ex.c"
...
# 1782 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_adc_ex.c"
      if (sConfigInjected->ExternalTrigInjecConv != ((0x00000000UL)))
      {
...
# 1827 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_adc_ex.c"
  if (LL_ADC_INJ_IsConversionOngoing(hadc->Instance) == 0UL)
  {
...
# 1855 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_adc_ex.c"
  tmp_adc_is_conversion_on_going_regular = LL_ADC_REG_IsConversionOngoing(hadc->Instance);
  tmp_adc_is_conversion_on_going_injected = LL_ADC_INJ_IsConversionOngoing(hadc->Instance);
  ...
  if (LL_ADC_IsEnabled(hadc->Instance) == 0UL)
  {
    ...
    if (sConfigInjected->InjectedSingleDiff == (((0x1UL << (30U)) | (0x7FUL << (16U)))))
    {
      ...
      LL_ADC_SetChannelSamplingTime(hadc->Instance, (uint32_t)((((((((((uint32_t)sConfigInjected->InjectedChannel) & ((0x7FFFFUL << (0U)))) == 0UL) ? ( (((uint32_t)sConfigInjected->InjectedChannel) & ((0x1FUL << (26U)))) >> ((26U)) ) : ( (uint32_t)(__CLZ(__builtin_arm_rbit(((uint32_t)sConfigInjected->InjectedChannel)))) ) ) + 1UL) & 0x1FUL) <= 9UL) ? ( ((((((((uint32_t)sConfigInjected->InjectedChannel) & ((0x7FFFFUL << (0U)))) == 0UL) ? ( (((uint32_t)sConfigInjected->InjectedChannel) & ((0x1FUL << (26U)))) >> ((26U)) ) : ( (uint32_t)(__CLZ(__builtin_arm_rbit(((uint32_t)sConfigInjected->InjectedChannel)))) ) ) + 1UL) & 0x1FUL) << ((26U))) | ((0x00001UL << (0U)) << (((((((uint32_t)sConfigInjected->InjectedChannel) & ((0x7FFFFUL << (0U)))) == 0UL) ? ( (((uint32_t)sConfigInjected->InjectedChannel) & ((0x1FUL << (26U)))) >> ((26U)) ) : ( (uint32_t)(__CLZ(__builtin_arm_rbit(((uint32_t)sConfigInjected->InjectedChannel)))) ) ) + 1UL) & 0x1FUL)) | ((0x00000000UL) | (((3UL * (((((((uint32_t)sConfigInjected->InjectedChannel) & ((0x7FFFFUL << (0U)))) == 0UL) ? ( (((uint32_t)sConfigInjected->InjectedChannel) & ((0x1FUL << (26U)))) >> ((26U)) ) : ( (uint32_t)(__CLZ(__builtin_arm_rbit(((uint32_t)sConfigInjected->InjectedChannel)))) ) ) + 1UL) & 0x1FUL))) << (20UL))) ) : ( ((((((((uint32_t)sConfigInjected->InjectedChannel) & ((0x7FFFFUL << (0U)))) == 0UL) ? ( (((uint32_t)sConfigInjected->InjectedChannel) & ((0x1FUL << (26U)))) >> ((26U)) ) : ( (uint32_t)(__CLZ(__builtin_arm_rbit(((uint32_t)sConfigInjected->InjectedChannel)))) ) ) + 1UL) & 0x1FUL) << ((26U))) | ((0x00001UL << (0U)) << (((((((uint32_t)sConfigInjected->InjectedChannel) & ((0x7FFFFUL << (0U)))) == 0UL) ? ( (((uint32_t)sConfigInjected->InjectedChannel) & ((0x1FUL << (26U)))) >> ((26U)) ) : ( (uint32_t)(__CLZ(__builtin_arm_rbit(((uint32_t)sConfigInjected->InjectedChannel)))) ) ) + 1UL) & 0x1FUL)) | ((0x02000000UL) | (((3UL * ((((((((uint32_t)sConfigInjected->InjectedChannel) & ((0x7FFFFUL << (0U)))) == 0UL) ? ( (((uint32_t)sConfigInjected->InjectedChannel) & ((0x1FUL << (26U)))) >> ((26U)) ) : ( (uint32_t)(__CLZ(__builtin_arm_rbit(((uint32_t)sConfigInjected->InjectedChannel)))) ) ) + 1UL) & 0x1FUL) - 10UL))) << (20UL))) ) )), sConfigInjected->InjectedSamplingTime);
    }
...
# 2079 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_adc_ex.c"
HAL_StatusTypeDef HAL_ADCEx_MultiModeConfigChannel(ADC_HandleTypeDef *hadc, ADC_MultiModeTypeDef *multimode)
{
  HAL_StatusTypeDef tmp_hal_status = HAL_OK;
  ADC_Common_TypeDef *tmpADC_Common;
...
# 2142 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_adc_ex.c"
...
# 2192 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_adc_ex.c"
HAL_StatusTypeDef HAL_ADCEx_EnableInjectedQueue(ADC_HandleTypeDef *hadc)
{
  HAL_StatusTypeDef tmp_hal_status;
  uint32_t tmp_adc_is_conversion_on_going_regular;
...
# 2233 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_adc_ex.c"
HAL_StatusTypeDef HAL_ADCEx_DisableInjectedQueue(ADC_HandleTypeDef *hadc)
{
  HAL_StatusTypeDef tmp_hal_status;
  uint32_t tmp_adc_is_conversion_on_going_regular;
...
# 2270 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_adc_ex.c"
HAL_StatusTypeDef HAL_ADCEx_DisableVoltageRegulator(ADC_HandleTypeDef *hadc)
{
  HAL_StatusTypeDef tmp_hal_status;
...
# 2307 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_adc_ex.c"
HAL_StatusTypeDef HAL_ADCEx_EnterADCDeepPowerDownMode(ADC_HandleTypeDef *hadc)
{
  HAL_StatusTypeDef tmp_hal_status;
