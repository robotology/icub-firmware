# 1 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_cordic.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 373 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_cordic.c" 2
# 140 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_cordic.c"
...
# 141 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_cordic.c" 2
# 163 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_cordic.c"
...
# 202 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_cordic.c"
HAL_StatusTypeDef HAL_CORDIC_Init(CORDIC_HandleTypeDef *hcordic)
{
  ...
  ((void)0U);
# 233 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_cordic.c"
  ...
  hcordic->ErrorCode = ((uint32_t)0x00000000U);
  ...
  hcordic->DMADirection = ((uint32_t)0x00000000U);
...
# 294 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_cordic.c"
...
__attribute__((weak)) void HAL_CORDIC_MspInit(CORDIC_HandleTypeDef *hcordic)
{
...
__attribute__((weak)) void HAL_CORDIC_MspDeInit(CORDIC_HandleTypeDef *hcordic)
{
...
# 558 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_cordic.c"
HAL_StatusTypeDef HAL_CORDIC_Configure(CORDIC_HandleTypeDef *hcordic, CORDIC_ConfigTypeDef *sConfig)
{
  ...
  if (hcordic->State == HAL_CORDIC_STATE_READY)
  {
    ...
    (((hcordic->Instance->CSR)) = ((((((hcordic->Instance->CSR))) & (~(((0xFUL << (0U)) | (0xFUL << (4U)) | (0x7UL << (8U)) | (0x1UL << (20U)) | (0x1UL << (19U)) | (0x1UL << (22U)) | (0x1UL << (21U)))))) | ((sConfig->Function | sConfig->Precision | sConfig->Scale | sConfig->NbWrite | sConfig->NbRead | sConfig->InSize | sConfig->OutSize)))));
  ...
  else
  {
    ...
    hcordic->ErrorCode |= ((uint32_t)0x00000002U);
...
# 605 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_cordic.c"
HAL_StatusTypeDef HAL_CORDIC_Calculate(CORDIC_HandleTypeDef *hcordic, int32_t *pInBuff, int32_t *pOutBuff, uint32_t NbCalc, uint32_t Timeout)
{
  uint32_t tickstart;
  uint32_t index;
  ...
  if ((pInBuff == 0) || (pOutBuff == 0) || (NbCalc == 0U))
  {

    hcordic->ErrorCode |= ((uint32_t)0x00000001U);
  ...
  if (hcordic->State == HAL_CORDIC_STATE_READY)
  {
    ...
    for (index = (NbCalc - 1U); index > 0U; index--)
    {
      ...
      do
      {
        ...
        if (Timeout != 0xFFFFFFFFU)
        {
          if ((HAL_GetTick() - tickstart) > Timeout)
          {
            ...
            hcordic->ErrorCode = ((uint32_t)0x00000004U);
      ...
      while ((((hcordic->Instance->CSR) & ((0x1UL << (31U)))) == 0U));
...
# 699 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_cordic.c"
HAL_StatusTypeDef HAL_CORDIC_CalculateZO(CORDIC_HandleTypeDef *hcordic, int32_t *pInBuff, int32_t *pOutBuff, uint32_t NbCalc, uint32_t Timeout)
{
  uint32_t tickstart;
  uint32_t index;
...
# 791 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_cordic.c"
HAL_StatusTypeDef HAL_CORDIC_Calculate_IT(CORDIC_HandleTypeDef *hcordic, int32_t *pInBuff, int32_t *pOutBuff, uint32_t NbCalc)
{
  ...
  if (hcordic->State == HAL_CORDIC_STATE_READY)
  {
    ...
    if ((((hcordic->Instance->CSR) & ((0x1UL << (20U)))) == ((0x1UL << (20U)))))
    {
    ...
    (((hcordic)->Instance->CSR) |= ((0x1UL << (16U))));
    ...
    ((hcordic->Instance->WDATA) = ((uint32_t)*tmp_pInBuff));
...
# 882 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_cordic.c"
HAL_StatusTypeDef HAL_CORDIC_Calculate_DMA(CORDIC_HandleTypeDef *hcordic, int32_t *pInBuff, int32_t *pOutBuff, uint32_t NbCalc, uint32_t DMADirection)
{
  uint32_t sizeinbuff;
  ...
  if ((DMADirection == ((uint32_t)0x00000002U)) || (DMADirection == ((uint32_t)0x00000003U)))
  {
  ...
  if ((DMADirection == ((uint32_t)0x00000001U)) || (DMADirection == ((uint32_t)0x00000003U)))
  {
  ...
  if (hcordic->State == HAL_CORDIC_STATE_READY)
  {
    ...
    if ((DMADirection == ((uint32_t)0x00000002U)) || (DMADirection == ((uint32_t)0x00000003U)))
    {
      ...
      if ((((hcordic->Instance->CSR) & ((0x1UL << (19U)))) == ((0x1UL << (19U)))))
      {
      ...
      if (HAL_DMA_Start_IT(hcordic->hdmaOut, (uint32_t)&hcordic->Instance->RDATA, outputaddr, sizeoutbuff) != HAL_OK)
      {
        ...
        hcordic->ErrorCode |= ((uint32_t)0x00000008U);
      ...
      ((hcordic->Instance->CSR) |= ((0x1UL << (17U))));
    }
    ...
    if ((DMADirection == ((uint32_t)0x00000001U)) || (DMADirection == ((uint32_t)0x00000003U)))
    {
      ...
      ((hcordic->Instance->CSR) |= ((0x1UL << (18U))));
    }
...
# 1049 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_cordic.c"
__attribute__((weak)) void HAL_CORDIC_ErrorCallback(CORDIC_HandleTypeDef *hcordic)
{
...
__attribute__((weak)) void HAL_CORDIC_CalculateCpltCallback(CORDIC_HandleTypeDef *hcordic)
{
...
# 1098 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_cordic.c"
void HAL_CORDIC_IRQHandler(CORDIC_HandleTypeDef *hcordic)
{


  if ((((hcordic)->Instance->CSR) & ((0x1UL << (16U)))) != 0U)
  {
    if (((((hcordic)->Instance->CSR) & ((0x1UL << (31U)))) == ((0x1UL << (31U)))) != 0U)
    {
...
# 1169 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_cordic.c"
HAL_CORDIC_StateTypeDef HAL_CORDIC_GetState(CORDIC_HandleTypeDef *hcordic)
{

  return hcordic->State;
}
# 1182 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_cordic.c"
uint32_t HAL_CORDIC_GetError(CORDIC_HandleTypeDef *hcordic)
{

  return hcordic->ErrorCode;
}
# 1207 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_cordic.c"
static void CORDIC_WriteInDataIncrementPtr(CORDIC_HandleTypeDef *hcordic, int32_t **ppInBuff)
{

  ((hcordic->Instance->WDATA) = ((uint32_t) **ppInBuff));
...
# 1233 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_cordic.c"
static void CORDIC_ReadOutDataIncrementPtr(CORDIC_HandleTypeDef *hcordic, int32_t **ppOutBuff)
{

  **ppOutBuff = (int32_t)((hcordic->Instance->RDATA));
...
static void CORDIC_DMAInCplt(DMA_HandleTypeDef *hdma)
{
  ...
  if (hcordic->DMADirection == ((uint32_t)0x00000001U))
  {
