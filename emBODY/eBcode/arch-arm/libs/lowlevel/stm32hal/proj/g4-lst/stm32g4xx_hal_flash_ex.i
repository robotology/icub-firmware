# 1 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_flash_ex.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 373 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_flash_ex.c" 2
# 72 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_flash_ex.c"
...
# 73 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_flash_ex.c" 2
# 93 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_flash_ex.c"
...
# 139 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_flash_ex.c"
HAL_StatusTypeDef HAL_FLASHEx_Erase(FLASH_EraseInitTypeDef *pEraseInit, uint32_t *PageError)
{
...
# 317 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_flash_ex.c"
HAL_StatusTypeDef HAL_FLASHEx_OBProgram(FLASH_OBProgramInitTypeDef *pOBInit)
{
  HAL_StatusTypeDef status = HAL_OK;
...
# 406 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_flash_ex.c"
void HAL_FLASHEx_OBGetConfig(FLASH_OBProgramInitTypeDef *pOBInit)
{
  ...
  if ((pOBInit->WRPArea == 0x00U) || (pOBInit->WRPArea == 0x01U) ||
      (pOBInit->WRPArea == 0x02U) || (pOBInit->WRPArea == 0x04U))
  ...
  if ((pOBInit->PCROPConfig == 0x00000001U) || (pOBInit->PCROPConfig == 0x00000002U))
  ...
  if ((pOBInit->SecBank == 0x00000001U) || (pOBInit->SecBank == 0x00000002U))
...
# 466 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_flash_ex.c"
HAL_StatusTypeDef HAL_FLASHEx_EnableSecMemProtection(uint32_t Bank)
{
  ...
  if (((((FLASH_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x2000UL))->OPTR) & ((0x1UL << (22U)))) != 0U)
  {
    ...
    if ((Bank & 0x00000001U) != 0U)
    {
      ((((FLASH_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x2000UL))->CR) |= ((0x1UL << (28U))));
    }


    if ((Bank & 0x00000002U) != 0U)
    {
      ((((FLASH_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x2000UL))->CR) |= ((0x1UL << (29U))));
    }
  }
  else
...
# 512 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_flash_ex.c"
void HAL_FLASHEx_DisableDebugger(void)
{
  ((FLASH_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x2000UL))->ACR &= ~(0x1UL << (18U));
}
# 540 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_flash_ex.c"
static void FLASH_MassErase(uint32_t Banks)
{
...
# 585 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_flash_ex.c"
void FLASH_PageErase(uint32_t Page, uint32_t Banks)
{
...
# 672 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_flash_ex.c"
static HAL_StatusTypeDef FLASH_OB_WRPConfig(uint32_t WRPArea, uint32_t WRPStartOffset, uint32_t WRDPEndOffset)
{
  HAL_StatusTypeDef status;
  ...
  if (status == HAL_OK)
  {
    ...
    else if (WRPArea == 0x02U)
    {
      ((FLASH_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x2000UL))->WRP2AR = ((WRDPEndOffset << (16U)) | WRPStartOffset);
    }
    else if (WRPArea == 0x04U)
    {
      ((FLASH_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x2000UL))->WRP2BR = ((WRDPEndOffset << (16U)) | WRPStartOffset);
    }
...
# 737 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_flash_ex.c"
static HAL_StatusTypeDef FLASH_OB_RDPConfig(uint32_t RDPLevel)
{
  HAL_StatusTypeDef status;
...
# 784 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_flash_ex.c"
static HAL_StatusTypeDef FLASH_OB_UserConfig(uint32_t UserType, uint32_t UserConfig)
{
...
# 990 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_flash_ex.c"
static HAL_StatusTypeDef FLASH_OB_PCROPConfig(uint32_t PCROPConfig, uint32_t PCROPStartAddr, uint32_t PCROPEndAddr)
{
  HAL_StatusTypeDef status;
  uint32_t reg_value;
  ...
  if (status == HAL_OK)
  {
    ...
    if (((((SYSCFG_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x0000UL))->MEMRMP) & ((0x1UL << (8U)))) == 0U)
    {
      ...
      bank2_addr = (0x08000000UL) + (((((*((uint16_t *)(0x1FFF75E0UL))) == 0xFFFFU)) ? (0x200UL << 10U) : (((*((uint32_t *)(0x1FFF75E0UL))) & 0xFFFFUL) << 10U)) >> 1);
    }
    else
    {
      bank1_addr = (0x08000000UL) + (((((*((uint16_t *)(0x1FFF75E0UL))) == 0xFFFFU)) ? (0x200UL << 10U) : (((*((uint32_t *)(0x1FFF75E0UL))) & 0xFFFFUL) << 10U)) >> 1);
    ...
    if (((((FLASH_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x2000UL))->OPTR) & ((0x1UL << (22U)))) == 0U)
    {
      ...
      if ((PCROPConfig & (0x00000001U | 0x00000002U)) == 0x00000001U)
      {
        reg_value = ((PCROPStartAddr - (0x08000000UL)) >> 4);
        ...
        reg_value = ((PCROPEndAddr - (0x08000000UL)) >> 4);
      ...
      else if ((PCROPConfig & (0x00000001U | 0x00000002U)) == 0x00000002U)
      {
        reg_value = ((PCROPStartAddr - (0x08000000UL)) >> 4);
        (((((FLASH_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x2000UL))->PCROP2SR)) = ((((((((FLASH_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x2000UL))->PCROP2SR))) & (~((0x07FFFUL << (0U))))) | (reg_value))));

        reg_value = ((PCROPEndAddr - (0x08000000UL)) >> 4);
        (((((FLASH_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x2000UL))->PCROP2ER)) = ((((((((FLASH_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x2000UL))->PCROP2ER))) & (~((0x07FFFUL << (0U))))) | (reg_value))));
      }
      else
      {
...
# 1108 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_flash_ex.c"
static HAL_StatusTypeDef FLASH_OB_SecMemConfig(uint32_t SecBank, uint32_t SecSize)
{
  ...
  if (status == HAL_OK)
  {
    ...
    {
      (((((FLASH_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x2000UL))->SEC1R)) = ((((((((FLASH_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x2000UL))->SEC1R))) & (~((0xFFUL << (0U))))) | (SecSize))));
    }

    else if (SecBank == 0x00000002U)
    {
      (((((FLASH_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x2000UL))->SEC2R)) = ((((((((FLASH_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x2000UL))->SEC2R))) & (~((0xFFUL << (0U))))) | (SecSize))));
    }
    else
    {
...
# 1161 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_flash_ex.c"
static HAL_StatusTypeDef FLASH_OB_BootLockConfig(uint32_t BootLockConfig)
{
  HAL_StatusTypeDef status;
...
# 1196 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_flash_ex.c"
static void FLASH_OB_GetSecMem(uint32_t SecBank, uint32_t *SecSize)
{

  if (SecBank == 0x00000001U)
  {
    *SecSize = ((((FLASH_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x2000UL))->SEC1R) & ((0xFFUL << (0U))));
  }

  else if (SecBank == 0x00000002U)
  {
    *SecSize = ((((FLASH_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x2000UL))->SEC2R) & ((0xFFUL << (0U))));
  }
  else
  {
...
# 1222 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_flash_ex.c"
static uint32_t FLASH_OB_GetBootLock(void)
{
  return (((((FLASH_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x2000UL))->SEC1R)) & (0x1UL << (16U)));
}
# 1241 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_flash_ex.c"
static void FLASH_OB_GetWRP(uint32_t WRPArea, uint32_t *WRPStartOffset, uint32_t *WRDPEndOffset)
{
  ...
  if (WRPArea == 0x00U)
  {
    ...
    *WRDPEndOffset = (((((FLASH_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x2000UL))->WRP1AR) & ((0x7FUL << (16U)))) >> (16U));
  }
  else if (WRPArea == 0x01U)
  {
    *WRPStartOffset = ((((FLASH_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x2000UL))->WRP1BR) & ((0x7FUL << (0U))));
    *WRDPEndOffset = (((((FLASH_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x2000UL))->WRP1BR) & ((0x7FUL << (16U)))) >> (16U));
  }

  else if (WRPArea == 0x02U)
  {
    *WRPStartOffset = ((((FLASH_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x2000UL))->WRP2AR) & ((0x7FUL << (0U))));
    *WRDPEndOffset = (((((FLASH_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x2000UL))->WRP2AR) & ((0x7FUL << (16U)))) >> (16U));
  }
  else if (WRPArea == 0x04U)
  {
    *WRPStartOffset = ((((FLASH_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x2000UL))->WRP2BR) & ((0x7FUL << (0U))));
    *WRDPEndOffset = (((((FLASH_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x2000UL))->WRP2BR) & ((0x7FUL << (16U)))) >> (16U));
  }
...
# 1280 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_flash_ex.c"
static uint32_t FLASH_OB_GetRDP(void)
{
...
# 1308 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_flash_ex.c"
static uint32_t FLASH_OB_GetUser(void)
{
...
# 1327 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_flash_ex.c"
static void FLASH_OB_GetPCROP(uint32_t *PCROPConfig, uint32_t *PCROPStartAddr, uint32_t *PCROPEndAddr)
{
  uint32_t reg_value;
  uint32_t bank1_addr;
  ...
  if (((((FLASH_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x2000UL))->OPTR) & ((0x1UL << (22U)))) == 0U)
  {
    if (((*PCROPConfig) & (0x00000001U | 0x00000002U)) == 0x00000001U)
    {
      ...
      *PCROPStartAddr = (reg_value << 4) + (0x08000000UL);

      reg_value = (((((FLASH_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x2000UL))->PCROP1ER)) & (0x7FFFUL << (0U)));
      *PCROPEndAddr = (reg_value << 4) + (0x08000000UL);
    }
    else if (((*PCROPConfig) & (0x00000001U | 0x00000002U)) == 0x00000002U)
    {
      reg_value = (((((FLASH_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x2000UL))->PCROP2SR)) & (0x07FFFUL << (0U)));
      *PCROPStartAddr = (reg_value << 4) + (0x08000000UL);

      reg_value = (((((FLASH_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x2000UL))->PCROP2ER)) & (0x07FFFUL << (0U)));
      *PCROPEndAddr = (reg_value << 4) + (0x08000000UL);
    }
    else
    {
