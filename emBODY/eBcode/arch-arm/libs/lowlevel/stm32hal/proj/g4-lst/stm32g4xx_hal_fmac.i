# 1 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_fmac.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 373 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_fmac.c" 2
# 214 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_fmac.c"
...
# 215 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_fmac.c" 2
# 331 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_fmac.c"
...
# 387 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_fmac.c"
HAL_StatusTypeDef HAL_FMAC_Init(FMAC_HandleTypeDef *hfmac)
{
...
# 424 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_fmac.c"
  ...
  else
  {
    ...
    hfmac->ErrorCode = 0x00000000U;
    hfmac->State = HAL_FMAC_STATE_READY;

    status = HAL_OK;
  }

  do{ (hfmac)->Lock = HAL_UNLOCKED; }while (0U);
...
HAL_StatusTypeDef HAL_FMAC_DeInit(FMAC_HandleTypeDef *hfmac)
{
  ...
  hfmac->FilterParam = 0U;
  FMAC_ResetDataPointers(hfmac);
# 490 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_fmac.c"
...
__attribute__((weak)) void HAL_FMAC_MspInit(FMAC_HandleTypeDef *hfmac)
{
...
__attribute__((weak)) void HAL_FMAC_MspDeInit(FMAC_HandleTypeDef *hfmac)
{
...
# 805 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_fmac.c"
HAL_StatusTypeDef HAL_FMAC_FilterConfig(FMAC_HandleTypeDef *hfmac, FMAC_FilterConfigTypeDef *pConfig)
{
  return (FMAC_FilterConfig(hfmac, pConfig, 0x01U));
}
# 821 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_fmac.c"
HAL_StatusTypeDef HAL_FMAC_FilterConfig_DMA(FMAC_HandleTypeDef *hfmac, FMAC_FilterConfigTypeDef *pConfig)
{
  return (FMAC_FilterConfig(hfmac, pConfig, 0x00U));
}
# 845 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_fmac.c"
HAL_StatusTypeDef HAL_FMAC_FilterPreload(FMAC_HandleTypeDef *hfmac, int16_t *pInput, uint8_t InputSize,
                                         int16_t *pOutput, uint8_t OutputSize)
{
  return (FMAC_FilterPreload(hfmac, pInput, InputSize, pOutput, OutputSize, 0x01U));
}
# 870 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_fmac.c"
HAL_StatusTypeDef HAL_FMAC_FilterPreload_DMA(FMAC_HandleTypeDef *hfmac, int16_t *pInput, uint8_t InputSize,
                                             int16_t *pOutput, uint8_t OutputSize)
{
  return (FMAC_FilterPreload(hfmac, pInput, InputSize, pOutput, OutputSize, 0x00U));
}
# 888 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_fmac.c"
HAL_StatusTypeDef HAL_FMAC_FilterStart(FMAC_HandleTypeDef *hfmac, int16_t *pOutput, uint16_t *pOutputSize)
{
  uint32_t tmpcr = 0U;
  HAL_StatusTypeDef status;
  ...
  if (((((hfmac)->Instance->PARAM) & ((0x1UL << (31U)))) >> ((31U))) != 0U)
  {
    return HAL_ERROR;
  }
  ...
  if (hfmac->State == HAL_FMAC_STATE_READY)
  {
    ...
    if (hfmac->InputAccess == 0x01U)
    {
      tmpcr |= (0x1UL << (9U));
    }
    else if (hfmac->InputAccess == 0x03U)
    {
      tmpcr |= (0x1UL << (1U));
    }
    else
    ...
    if (hfmac->OutputAccess == 0x01U)
    {
      tmpcr |= (0x1UL << (8U));
    }
    else if (hfmac->OutputAccess == 0x03U)
    {
      tmpcr |= (0x1UL << (0U));
    }
    else
    ...
    (((hfmac->Instance->CR)) = ((((((hfmac->Instance->CR))) & (~((0x1UL << (0U)) | (0x1UL << (1U)) | (0x1UL << (8U)) | (0x1UL << (9U))))) | (tmpcr))));
    ...
    if (status == HAL_OK)
    {
      ...
      ((hfmac->Instance->PARAM) = ((uint32_t)(hfmac->FilterParam)));
    }
...
# 973 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_fmac.c"
HAL_StatusTypeDef HAL_FMAC_AppendFilterData(FMAC_HandleTypeDef *hfmac, int16_t *pInput, uint16_t *pInputSize)
{
  HAL_StatusTypeDef status;


  if ((pInput == 0) || (pInputSize == 0))
  {
    return HAL_ERROR;
  }
  if (*pInputSize == 0U)
  ...
  if (hfmac->InputAccess == 0x00U)
  {
    return HAL_ERROR;
  }


  if ((hfmac->pInputSize != 0) && (hfmac->InputCurrentSize < * (hfmac->pInputSize)))
  {
    return HAL_BUSY;
  }
...
# 1029 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_fmac.c"
HAL_StatusTypeDef HAL_FMAC_ConfigFilterOutputBuffer(FMAC_HandleTypeDef *hfmac, int16_t *pOutput, uint16_t *pOutputSize)
{
  HAL_StatusTypeDef status;


  if ((pOutput == 0) || (pOutputSize == 0))
  {
    return HAL_ERROR;
  }
  if (*pOutputSize == 0U)
  ...
  if (hfmac->OutputAccess == 0x00U)
  {
    return HAL_ERROR;
  }


  if ((hfmac->pOutputSize != 0) && (hfmac->OutputCurrentSize < * (hfmac->pOutputSize)))
  {
    return HAL_BUSY;
  }
...
# 1090 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_fmac.c"
HAL_StatusTypeDef HAL_FMAC_PollFilterData(FMAC_HandleTypeDef *hfmac, uint32_t Timeout)
{
  uint32_t tickstart;
  uint8_t inpolling;
  uint8_t inpollingover = 0U;
  uint8_t outpolling;
  uint8_t outpollingover = 0U;
  HAL_StatusTypeDef status;
  ...
  if ((hfmac->InputAccess == 0x02U) && (hfmac->pInput != 0))
  {
    inpolling = 1U;
  }
  else
  ...
  if ((hfmac->OutputAccess == 0x02U) && (hfmac->pOutput != 0))
  {
    outpolling = 1U;
  }
  else
  ...
  if (hfmac->State == HAL_FMAC_STATE_READY)
  {
    ...
    while ((HAL_GetTick() - tickstart) < Timeout)
    {
      ...
      if (inpolling != 0U)
      {
        FMAC_WriteDataIncrementPtr(hfmac, ((uint16_t) 0xFFU));
      ...
      if (outpolling != 0U)
      {
        FMAC_ReadDataIncrementPtr(hfmac, ((uint16_t) 0xFFU));
      ...
      if ((inpollingover != 0U) || (outpollingover != 0U))
      {
        break;
      }
    }
...
HAL_StatusTypeDef HAL_FMAC_FilterStop(FMAC_HandleTypeDef *hfmac)
{
  ...
  if (hfmac->State == HAL_FMAC_STATE_READY)
  {
    ...
    ((hfmac->Instance->PARAM) &= ~((0x1UL << (31U))));


    ((hfmac->Instance->CR) &= ~((0x1UL << (8U)) | (0x1UL << (9U)) | (0x1UL << (0U)) | (0x1UL << (1U))));


    if ((hfmac->InputAccess == 0x03U) && (hfmac->pInput != 0))
    {
      (*(hfmac->pInputSize)) = hfmac->InputCurrentSize;
    }
    if ((hfmac->OutputAccess == 0x03U) && (hfmac->pOutput != 0))
    {
      (*(hfmac->pOutputSize)) = hfmac->OutputCurrentSize;
    }
...
# 1290 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_fmac.c"
__attribute__((weak)) void HAL_FMAC_ErrorCallback(FMAC_HandleTypeDef *hfmac)
{
...
__attribute__((weak)) void HAL_FMAC_HalfGetDataCallback(FMAC_HandleTypeDef *hfmac)
{
...
__attribute__((weak)) void HAL_FMAC_GetDataCallback(FMAC_HandleTypeDef *hfmac)
{
...
__attribute__((weak)) void HAL_FMAC_HalfOutputDataReadyCallback(FMAC_HandleTypeDef *hfmac)
{
...
__attribute__((weak)) void HAL_FMAC_OutputDataReadyCallback(FMAC_HandleTypeDef *hfmac)
{
...
__attribute__((weak)) void HAL_FMAC_FilterConfigCallback(FMAC_HandleTypeDef *hfmac)
{
...
__attribute__((weak)) void HAL_FMAC_FilterPreloadCallback(FMAC_HandleTypeDef *hfmac)
{
...
# 1419 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_fmac.c"
void HAL_FMAC_IRQHandler(FMAC_HandleTypeDef *hfmac)
{
  uint32_t itsource;


  itsource = (((hfmac)->Instance->CR) & ((0x1UL << (0U))));
  if ((((((hfmac)->Instance->SR) & ((0x1UL << (0U)))) == ((0x1UL << (0U)))) == 0U) && (itsource != 0U))
  {
    ...
    if (hfmac->pOutput != 0)
    {
      FMAC_ReadDataIncrementPtr(hfmac, (uint16_t)((((hfmac)->Instance->YBUFCFG) & ((0xFFUL << (8U)))) >> ((8U))));
    }


    if ((hfmac->pOutput == 0) || (hfmac->OutputCurrentSize == *(hfmac->pOutputSize)))
    {
  ...
  itsource = (((hfmac)->Instance->CR) & ((0x1UL << (1U))));
  if ((((((hfmac)->Instance->SR) & ((0x1UL << (1U)))) == ((0x1UL << (1U)))) == 0U) && (itsource != 0U))
  {
    ...
    if (hfmac->pInput != 0)
    {
      FMAC_WriteDataIncrementPtr(hfmac, (uint16_t)((((hfmac)->Instance->X1BUFCFG) & ((0xFFUL << (8U)))) >> ((8U))));
    }


    if ((hfmac->pInput == 0) || (hfmac->InputCurrentSize == *(hfmac->pInputSize)))
    {
  ...
  itsource = (((hfmac)->Instance->CR) & ((0x1UL << (2U))));
  if ((((((hfmac)->Instance->SR) & ((0x1UL << (8U)))) == ((0x1UL << (8U)))) != 0U) && (itsource != 0U))
  {
    hfmac->ErrorCode |= 0x00000004U;
  }


  itsource = (((hfmac)->Instance->CR) & ((0x1UL << (3U))));
  if ((((((hfmac)->Instance->SR) & ((0x1UL << (9U)))) == ((0x1UL << (9U)))) != 0U) && (itsource != 0U))
  {
    hfmac->ErrorCode |= 0x00000002U;
  }


  itsource = (((hfmac)->Instance->CR) & ((0x1UL << (4U))));
  if ((((((hfmac)->Instance->SR) & ((0x1UL << (10U)))) == ((0x1UL << (10U)))) != 0U) && (itsource != 0U))
  {
    hfmac->ErrorCode |= 0x00000001U;
  }


  if (hfmac->ErrorCode != 0x00000000U)
  {
...
# 1535 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_fmac.c"
HAL_FMAC_StateTypeDef HAL_FMAC_GetState(FMAC_HandleTypeDef *hfmac)
{

  return hfmac->State;
}
# 1548 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_fmac.c"
uint32_t HAL_FMAC_GetError(FMAC_HandleTypeDef *hfmac)
{

  return hfmac->ErrorCode;
}
# 1576 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_fmac.c"
static HAL_StatusTypeDef FMAC_Reset(FMAC_HandleTypeDef *hfmac)
{
  uint32_t tickstart;
  ...
  ((hfmac->Instance->CR) |= ((0x1UL << (16U))));


  while (((hfmac->Instance->CR) & ((0x1UL << (16U)))) != 0U)
  {
...
# 1648 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_fmac.c"
static HAL_StatusTypeDef FMAC_FilterConfig(FMAC_HandleTypeDef *hfmac, FMAC_FilterConfigTypeDef *pConfig,
                                           uint8_t PreloadAccess)
{
  uint32_t tickstart;
  ...
  {
    (((hfmac->Instance->X1BUFCFG)) = ((((((hfmac->Instance->X1BUFCFG))) & (~(((0xFFUL << (0U)) | (0xFFUL << (8U)))))) | ((((((uint32_t)(pConfig->InputBaseAddress)) << (0U)) & (0xFFUL << (0U))) | ((((uint32_t)(pConfig->InputBufferSize)) << (8U)) & (0xFFUL << (8U))))))));
  ...
  if (pConfig->InputThreshold != 0xFFFFFFFFU)
  {

    ((void)0U);

    (((hfmac->Instance->X1BUFCFG)) = ((((((hfmac->Instance->X1BUFCFG))) & (~((0x3UL << (24U))))) | (((pConfig->InputThreshold) & (0x3UL << (24U)))))));
  ...
  {
    (((hfmac->Instance->X2BUFCFG)) = ((((((hfmac->Instance->X2BUFCFG))) & (~(((0xFFUL << (0U)) | (0xFFUL << (8U)))))) | ((((((uint32_t)(pConfig->CoeffBaseAddress)) << (0U)) & (0xFFUL << (0U))) | ((((uint32_t)(pConfig->CoeffBufferSize)) << (8U)) & (0xFFUL << (8U))))))));
  ...
  {
    (((hfmac->Instance->YBUFCFG)) = ((((((hfmac->Instance->YBUFCFG))) & (~(((0xFFUL << (0U)) | (0xFFUL << (8U)))))) | ((((((uint32_t)(pConfig->OutputBaseAddress)) << (0U)) & (0xFFUL << (0U))) | ((((uint32_t)(pConfig->OutputBufferSize)) << (8U)) & (0xFFUL << (8U))))))));
  ...
  if (pConfig->OutputThreshold != 0xFFFFFFFFU)
  {

    ((void)0U);

    (((hfmac->Instance->YBUFCFG)) = ((((((hfmac->Instance->YBUFCFG))) & (~((0x3UL << (24U))))) | (((pConfig->OutputThreshold) & (0x3UL << (24U)))))));


  }


  tmpcr = pConfig->Clip & (0x1UL << (15U));



  if ((pConfig->InputAccess == 0x01U) || (pConfig->InputAccess == 0x03U) ||
      (pConfig->OutputAccess == 0x01U) || (pConfig->OutputAccess == 0x03U))
  {
    tmpcr |= (0x1UL << (3U)) | (0x1UL << (2U));
  }


  ((hfmac->Instance->CR) = (tmpcr));
  ...
  hfmac->FilterParam = ((0x1UL << (31U)) | pConfig->Filter | ((((uint32_t)(pConfig->P)) << (0U)) & (0xFFUL << (0U))) | ((((uint32_t)(pConfig->Q)) << (8U)) & (0xFFUL << (8U))) | ((((uint32_t)(pConfig->R)) << (16U)) & (0xFFUL << (16U))));





  if ((pConfig->pCoeffB != 0) && (pConfig->CoeffBSize != 0U))
  {
    ...
    ((hfmac->Instance->PARAM) = ((((uint32_t)(pConfig->CoeffBSize) << (0U)) | ((uint32_t)(pConfig->CoeffASize) << (8U)) | ((0x2UL << (24U))) | (0x1UL << (31U)))));




    if (PreloadAccess == 0x01U)
    {

      FMAC_WritePreloadDataIncrementPtr(hfmac, &(pConfig->pCoeffB), pConfig->CoeffBSize);


      if ((pConfig->pCoeffA != 0) && (pConfig->CoeffASize != 0U))
      {
      ...
      if (FMAC_WaitOnStartUntilTimeout(hfmac, tickstart, 1000U) != HAL_OK)
      {
        hfmac->ErrorCode |= 0x00000080U;
        hfmac->State = HAL_FMAC_STATE_TIMEOUT;
        return HAL_TIMEOUT;
    ...
    else
    {
      ...
      hfmac->hdmaPreload->XferHalfCpltCallback = 0;
...
# 1858 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_fmac.c"
static HAL_StatusTypeDef FMAC_FilterPreload(FMAC_HandleTypeDef *hfmac, int16_t *pInput, uint8_t InputSize,
                                            int16_t *pOutput, uint8_t OutputSize, uint8_t PreloadAccess)
{
  uint32_t tickstart;
  ...
  if ((InputSize > ((((hfmac)->Instance->X1BUFCFG) & ((0xFFUL << (8U)))) >> ((8U)))) && (pInput != 0))
  {
    return HAL_ERROR;
  }


  if ((OutputSize > ((((hfmac)->Instance->YBUFCFG) & ((0xFFUL << (8U)))) >> ((8U)))) && (pOutput != 0))
  {
    return HAL_ERROR;
  }
  ...
  if ((pInput != 0) && (InputSize != 0U))
  {

    ((hfmac->Instance->PARAM) = ((((uint32_t)InputSize << (0U)) | ((0x1UL << (24U))) | (0x1UL << (31U)))));
  ...
  if ((pOutput != 0) && (OutputSize != 0U))
  {

    ((hfmac->Instance->PARAM) = ((((uint32_t)OutputSize << (0U)) | ((0x2UL << (24U)) | (0x1UL << (24U))) | (0x1UL << (31U)))));
  ...
  if (((((hfmac)->Instance->SR) & ((0x1UL << (8U)))) == ((0x1UL << (8U)))))
  {
    hfmac->ErrorCode |= 0x00000004U;
  }
  if (((((hfmac)->Instance->SR) & ((0x1UL << (9U)))) == ((0x1UL << (9U)))))
  {
    hfmac->ErrorCode |= 0x00000002U;
  }
  if (((((hfmac)->Instance->SR) & ((0x1UL << (10U)))) == ((0x1UL << (10U)))))
  {
    hfmac->ErrorCode |= 0x00000001U;
  }
...
# 2010 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_fmac.c"
static void FMAC_WritePreloadDataIncrementPtr(FMAC_HandleTypeDef *hfmac, int16_t **ppData, uint8_t Size)
{
  uint8_t index;
  ...
  {
    ((hfmac->Instance->WDATA) = ((((uint32_t)(*(*ppData))) & (0xFFFFUL << (0U)))));
    (*ppData)++;
  }
}
# 2029 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_fmac.c"
static HAL_StatusTypeDef FMAC_WaitOnStartUntilTimeout(FMAC_HandleTypeDef *hfmac, uint32_t Tickstart, uint32_t Timeout)
{

  while (((hfmac->Instance->PARAM) & ((0x1UL << (31U)))) != 0U)
  {
    if ((HAL_GetTick() - Tickstart) > Timeout)
    {
      hfmac->ErrorCode |= 0x00000080U;
...
# 2053 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_fmac.c"
static HAL_StatusTypeDef FMAC_AppendFilterDataUpdateState(FMAC_HandleTypeDef *hfmac, int16_t *pInput,
                                                          uint16_t *pInputSize)
{
...
# 2097 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_fmac.c"
static HAL_StatusTypeDef FMAC_ConfigFilterOutputBufferUpdateState(FMAC_HandleTypeDef *hfmac, int16_t *pOutput,
                                                                  uint16_t *pOutputSize)
{
  ...
  if ((pOutput == 0) || (pOutputSize == 0) || (*pOutputSize == 0U))
  {
  ...
  else if (hfmac->OutputAccess == 0x01U)
  {
    hfmac->pOutput = 0;
    hfmac->pOutputSize = 0;
  ...
  else if (hfmac->OutputAccess == 0x00U)
  {
    hfmac->pOutput = 0;
    hfmac->pOutputSize = 0;
    hfmac->RdState = HAL_FMAC_STATE_READY;
...
# 2151 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_fmac.c"
static void FMAC_ReadDataIncrementPtr(FMAC_HandleTypeDef *hfmac, uint16_t MaxSizeToRead)
{
  uint16_t maxsize;
  uint16_t threshold;
  ...
  if (((hfmac->Instance->SR) & ((0x1UL << (0U)))) != 0U)
  {
    return;
  }
  ...
  do
  {
    ...
    tmpvalue = ((((hfmac->Instance->RDATA)))& (0xFFFFUL << (0U)));
    *(hfmac->pOutput) = (int16_t)tmpvalue;
    hfmac->pOutput++;
    hfmac->OutputCurrentSize++;
  } while (((hfmac->Instance->SR) & ((0x1UL << (0U)))) == 0U);


  threshold = (uint16_t)((((((hfmac)->Instance->YBUFCFG) & ((0x3UL << (24U))))) == 0x00000000U)? 1U: (((((hfmac)->Instance->YBUFCFG) & ((0x3UL << (24U))))) == 0x01000000U)? 2U: (((((hfmac)->Instance->YBUFCFG) & ((0x3UL << (24U))))) == 0x02000000U)? 4U:8U) - 1U;
...
# 2215 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_fmac.c"
static void FMAC_WriteDataIncrementPtr(FMAC_HandleTypeDef *hfmac, uint16_t MaxSizeToWrite)
{
  uint16_t maxsize;
  uint16_t threshold;
  ...
  if (((hfmac->Instance->SR) & ((0x1UL << (1U)))) != 0U)
  {
    return;
  }
  ...
  do
  {
    ...
    ((hfmac->Instance->WDATA) = ((((uint32_t)(*(hfmac->pInput))) & (0xFFFFUL << (0U)))));
    hfmac->pInput++;
    hfmac->InputCurrentSize++;
  } while (((hfmac->Instance->SR) & ((0x1UL << (1U)))) == 0U);


  threshold = (uint16_t)((((((hfmac)->Instance->X1BUFCFG) & ((0x3UL << (24U))))) == 0x00000000U)? 1U: (((((hfmac)->Instance->X1BUFCFG) & ((0x3UL << (24U))))) == 0x01000000U)? 2U: (((((hfmac)->Instance->X1BUFCFG) & ((0x3UL << (24U))))) == 0x02000000U)? 4U:8U) - 1U;
...
static void FMAC_DMAFilterConfig(DMA_HandleTypeDef *hdma)
{
  ...
  else
  {
    ...
    {
      if (((hfmac->Instance->PARAM) & ((0x1UL << (31U)))) == 0U)
      {
        break;
      }
    }
...
static void FMAC_DMAFilterPreload(DMA_HandleTypeDef *hdma)
{
  ...
  else if ((hfmac->pInput != 0) && (hfmac->InputCurrentSize != 0U))
  {

    ((hfmac->Instance->PARAM) = ((((uint32_t)(hfmac->InputCurrentSize) << (0U)) | ((0x2UL << (24U)) | (0x1UL << (24U))) | (0x1UL << (31U)))));
