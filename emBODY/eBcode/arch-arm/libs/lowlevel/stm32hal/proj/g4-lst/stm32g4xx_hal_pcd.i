# 1 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_pcd.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 373 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_pcd.c" 2
# 57 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_pcd.c"
...
# 58 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_pcd.c" 2
# 90 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_pcd.c"
static HAL_StatusTypeDef PCD_EP_ISR_Handler(PCD_HandleTypeDef *hpcd);
static HAL_StatusTypeDef HAL_PCD_EP_DB_Transmit(PCD_HandleTypeDef *hpcd, PCD_EPTypeDef *ep, uint16_t wEPVal);
static uint16_t HAL_PCD_EP_DB_Receive(PCD_HandleTypeDef *hpcd, PCD_EPTypeDef *ep, uint16_t wEPVal);
# 122 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_pcd.c"
HAL_StatusTypeDef HAL_PCD_Init(PCD_HandleTypeDef *hpcd)
{
  uint8_t i;
...
# 164 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_pcd.c"
...
# 244 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_pcd.c"
...
# 967 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_pcd.c"
HAL_StatusTypeDef HAL_PCD_Start(PCD_HandleTypeDef *hpcd)
{
...
void HAL_PCD_IRQHandler(PCD_HandleTypeDef *hpcd)
{
  if (((USB_ReadInterrupts((hpcd)->Instance) & (((uint16_t)0x8000U))) == (((uint16_t)0x8000U))))
  {
  ...
  if (((USB_ReadInterrupts((hpcd)->Instance) & (((uint16_t)0x0400U))) == (((uint16_t)0x0400U))))
  {
  ...
  if (((USB_ReadInterrupts((hpcd)->Instance) & (((uint16_t)0x4000U))) == (((uint16_t)0x4000U))))
  {
    (((hpcd)->Instance->ISTR) &= (uint16_t)(~(((uint16_t)0x4000U))));
  }

  if (((USB_ReadInterrupts((hpcd)->Instance) & (((uint16_t)0x2000U))) == (((uint16_t)0x2000U))))
  {
    (((hpcd)->Instance->ISTR) &= (uint16_t)(~(((uint16_t)0x2000U))));
  }

  if (((USB_ReadInterrupts((hpcd)->Instance) & (((uint16_t)0x1000U))) == (((uint16_t)0x1000U))))
  {
  ...
  if (((USB_ReadInterrupts((hpcd)->Instance) & (((uint16_t)0x0800U))) == (((uint16_t)0x0800U))))
  {
  ...
  if (((USB_ReadInterrupts((hpcd)->Instance) & (((uint16_t)0x0080U))) == (((uint16_t)0x0080U))))
  {
  ...
  if (((USB_ReadInterrupts((hpcd)->Instance) & (((uint16_t)0x0200U))) == (((uint16_t)0x0200U))))
  {
  ...
  if (((USB_ReadInterrupts((hpcd)->Instance) & (((uint16_t)0x0100U))) == (((uint16_t)0x0100U))))
  {

    (((hpcd)->Instance->ISTR) &= (uint16_t)(~(((uint16_t)0x0100U))));
  }
}
# 1124 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_pcd.c"
...
# 1314 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_pcd.c"
HAL_StatusTypeDef HAL_PCD_DevConnect(PCD_HandleTypeDef *hpcd)
{
  do{ if((hpcd)->Lock == HAL_LOCKED) { return HAL_BUSY; } else { (hpcd)->Lock = HAL_LOCKED; } }while (0U);
  (void)USB_DevConnect(hpcd->Instance);
...
# 1360 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_pcd.c"
HAL_StatusTypeDef HAL_PCD_EP_Open(PCD_HandleTypeDef *hpcd, uint8_t ep_addr, uint16_t ep_mps, uint8_t ep_type)
{
...
# 1435 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_pcd.c"
HAL_StatusTypeDef HAL_PCD_EP_Receive(PCD_HandleTypeDef *hpcd, uint8_t ep_addr, uint8_t *pBuf, uint32_t len)
{
  PCD_EPTypeDef *ep;
...
# 1478 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_pcd.c"
HAL_StatusTypeDef HAL_PCD_EP_Transmit(PCD_HandleTypeDef *hpcd, uint8_t ep_addr, uint8_t *pBuf, uint32_t len)
{
  PCD_EPTypeDef *ep;
...
# 1641 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_pcd.c"
PCD_StateTypeDef HAL_PCD_GetState(PCD_HandleTypeDef *hpcd)
{
  return hpcd->State;
}
# 1665 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_pcd.c"
static HAL_StatusTypeDef PCD_EP_ISR_Handler(PCD_HandleTypeDef *hpcd)
{
  PCD_EPTypeDef *ep;
  ...
  while ((hpcd->Instance->ISTR & ((uint16_t)0x8000U)) != 0U)
  {
    ...
    if (epindex == 0U)
    {
      ...
      else
      {
        ...
        else if ((wEPVal & ((uint16_t)0x8000U)) != 0U)
        {
          ...
          do { uint32_t _wRegBase = (uint32_t)(hpcd->Instance); volatile uint16_t *_wRegVal; _wRegBase += (uint32_t)(hpcd->Instance)->BTABLE; _wRegVal = (volatile uint16_t *)(_wRegBase + 0x400U + ((((uint32_t)(0U) * 8U) + 6U) * 1U)); do { uint32_t wNBlocks; if (((ep->maxpacket)) == 0U) { *(_wRegVal) &= (uint16_t)~(0x1FU << 10); *(_wRegVal) |= (0x1U << 15); } else if(((ep->maxpacket)) <= 62U) { do { (wNBlocks) = (((ep->maxpacket))) >> 1; if (((((ep->maxpacket))) & 0x1U) != 0U) { (wNBlocks)++; } *((_wRegVal)) = (uint16_t)((wNBlocks) << 10); } while(0); } else { do { (wNBlocks) = (((ep->maxpacket))) >> 5; if (((((ep->maxpacket))) & 0x1fU) == 0U) { (wNBlocks)--; } *((_wRegVal)) = (uint16_t)(((wNBlocks) << 10) | (0x1U << 15)); } while(0); } } while(0); } while(0);
    ...
    else
    {
      ...
      if ((wEPVal & ((uint16_t)0x0080U)) != 0U)
      {
        ...
        if ((ep->type != 2U) ||
            ((ep->type == 2U) && ((wEPVal & ((uint16_t)0x0100U)) == 0U)))
        {

          TxByteNbre = (uint16_t)((uint32_t)(*((uint16_t *)((((uint32_t)((hpcd->Instance))->BTABLE + ((uint32_t)((ep->num)) * 8U) + 2U) * 1U) + ((uint32_t)((hpcd->Instance)) + 0x400U)))) & 0x3ffU);
...
# 1899 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_pcd.c"
...
# 1980 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_pcd.c"
                                                ...
                                                PCD_EPTypeDef *ep, uint16_t wEPVal)
{
  ...
  if ((wEPVal & ((uint16_t)0x0040U)) != 0U)
  {
    ...
    else
    {
      ...
      if (ep->xfer_fill_db == 1U)
      {
        ...
        do { if ((ep->is_in) == 0U) { do { uint32_t _wRegBase = (uint32_t)((hpcd->Instance)); volatile uint16_t *pdwReg; _wRegBase += (uint32_t)((hpcd->Instance))->BTABLE; pdwReg = (volatile uint16_t *)(_wRegBase + 0x400U + ((((uint32_t)((ep->num)) * 8U) + 2U) * 1U)); do { uint32_t wNBlocks; if ((((len))) == 0U) { *(pdwReg) &= (uint16_t)~(0x1FU << 10); *(pdwReg) |= (0x1U << 15); } else if((((len))) <= 62U) { do { (wNBlocks) = ((((len)))) >> 1; if ((((((len)))) & 0x1U) != 0U) { (wNBlocks)++; } *((pdwReg)) = (uint16_t)((wNBlocks) << 10); } while(0); } else { do { (wNBlocks) = ((((len)))) >> 5; if ((((((len)))) & 0x1fU) == 0U) { (wNBlocks)--; } *((pdwReg)) = (uint16_t)(((wNBlocks) << 10) | (0x1U << 15)); } while(0); } } while(0); } while(0); } else { if ((ep->is_in) == 1U) { do { uint32_t _wRegBase = (uint32_t)((hpcd->Instance)); volatile uint16_t *_wRegVal; _wRegBase += (uint32_t)((hpcd->Instance))->BTABLE; _wRegVal = (volatile uint16_t *)(_wRegBase + 0x400U + ((((uint32_t)((ep->num)) * 8U) + 2U) * 1U)); *_wRegVal = (uint16_t)((len)); } while(0); } } } while(0);
  ...
  else
  {
    ...
    TxByteNbre = (uint16_t)(((uint32_t)(*((uint16_t *)((((uint32_t)(((hpcd->Instance)))->BTABLE + ((uint32_t)(((ep->num))) * 8U) + 6U) * 1U) + ((uint32_t)(((hpcd->Instance))) + 0x400U)))) & 0x3ffU));
    ...
    else
    {
      ...
      if (ep->xfer_fill_db == 1U)
      {
        ...
        do { uint32_t _wBase = (uint32_t)(hpcd->Instance); volatile uint16_t *_wEPRegVal; if ((ep->is_in) == 0U) { do { uint32_t _wRegBase = (uint32_t)((hpcd->Instance)); volatile uint16_t *_wRegVal; _wRegBase += (uint32_t)((hpcd->Instance))->BTABLE; _wRegVal = (volatile uint16_t *)(_wRegBase + 0x400U + ((((uint32_t)((ep->num)) * 8U) + 6U) * 1U)); do { uint32_t wNBlocks; if ((((len))) == 0U) { *(_wRegVal) &= (uint16_t)~(0x1FU << 10); *(_wRegVal) |= (0x1U << 15); } else if((((len))) <= 62U) { do { (wNBlocks) = ((((len)))) >> 1; if ((((((len)))) & 0x1U) != 0U) { (wNBlocks)++; } *((_wRegVal)) = (uint16_t)((wNBlocks) << 10); } while(0); } else { do { (wNBlocks) = ((((len)))) >> 5; if ((((((len)))) & 0x1fU) == 0U) { (wNBlocks)--; } *((_wRegVal)) = (uint16_t)(((wNBlocks) << 10) | (0x1U << 15)); } while(0); } } while(0); } while(0); } else { if ((ep->is_in) == 1U) { _wBase += (uint32_t)(hpcd->Instance)->BTABLE; _wEPRegVal = (volatile uint16_t *)(_wBase + 0x400U + ((((uint32_t)(ep->num) * 8U) + 6U) * 1U)); *_wEPRegVal = (uint16_t)(len); } } } while(0);
