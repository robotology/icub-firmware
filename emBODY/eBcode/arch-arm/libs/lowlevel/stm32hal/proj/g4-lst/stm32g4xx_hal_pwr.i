# 1 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_pwr.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 373 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_pwr.c" 2
# 26 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_pwr.c"
...
# 27 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_pwr.c" 2
# 87 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_pwr.c"
void HAL_PWR_DeInit(void)
{
  ((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->APB1RSTR1) |= ((0x1UL << (28U))));
  ((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->APB1RSTR1) &= ~((0x1UL << (28U))));
}
# 105 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_pwr.c"
void HAL_PWR_EnableBkUpAccess(void)
{
...
# 309 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_pwr.c"
HAL_StatusTypeDef HAL_PWR_ConfigPVD(PWR_PVDTypeDef *sConfigPVD)
{
...
# 389 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_pwr.c"
void HAL_PWR_EnableWakeUpPin(uint32_t WakeUpPinPolarity)
{
  ((void)0U);
...
# 410 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_pwr.c"
void HAL_PWR_DisableWakeUpPin(uint32_t WakeUpPinx)
{
  ((void)0U);
...
# 442 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_pwr.c"
void HAL_PWR_EnterSLEEPMode(uint32_t Regulator, uint8_t SLEEPEntry)
{
...
# 517 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_pwr.c"
void HAL_PWR_EnterSTOPMode(uint32_t Regulator, uint8_t STOPEntry)
{
...
# 550 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_pwr.c"
void HAL_PWR_EnterSTANDBYMode(void)
{
...
# 576 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_pwr.c"
void HAL_PWR_EnableSleepOnExit(void)
{

  ((((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->SCR) |= (((uint32_t)(1UL << 1U))));
}
# 589 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_pwr.c"
void HAL_PWR_DisableSleepOnExit(void)
{

  ((((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->SCR) &= ~(((uint32_t)(1UL << 1U))));
}
# 603 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_pwr.c"
void HAL_PWR_EnableSEVOnPend(void)
{

  ((((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->SCR) |= (((uint32_t)(1UL << 4U))));
}
# 616 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_pwr.c"
void HAL_PWR_DisableSEVOnPend(void)
{

  ((((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->SCR) &= ~(((uint32_t)(1UL << 4U))));
}
# 630 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_pwr.c"
