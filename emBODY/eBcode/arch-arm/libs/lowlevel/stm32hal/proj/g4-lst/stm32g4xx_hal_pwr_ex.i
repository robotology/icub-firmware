# 1 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_pwr_ex.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 373 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_pwr_ex.c" 2
# 26 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_pwr_ex.c"
...
# 27 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_pwr_ex.c" 2
# 110 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_pwr_ex.c"
uint32_t HAL_PWREx_GetVoltageRange(void)
{
...
# 154 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_pwr_ex.c"
HAL_StatusTypeDef HAL_PWREx_ControlVoltageScaling(uint32_t VoltageScaling)
{
...
# 239 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_pwr_ex.c"
void HAL_PWREx_EnableBatteryCharging(uint32_t ResistorSelection)
{
  ((void)0U);
...
# 303 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_pwr_ex.c"
HAL_StatusTypeDef HAL_PWREx_EnableGPIOPullUp(uint32_t GPIO, uint32_t GPIONumber)
{
  ...
  switch (GPIO)
  {
    ...
    case 0x00000004U:
       ...
       break;
    case 0x00000005U:
       ((((PWR_TypeDef *) ((0x40000000UL) + 0x7000UL))->PUCRF) |= ((GPIONumber & 0x0000FFFFU)));
       ((((PWR_TypeDef *) ((0x40000000UL) + 0x7000UL))->PDCRF) &= ~((GPIONumber & 0x0000FFFFU)));
       break;
    case 0x00000006U:
       ((((PWR_TypeDef *) ((0x40000000UL) + 0x7000UL))->PUCRG) |= ((GPIONumber & 0x000007FFU)));
       ((((PWR_TypeDef *) ((0x40000000UL) + 0x7000UL))->PDCRG) &= ~(((GPIONumber & 0x000007FFU) & (~((0x1UL << (10U)))))));
       break;
    default:
      status = HAL_ERROR;
      break;
...
# 364 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_pwr_ex.c"
HAL_StatusTypeDef HAL_PWREx_DisableGPIOPullUp(uint32_t GPIO, uint32_t GPIONumber)
{
  HAL_StatusTypeDef status = HAL_OK;
...
# 425 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_pwr_ex.c"
HAL_StatusTypeDef HAL_PWREx_EnableGPIOPullDown(uint32_t GPIO, uint32_t GPIONumber)
{
  HAL_StatusTypeDef status = HAL_OK;
...
# 486 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_pwr_ex.c"
HAL_StatusTypeDef HAL_PWREx_DisableGPIOPullDown(uint32_t GPIO, uint32_t GPIONumber)
{
  HAL_StatusTypeDef status = HAL_OK;
...
# 536 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_pwr_ex.c"
void HAL_PWREx_EnablePullUpPullDownConfig(void)
{
  ((((PWR_TypeDef *) ((0x40000000UL) + 0x7000UL))->CR3) |= ((0x1UL << (10U))));
}
# 548 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_pwr_ex.c"
void HAL_PWREx_DisablePullUpPullDownConfig(void)
{
  ((((PWR_TypeDef *) ((0x40000000UL) + 0x7000UL))->CR3) &= ~((0x1UL << (10U))));
}
# 561 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_pwr_ex.c"
void HAL_PWREx_EnableSRAM2ContentRetention(void)
{
  ((((PWR_TypeDef *) ((0x40000000UL) + 0x7000UL))->CR3) |= ((0x1UL << (8U))));
}
# 573 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_pwr_ex.c"
void HAL_PWREx_DisableSRAM2ContentRetention(void)
{
  ((((PWR_TypeDef *) ((0x40000000UL) + 0x7000UL))->CR3) &= ~((0x1UL << (8U))));
}
# 586 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_pwr_ex.c"
void HAL_PWREx_EnablePVM1(void)
{
...
# 607 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_pwr_ex.c"
void HAL_PWREx_EnablePVM2(void)
{
...
# 675 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_pwr_ex.c"
HAL_StatusTypeDef HAL_PWREx_ConfigPVM(PWR_PVMTypeDef *sConfigPVM)
{
  HAL_StatusTypeDef status = HAL_OK;
...
# 836 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_pwr_ex.c"
void HAL_PWREx_EnableLowPowerRunMode(void)
{

  ((((PWR_TypeDef *) ((0x40000000UL) + 0x7000UL))->CR1) |= ((0x1UL << (14U))));
}
# 851 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_pwr_ex.c"
HAL_StatusTypeDef HAL_PWREx_DisableLowPowerRunMode(void)
{
  uint32_t wait_loop_index;
...
# 895 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_pwr_ex.c"
void HAL_PWREx_EnterSTOP0Mode(uint8_t STOPEntry)
{
...
# 946 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_pwr_ex.c"
void HAL_PWREx_EnterSTOP1Mode(uint8_t STOPEntry)
{
...
# 987 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_pwr_ex.c"
void HAL_PWREx_EnterSHUTDOWNMode(void)
{
...
# 1012 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_pwr_ex.c"
void HAL_PWREx_PVD_PVM_IRQHandler(void)
{
...
# 1142 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_pwr_ex.c"
void HAL_PWREx_EnableUCPDDeadBattery(void)
{

  ((((PWR_TypeDef *) ((0x40000000UL) + 0x7000UL))->CR3) &= ~((0x1UL << (14U))));
}
# 1158 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_pwr_ex.c"
void HAL_PWREx_DisableUCPDDeadBattery(void)
{
