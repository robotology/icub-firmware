# 1 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_rcc_ex.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 373 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_rcc_ex.c" 2
# 27 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_rcc_ex.c"
...
# 28 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_rcc_ex.c" 2
# 125 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_rcc_ex.c"
HAL_StatusTypeDef HAL_RCCEx_PeriphCLKConfig(RCC_PeriphCLKInitTypeDef *PeriphClkInit)
{
  ...
  if(((PeriphClkInit->PeriphClockSelection) & 0x00010000U) == 0x00010000U)
  {
    ...
    (((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->CCIPR)) = ((((((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->CCIPR))) & (~((0x3UL << (30U))))) | (PeriphClkInit->Adc345ClockSelection))));

    if(PeriphClkInit->Adc345ClockSelection == (0x1UL << (30U)))
    {
  ...
  if(((PeriphClkInit->PeriphClockSelection) & 0x00040000U) == 0x00040000U)
  {
    ...
    (((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->CCIPR2)) = ((((((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->CCIPR2))) & (~((0x3UL << (20U))))) | (PeriphClkInit->QspiClockSelection))));

    if(PeriphClkInit->QspiClockSelection == (0x2UL << (20U)))
    {
...
# 487 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_rcc_ex.c"
void HAL_RCCEx_GetPeriphCLKConfig(RCC_PeriphCLKInitTypeDef *PeriphClkInit)
{
  ...
  PeriphClkInit->PeriphClockSelection = 0x00000001U | 0x00000002U | 0x00000004U | 0x00000008U | 0x00000010U | 0x00000020U | 0x00000040U | 0x00000080U | 0x00000100U | 0x00020000U | 0x00000200U | 0x00000400U | 0x00000800U | 0x00001000U | 0x00004000U | 0x00002000U | 0x00008000U | 0x00010000U | 0x00040000U | 0x00080000U;
# 550 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_rcc_ex.c"
  ...
  PeriphClkInit->Adc345ClockSelection = (((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->CCIPR) & ((0x3UL << (30U)))));




  PeriphClkInit->QspiClockSelection = (((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->CCIPR2) & ((0x3UL << (20U)))));
...
# 650 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_rcc_ex.c"
uint32_t HAL_RCCEx_GetPeriphCLKFreq(uint32_t PeriphClk)
{
  ...
  else
  {
    ...
    case 0x00000010U:
      ...
      else if(srcclk == (0x1UL << (8U)))
      {
        frequency = HAL_RCC_GetSysClockFreq();
      }
      else if(((((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->CR) & ((0x1UL << (10U)))) == ((0x1UL << (10U))))) && (srcclk == (0x2UL << (8U))))
      {
        frequency = (16000000UL);
      }
      else if(((((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->BDCR) & ((0x1UL << (1U)))) == ((0x1UL << (1U))))) && (srcclk == ((0x1UL << (8U)) | (0x2UL << (8U)))))
      {
        frequency = (32768UL);
      }
    ...
    case 0x00010000U:
      ...
      srcclk = (((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->CCIPR) & ((0x3UL << (30U)))));
    ...
    case 0x00040000U:
      ...
      srcclk = (((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->CCIPR2) & ((0x3UL << (20U)))));
...
# 1288 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_rcc_ex.c"
void HAL_RCCEx_EnableLSECSS(void)
{
...
# 1360 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_rcc_ex.c"
void HAL_RCCEx_EnableLSCO(uint32_t LSCOSource)
{
...
# 1515 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_rcc_ex.c"
void HAL_RCCEx_CRSConfig(RCC_CRSInitTypeDef *pInit)
{
  uint32_t value;
...
# 1600 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_rcc_ex.c"
uint32_t HAL_RCCEx_CRSWaitSynchronization(uint32_t Timeout)
{
...
# 1786 "../src/driver/stm32g4-v120/src/stm32g4xx_hal_rcc_ex.c"
