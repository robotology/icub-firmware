# 1 "../src/stm32hal/stm32hal.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 373 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../src/stm32hal/stm32hal.c" 2
# 24 "../src/stm32hal/stm32hal.c"
...
extern stm32hal_res_t stm32hal_init(const stm32hal_config_t *cfg)
{
    ...
    if(0 == s_stm32hal_bsp_config.tick1ms_init)
    {
        s_stm32hal_bsp_config.tick1ms_init = s_stm32hal_bps_dummy_tick1msinit;
    }

    if(0 == s_stm32hal_bsp_config.tick1ms_get)
    {
...
# 148 "../src/stm32hal/stm32hal.c"
HAL_StatusTypeDef HAL_InitTick(uint32_t TickPriority)
{
# 159 "../src/stm32hal/stm32hal.c"
