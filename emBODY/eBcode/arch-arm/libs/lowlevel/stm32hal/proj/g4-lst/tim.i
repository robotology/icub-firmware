# 1 "../src/board/amcbldc/v120/src/tim.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 373 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../src/board/amcbldc/v120/src/tim.c" 2
# 21 "../src/board/amcbldc/v120/src/tim.c"
# 1 "../src/board/amcbldc/v120/inc\\tim.h" 1
# 28 "../src/board/amcbldc/v120/inc\\tim.h"
...
# 28 "../api/../src/board/amcbldc/v120/inc/adc.h"
# 1 "../api/../src/board/amcbldc/v120/inc/main.h" 1
...
# 22 "../src/board/amcbldc/v120/src/tim.c" 2
...
void MX_TIM1_Init(void)
{
  ...
  htim1.Instance = ((TIM_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x2C00UL));
  htim1.Init.Prescaler = 0;
  htim1.Init.CounterMode = (0x1UL << (5U));
  ...
  do{ (&htim1)->Instance->ARR = (16384); (&htim1)->Init.Period = (16384); } while(0);
  HAL_TIM_GenerateEvent(&htim1, (0x1UL << (0U)));
  ...
  sMasterConfig.MasterOutputTrigger = ((0x000004UL << (4U)) | (0x000002UL << (4U)) | (0x000001UL << (4U)));
  ...
  sBreakInputConfig.Source = 0x00000001U;
  sBreakInputConfig.Enable = 0x00000001U;
  sBreakInputConfig.Polarity = 0x00000001U;
  if (HAL_TIMEx_ConfigBreakInput(&htim1, 0x00000001U, &sBreakInputConfig) != HAL_OK)
  {
    Error_Handler();
  }
  ...
  sBreakDeadTimeConfig.BreakAFMode = 0x00000000U;
  sBreakDeadTimeConfig.Break2State = 0x00000000U;
  sBreakDeadTimeConfig.Break2Polarity = (0x1UL << (25U));
  sBreakDeadTimeConfig.Break2Filter = 0;
  sBreakDeadTimeConfig.Break2AFMode = 0x00000000U;
...
void MX_TIM2_Init(void)
{
  ...
  sConfig.EncoderMode = ((0x00002UL << (0U)) | (0x00001UL << (0U)));
  sConfig.IC1Polarity = 0x00000000U;
  sConfig.IC1Selection = (0x1UL << (0U));
  sConfig.IC1Prescaler = 0x00000000U;
  sConfig.IC1Filter = 4;
  sConfig.IC2Polarity = 0x00000000U;
  sConfig.IC2Selection = (0x1UL << (0U));
  sConfig.IC2Prescaler = 0x00000000U;
  sConfig.IC2Filter = 4;
  ...
  sEncoderIndexConfig.Polarity = 0x00000000U;
  sEncoderIndexConfig.Prescaler = 0x00000000U;
  sEncoderIndexConfig.Filter = 4;
  sEncoderIndexConfig.FirstIndexEnable = DISABLE;
  sEncoderIndexConfig.Position = 0x00000000U;
  sEncoderIndexConfig.Direction = 0x00000000U;
...
void MX_TIM3_Init(void)
{
  ...
  sConfigIC.ICPolarity = ((0x1UL << (1U)) | (0x1UL << (3U)));
  sConfigIC.ICSelection = (0x1UL << (0U));
  sConfigIC.ICPrescaler = 0x00000000U;
  sConfigIC.ICFilter = 4;
  if (HAL_TIM_IC_ConfigChannel(&htim3, &sConfigIC, 0x00000000U) != HAL_OK)
  {
    Error_Handler();
  }
  if (HAL_TIM_IC_ConfigChannel(&htim3, &sConfigIC, 0x00000004U) != HAL_OK)
  {
    Error_Handler();
  }
  if (HAL_TIM_IC_ConfigChannel(&htim3, &sConfigIC, 0x00000008U) != HAL_OK)
  {
    Error_Handler();
  }
...
void HAL_TIM_Base_MspInit(TIM_HandleTypeDef* tim_baseHandle)
{
  ...
  if(tim_baseHandle->Instance==((TIM_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x2C00UL)))
  {




    do { volatile uint32_t tmpreg; ((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->APB2ENR) |= ((0x1UL << (11U)))); tmpreg = ((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x1000UL))->APB2ENR) & ((0x1UL << (11U)))); (void)tmpreg; } while(0);
...
void HAL_TIM_Encoder_MspInit(TIM_HandleTypeDef* tim_encoderHandle)
{
  ...
  GPIO_InitTypeDef GPIO_InitStruct = {0};
  if(tim_encoderHandle->Instance==((TIM_TypeDef *) ((0x40000000UL) + 0x0000UL)))
  {
    ...
    GPIO_InitStruct.Pull = (0x00000000U);
    GPIO_InitStruct.Speed = (0x00000000U);
    GPIO_InitStruct.Alternate = ((uint8_t)0x0E);
    HAL_GPIO_Init(((GPIO_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x0000UL)), &GPIO_InitStruct);
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* timHandle)
{
  ...
  GPIO_InitTypeDef GPIO_InitStruct = {0};
  if(timHandle->Instance==((TIM_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x2C00UL)))
  {
...
void HAL_TIM_Base_MspDeInit(TIM_HandleTypeDef* tim_baseHandle)
{
  ...
  if(tim_baseHandle->Instance==((TIM_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x2C00UL)))
  {
    ...
    HAL_GPIO_DeInit(((GPIO_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x0000UL)), ((uint16_t)0x0100)|((uint16_t)0x0200)|((uint16_t)0x0400));
  ...
  else if(tim_baseHandle->Instance==((TIM_TypeDef *) ((0x40000000UL) + 0x0400UL)))
  {
    ...
    HAL_GPIO_DeInit(((GPIO_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x0000UL)), ((uint16_t)0x0010));

    HAL_GPIO_DeInit(((GPIO_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x0400UL)), ((uint16_t)0x0001)|((uint16_t)0x0010));
...
void HAL_TIM_Encoder_MspDeInit(TIM_HandleTypeDef* tim_encoderHandle)
{
  ...
  if(tim_encoderHandle->Instance==((TIM_TypeDef *) ((0x40000000UL) + 0x0000UL)))
  {
    ...
    HAL_GPIO_DeInit(((GPIO_TypeDef *) (((0x40000000UL) + 0x08000000UL) + 0x0000UL)), ((uint16_t)0x0002)|((uint16_t)0x0020)|((uint16_t)0x8000));
