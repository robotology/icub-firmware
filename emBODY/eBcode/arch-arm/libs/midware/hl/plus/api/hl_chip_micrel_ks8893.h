...
/** @fn			extern hl_result_t hl_chip_micrel_ks8893_configure(hl_eth_phymode_t targetphymode, hl_eth_phymode_t* usedphymode)
...
/** @fn			extern hl_result_t hl_chip_micrel_ks8893_mii_getphymode(hl_eth_phymode_t* usedphymode)
