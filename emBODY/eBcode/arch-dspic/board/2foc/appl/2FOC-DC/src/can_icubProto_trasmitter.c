...
extern volatile int gulp_0;
extern volatile int gulp_1;
extern volatile int gulp_2;
extern volatile int gulp_3;
...
extern void CanIcubProtoTrasmitterSendPeriodicData(void)
{
    ...
    //payload.w[0] = gulp_0;//I2Tdata.IQMeasured;
    //payload.w[1] = gulp_1;//gQEVelocity;
    //payload.w[2] = gulp_2;//gQEPosition & 0xFFFF;//VqRef;
    //payload.w[3] = gulp_3;//gQEPosition >> 16;//IqRef;
    ...
    payload.w[1] = CtrlReferences.VqRef;
