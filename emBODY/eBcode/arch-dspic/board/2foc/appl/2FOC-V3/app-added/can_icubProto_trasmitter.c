...
//extern volatile int gulp_sector;
//extern volatile int gulp_delta;
...
extern void CanIcubProtoTrasmitterSendPeriodicData(void)
{
    ...
    payload.w[2] = gQEPosition & 0xFFFF;//VqRef;//gulp_delta;//
    payload.w[3] = gQEPosition >> 16;//IqRef;//gulp_sector; //
