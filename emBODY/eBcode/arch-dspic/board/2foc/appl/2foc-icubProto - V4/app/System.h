...
extern long position_limit_lower;
extern long position_limit_upper;

extern unsigned long setpoint_watchdog_timeout;
extern int setpoint_watchdog_enabled;
extern int speed_limit_upper;
extern int speed_limit_lower;
extern int torque_q_limit_upper;
extern int torque_q_limit_lower;
extern int torque_d_limit_upper;
extern int torque_d_limit_lower;
extern int velocity_limit_upper;
extern int velocity_limit_lower;
extern unsigned char PeriodicMessageContents[4];

// max can't be arbitrary big: it depends by timer5 overflow value
#define  SETPOINT_WATCHDOG_TIMEOUT_MAX 400000
#define  SETPOINT_WATCHDOG_TIMEOUT_MIN 100000
...
#define ExternaFaultIsAsserted()  (PORTA & 0x08)
...
typedef struct eeprom_data {
  ...
  long torque_d_limit_upper;
  long torque_d_limit_lower;
  long torque_q_limit_upper;
  long torque_q_limit_lower;
  long speed_limit_upper;
  long speed_limit_lower;
  long setpoint_watchdog_timeout;
  int setpoint_watchdog_enabled;
  unsigned char periodic_command1;
  unsigned char periodic_command2;
  unsigned char periodic_command3;
  unsigned char periodic_command4;
  SFRAC16 Ira_qVq;
  short Ira_direction;
  short Ira_ramp_steepness;

  int app_data_default;
  // add user data ahead ...
  // .... 
  SFRAC16 CurLimit; // ALE
  int app_data_crc16;
