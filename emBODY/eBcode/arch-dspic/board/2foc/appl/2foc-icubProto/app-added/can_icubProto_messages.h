...
#define ICUBPROTO_POLLINGCMD_SET_VELOCITY_PIDLIMITS      98 // = 0x5c
#define ICUBPROTO_POLLINGCMD_GET_VELOCITY_PIDLIMITS      99
#define ICUBPROTO_POLLINGCMD_SET_DESIRED_CURRENT		100 // = 0x64
#define ICUBPROTO_POLLINGCMD_GET_DESIRED_CURRENT		101
