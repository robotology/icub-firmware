...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/appl-boardFinder.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
.build-conf:  ${BUILD_SUBPROJECTS}
	${MAKE} ${MAKE_OPTIONS} -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/appl-boardFinder.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
${OBJECTDIR}/_ext/1445257345/main.o: ../../app/main.c  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_CC} $(MP_EXTRA_CC_PRE)  ../../app/main.c  -o ${OBJECTDIR}/_ext/1445257345/main.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/_ext/1445257345/main.o.d"      -g -D__DEBUG -D__MPLAB_DEBUGGER_ICD3=1  -omf=elf -O0 -I"../../hal-cfg" -I"../../app" -I".." -I"../../../../env/cfg" -I"../../../../../../libs/services/common/api" -I"../../../../../../libs/services/storage/basic/api" -I"../../../../../../libs/abslayer/hal/api" -I"../../../../../../libs/abslayer/hal/src" -D_DSPIC_ -DHAL_USE_ARCH_DSPIC -DHAL_BOARD_2FOC -DHAL_DONT_INLINE -msmart-io=1 -Wall -msfr-warn=off -finline
	@${FIXDEPS} "${OBJECTDIR}/_ext/1445257345/main.o.d" $(SILENT)  -rsi ${MP_CC_DIR}../ 
	
${OBJECTDIR}/_ext/1445257345/app_body.o: ../../app/app_body.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} ${OBJECTDIR}/_ext/1445257345 
	@${RM} ${OBJECTDIR}/_ext/1445257345/app_body.o.d 
	@${RM} ${OBJECTDIR}/_ext/1445257345/app_body.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  ../../app/app_body.c  -o ${OBJECTDIR}/_ext/1445257345/app_body.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/_ext/1445257345/app_body.o.d"      -g -D__DEBUG -D__MPLAB_DEBUGGER_ICD3=1  -omf=elf -O0 -I"../../hal-cfg" -I"../../app" -I".." -I"../../../../env/cfg" -I"../../../../../../libs/services/common/api" -I"../../../../../../libs/services/storage/basic/api" -I"../../../../../../libs/abslayer/hal/api" -I"../../../../../../libs/abslayer/hal/src" -D_DSPIC_ -DHAL_USE_ARCH_DSPIC -DHAL_BOARD_2FOC -DHAL_DONT_INLINE -msmart-io=1 -Wall -msfr-warn=off -finline
	@${FIXDEPS} "${OBJECTDIR}/_ext/1445257345/app_body.o.d" $(SILENT)  -rsi ${MP_CC_DIR}../ 
...
${OBJECTDIR}/_ext/1445257345/main.o: ../../app/main.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/_ext/1445257345/main.o.d 
	@${RM} ${OBJECTDIR}/_ext/1445257345/main.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  ../../app/main.c  -o ${OBJECTDIR}/_ext/1445257345/main.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/_ext/1445257345/main.o.d"      -g -omf=elf -O0 -I"../../hal-cfg" -I"../../app" -I".." -I"../../../../env/cfg" -I"../../../../../../libs/services/common/api" -I"../../../../../../libs/services/storage/basic/api" -I"../../../../../../libs/abslayer/hal/api" -I"../../../../../../libs/abslayer/hal/src" -D_DSPIC_ -DHAL_USE_ARCH_DSPIC -DHAL_BOARD_2FOC -DHAL_DONT_INLINE -msmart-io=1 -Wall -msfr-warn=off -finline
	@${FIXDEPS} "${OBJECTDIR}/_ext/1445257345/main.o.d" $(SILENT)  -rsi ${MP_CC_DIR}../ 
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
dist/${CND_CONF}/${IMAGE_TYPE}/appl-boardFinder.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    ../eElinkerscript_applic.gld
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE)  -o dist/${CND_CONF}/${IMAGE_TYPE}/appl-boardFinder.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}      -mcpu=$(MP_PROCESSOR_OPTION)        -D__DEBUG -D__MPLAB_DEBUGGER_ICD3=1  -omf=elf -Wl,--defsym=__MPLAB_BUILD=1,--defsym=__ICD2RAM=1,--defsym=__MPLAB_DEBUG=1,--defsym=__DEBUG=1,--defsym=__MPLAB_DEBUGGER_ICD3=1,$(MP_LINKER_FILE_OPTION),--heap=4096,--stack=1024,--check-sections,--data-init,--pack-data,--handles,--isr,--no-gc-sections,--fill-upper=0,--stackguard=16,--library-path="..",--no-force-link,--smart-io,-Map="${DISTDIR}/appl-boardFinder.X.${IMAGE_TYPE}.map",--report-mem,--warn-section-align$(MP_EXTRA_LD_POST) 
	
else
dist/${CND_CONF}/${IMAGE_TYPE}/appl-boardFinder.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   ../eElinkerscript_applic.gld
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE)  -o dist/${CND_CONF}/${IMAGE_TYPE}/appl-boardFinder.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}      -mcpu=$(MP_PROCESSOR_OPTION)        -omf=elf -Wl,--defsym=__MPLAB_BUILD=1,$(MP_LINKER_FILE_OPTION),--heap=4096,--stack=1024,--check-sections,--data-init,--pack-data,--handles,--isr,--no-gc-sections,--fill-upper=0,--stackguard=16,--library-path="..",--no-force-link,--smart-io,-Map="${DISTDIR}/appl-boardFinder.X.${IMAGE_TYPE}.map",--report-mem,--warn-section-align$(MP_EXTRA_LD_POST) 
	${MP_CC_DIR}\\xc16-bin2hex dist/${CND_CONF}/${IMAGE_TYPE}/appl-boardFinder.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} -a  -omf=elf 
