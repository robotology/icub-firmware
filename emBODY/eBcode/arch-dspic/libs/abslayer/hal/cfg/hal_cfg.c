...
const hal_cfg_t *hal_cfgMINE = &s_cfg;

#if 1
//   this function is kept as it is in order to maintain the same api as in arm-cmx micros.
//   however, we can remove it, because a SysTick_Handler() is weakly defined inside hal_dspic_sys.c
