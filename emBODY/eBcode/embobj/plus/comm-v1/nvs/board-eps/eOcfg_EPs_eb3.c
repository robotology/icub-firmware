...
const EOconstvector eo_cfg_EPs_vectorof_eb3_object = 
{
...
const EOconstvector* const eo_cfg_EPs_vectorof_eb3 = &eo_cfg_EPs_vectorof_eb3_object;

const eOuint16_fp_uint16_t eo_cfg_nvsEP_eb3_fptr_hashfunction_ep2index = eo_cfg_nvsEP_eb3_hashfunction_ep2index;
...
static uint8_t s_hashtable[64] = 
{
    ...
    // 16-31: MC endpoint_mc_rightupperarm is 0x13 and is in pos 2
    0xff, 0xff, 0xff,    2, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 
    // 32-47: AS endpoint_as_rightupperarm is 0x23 and is in pos 3.
    0xff, 0xff, 0xff,    3, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
    // 48-63: 
