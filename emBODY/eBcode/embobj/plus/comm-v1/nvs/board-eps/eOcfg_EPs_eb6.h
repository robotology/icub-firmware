...
// - include guard ----------------------------------------------------------------------------------------------------
#ifndef _EOCFG_EPS_EB6_H_
#define _EOCFG_EPS_EB6_H_
...
/** @file       eOcfg_EPs_eb6.h
	@brief      This header file contains a const configuration for the endpoints of board EB6 (left leg, upper)
...
// if not NULL it contains a mapping from EPs to index inside eo_cfg_EPs_vectorof_eb6
...
/** @fn         extern void* eo_cfg_nvsEP_eb6_Get_remotelyownedRAM(eOnvEP_t ep, eOnvscfgOwnership_t ownership)
...
/** @fn         extern void* eo_cfg_nvsEP_eb6_Get_locallyownedRAM(eOnvEP_t ep)
