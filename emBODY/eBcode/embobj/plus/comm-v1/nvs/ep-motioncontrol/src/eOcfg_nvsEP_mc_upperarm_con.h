...
#ifndef _EOCFG_NVSEP_MC_UPPERARM_CON_H_
#define _EOCFG_NVSEP_MC_UPPERARM_CON_H_




/** @file       eOcfg_nvsEP_mc_upperarm_con.h
...
/** @typedef    typedef enum eo_cfg_nvsEP_mc_upperarm_con_jointNumber_t
...
{
    jointUpperArm_00 = 0,   
    jointUpperArm_01, jointUpperArm_02, jointUpperArm_03
} eo_cfg_nvsEP_mc_upperarm_con_jointNumber_t;

enum { jointUpperArm_TOTALnumber = 4}; 
...
{
    motorUpperArm_00 = 0,   
    motorUpperArm_01, motorUpperArm_02, motorUpperArm_03
} eo_cfg_nvsEP_mc_upperarm_con_motorNumber_t;

enum { motorUpperArm_TOTALnumber = 4}; 
...
} eo_cfg_nvsEP_mc_upperarm_t;   EO_VERIFYsizeof(eo_cfg_nvsEP_mc_upperarm_t, 824);

    
// - declaration of extern public variables, ... but better using use _get/_set instead -------------------------------

//we prefer to omit this to save rom space: use the default joint and motor values instead ....
//extern const eo_cfg_nvsEP_mc_upperarm_t eo_cfg_nvsEP_mc_upperarm_default;
...
/** @fn         extern eOnvID_t eo_cfg_nvsEP_mc_upperarm_joint_NVID_Get(eo_cfg_nvsEP_mc_upperarm_con_jointNumber_t j, eo_cfg_nvsEP_mc_upperarm_con_jointNVindex_t jnvindex)
...
/** @fn         extern eOnvID_t eo_cfg_nvsEP_mc_upperarm_motor_NVID_Get(eo_cfg_nvsEP_mc_upperarm_con_motorNumber_t m, eo_cfg_nvsEP_mc_upperarm_con_motorNVindex_t mnvindex)
...
extern const EOconstvector* const eo_cfg_nvsEP_mc_upperarm_constvector_of_treenodes_EOnv_con;

// if not NULL it contains a mapping from IDs to index inside eo_cfg_nvsEP_mc_upperarm_constvector_of_treenodes_EOnv_con
extern const eOuint16_fp_uint16_t eo_cfg_nvsEP_mc_upperarm_fptr_hashfunction_id2index;

// the size of the ram to be used
#define EOK_cfg_nvsEP_mc_upperarm_RAMSIZE                                            (sizeof(eo_cfg_nvsEP_mc_upperarm_t));
