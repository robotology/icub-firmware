...
static uint16_t s_eoprot_b06_ep2index(eOnvEP8_t ep);

static eObool_t s_eoprot_b06_isvariableproxied(eOnvID32_t id);
...
extern eOresult_t eoprot_b06_Initialise(eObool_t islocal)
{
    ...
    eoprot_config_proxied_variables(eoprot_b06_boardnumber, s_eoprot_b06_isvariableproxied);
