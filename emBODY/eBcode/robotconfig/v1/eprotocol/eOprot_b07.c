...
static uint16_t s_eoprot_b07_ep2index(eOnvEP8_t ep);

static eObool_t s_eoprot_b07_isvariableproxied(eOnvID32_t id);
...
extern eOresult_t eoprot_b07_Initialise(eObool_t islocal)
{
    ...
    eoprot_config_proxied_variables(eoprot_b07_boardnumber, s_eoprot_b07_isvariableproxied);
