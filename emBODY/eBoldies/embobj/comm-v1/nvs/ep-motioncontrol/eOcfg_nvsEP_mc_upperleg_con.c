...
#define CMACRO_EXTERNALPREFIX_CONST                s_eo_cfg_nvsEP_mc_upperleg_con_
...
EOtreenode eo_cfg_nvsEP_mc_upperleg_tree_con[] =
{
    ...
    {   // 0
        ...
        {   // 8
            EO_INIT(.data)      (void*)&eo_cfg_nvsEP_mc_upperleg_j00_jconfig__holder01FFU00,
        ...
        {   //10
            EO_INIT(.data)      (void*)&eo_cfg_nvsEP_mc_upperleg_j00_jconfig__encoderconversionfactor,
            EO_INIT(.index)     Jindex( 0,10),
            EO_INIT(.nchildren) 0,
            EO_INIT(.dchildren) NULL
        },   
        {   //11
            EO_INIT(.data)      (void*)&eo_cfg_nvsEP_mc_upperleg_j00_jconfig__encoderconversionoffset,
    ...
    {   //28
        EO_INIT(.data)      (void*)&eo_cfg_nvsEP_mc_upperleg_j00_jcmmnds__controlmode,
    ...
    {   // 0
        ...
        {   // 8
            EO_INIT(.data)      (void*)&eo_cfg_nvsEP_mc_upperleg_j01_jconfig__holder01FFU00,
        ...
        {   //10
            EO_INIT(.data)      (void*)&eo_cfg_nvsEP_mc_upperleg_j01_jconfig__encoderconversionfactor,
            EO_INIT(.index)     Jindex( 1,10),
            EO_INIT(.nchildren) 0,
            EO_INIT(.dchildren) NULL
        },   
        {   //11
            EO_INIT(.data)      (void*)&eo_cfg_nvsEP_mc_upperleg_j01_jconfig__encoderconversionoffset,
    ...
    {   //28
        EO_INIT(.data)      (void*)&eo_cfg_nvsEP_mc_upperleg_j01_jcmmnds__controlmode,
    ...
    {   // 0
        ...
        {   // 8
            EO_INIT(.data)      (void*)&eo_cfg_nvsEP_mc_upperleg_j02_jconfig__holder01FFU00,
        ...
        {   //10
            EO_INIT(.data)      (void*)&eo_cfg_nvsEP_mc_upperleg_j02_jconfig__encoderconversionfactor,
            EO_INIT(.index)     Jindex( 2,10),
            EO_INIT(.nchildren) 0,
            EO_INIT(.dchildren) NULL
        },   
        {   //11
            EO_INIT(.data)      (void*)&eo_cfg_nvsEP_mc_upperleg_j02_jconfig__encoderconversionoffset,
    ...
    {   //28
        EO_INIT(.data)      (void*)&eo_cfg_nvsEP_mc_upperleg_j02_jcmmnds__controlmode,
    ...
    {   // 0
        ...
        {   // 8
            EO_INIT(.data)      (void*)&eo_cfg_nvsEP_mc_upperleg_j03_jconfig__holder01FFU00,
        ...
        {   //10
            EO_INIT(.data)      (void*)&eo_cfg_nvsEP_mc_upperleg_j03_jconfig__encoderconversionfactor,
            EO_INIT(.index)     Jindex( 3,10),
            EO_INIT(.nchildren) 0,
            EO_INIT(.dchildren) NULL
        },   
        {   //11
            EO_INIT(.data)      (void*)&eo_cfg_nvsEP_mc_upperleg_j03_jconfig__encoderconversionoffset,
    ...
    {   //28
        EO_INIT(.data)      (void*)&eo_cfg_nvsEP_mc_upperleg_j03_jcmmnds__controlmode,
