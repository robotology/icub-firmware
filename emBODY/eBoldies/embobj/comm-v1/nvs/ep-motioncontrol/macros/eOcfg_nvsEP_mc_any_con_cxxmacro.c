...
//    EO_INIT(.resetval)  (const void*)&eo_cfg_nvsEP_mc_any_con_cxxdefault_defaultvalue.config,
    EO_INIT(.resetval)  (const void*)&CMACRO_CONST(CMACRO_EXTERNALPREFIX_CONST, defaultvalue.config),
...
//    EO_INIT(.resetval)  (const void*)&eo_cfg_nvsEP_mc_any_con_cxxdefault_defaultvalue.config.durationofctrlloop,
    EO_INIT(.resetval)  (const void*)&CMACRO_CONST(CMACRO_EXTERNALPREFIX_CONST, defaultvalue.config.durationofctrlloop),
...
//    EO_INIT(.resetval)  (const void*)&eo_cfg_nvsEP_mc_any_con_cxxdefault_defaultvalue.status,
    EO_INIT(.resetval)  (const void*)&CMACRO_CONST(CMACRO_EXTERNALPREFIX_CONST, defaultvalue.status),
...
//    EO_INIT(.resetval)  (const void*)&eo_cfg_nvsEP_mc_any_con_cxxdefault_defaultvalue.status.alljomoinitted,
    EO_INIT(.resetval)  (const void*)&CMACRO_CONST(CMACRO_EXTERNALPREFIX_CONST, defaultvalue.status.alljomoinitted),
...
//    EO_INIT(.resetval)  (const void*)&eo_cfg_nvsEP_mc_any_con_cxxdefault_defaultvalue.cmmnds.go2stateofcontroller,
    EO_INIT(.resetval)  (const void*)&CMACRO_CONST(CMACRO_EXTERNALPREFIX_CONST, defaultvalue.cmmnds.go2stateofcontroller),
