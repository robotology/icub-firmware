...
extern unsigned char ReadViaI2C(unsigned char Channel,unsigned char DeviceAddress, const unsigned int RegisterStartAddress, const unsigned char NumberOfRegistersToRead, unsigned short *DataBuffer1, unsigned short *DataBuffer2, unsigned short *DataBuffer3, unsigned short *DataBuffer4, const unsigned int OffsetInBuffer);
