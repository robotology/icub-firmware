...
{ 
    ...
    static void osalIdleTask(void)
    {
        ...
        workerFptr onidle = thesystem.pImpl->osalIdleActivity;
    ...
    {
        embot::sys::theScheduler &thesystem = embot::sys::theScheduler::getInstance();        
        workerFptr onfatalerror = thesystem.pImpl->osalFatalErrorActivity;
    ...
    workerFptr osalLauncher;
    workerFptr osalIdleActivity;   
    workerFptr osalFatalErrorActivity;
...
bool Timer::start(relTime countdown, Type type, Action &onexpiry)
{
...
{    
    ...
    EOMtask *eomtask0;
    void *param;
    Task::startupFptr startupFP0;
    Task::oneventFptr oneventFP0; 
    Task::onmessageFptr onmessageFP0; 
    Task::periodicFptr periodicFP0;
    Time timeOfLatestTrigger;
    ...
    static void eventrun0(EOMtask *tsk, std::uint32_t evtmsgper)
    {
        ...
        {
            t->pImpl0->oneventFP0(t, static_cast<Task::Event>(evtmsgper), t->pImpl0->param); 
        }    
    }  
    ...
    static void messagerun0(EOMtask *tsk, std::uint32_t evtmsgper)
    {
        ...
        {
            t->pImpl0->onmessageFP0(t, static_cast<Task::Message>(evtmsgper), t->pImpl0->param); 
        }    
    }    
...
EventTask::EventTask(Task::startupFptr startup, Task::oneventFptr onevent, std::uint32_t stacksize, Priority priority, relTime timeout, void *param)
{
    pImpl0->taskParent = this;    
...
bool EventTask::setEvent(Task::Event event)
{
...
bool EventTask::setMessage(Task::Message message, relTime timeout)
{
    return false;
}
...
bool EventTask::init(Task::startupFptr startup, Task::oneventFptr onevent, std::uint32_t stacksize, Priority priority, relTime timeout, void *param)
{
...
MessageTask::MessageTask(Task::startupFptr startup, Task::onmessageFptr onmessage, std::uint32_t stacksize, Priority priority, std::uint8_t messagequeuecapacity, relTime timeout, void *param)
{
    pImpl0->taskParent = this;     
...
bool MessageTask::setEvent(Task::Event event)
{
    return false;
}  


bool MessageTask::setMessage(Task::Message message, relTime timeout)
{
...
bool MessageTask::init(Task::startupFptr startup, Task::onmessageFptr onmessage, std::uint32_t stacksize, Priority priority, std::uint8_t messagequeuecapacity, relTime timeout, void *param)
{
    pImpl0->startupFP0 = startup;
...
PeriodicTask::PeriodicTask(Task::startupFptr startup, Task::periodicFptr periodicactivity, std::uint32_t stacksize, Priority priority, relTime period, void *param)
{
    pImpl0->taskParent = this;     
...
bool PeriodicTask::setEvent(Task::Event event)
{
    return false;
}  

bool PeriodicTask::setMessage(Task::Message message, relTime timeout)
{
    return false;
}


bool PeriodicTask::init(Task::startupFptr startup, Task::periodicFptr periodicactivity, std::uint32_t stacksize, Priority priority, relTime period, void *param)
{
    pImpl0->startupFP0 = startup;
