...
static const hl_i2c_mapping_t s_hl_i2c_mapping =
{
    ...
    {   
        {   // hl_i2c1 
            ...
            .sda = 
            {
                .gpio   = { .port = hl_gpio_portB,      .pin = hl_gpio_pin7 },
                .af32   = GPIO_AF_I2C1            
            } 
        }, 
        {   // hl_i2c2 
        ...
        {   // hl_i2c3 
            .scl = 
            {
                .gpio   = { .port = hl_gpio_portH,      .pin = hl_gpio_pin7 },
                .af32   = GPIO_AF_I2C3      
            }, 
            .sda = 
            {
                .gpio   = { .port = hl_gpio_portH,      .pin = hl_gpio_pin8 },
                .af32   = GPIO_AF_I2C3      
            } 
        }        
    }       
...
static const hl_can_mapping_t s_hl_can_mapping =
{
    .supportedmask      = (1 << hl_can1) | (0 << hl_can2),
    .gpiomap            =
    {   
        {   // hl_can1 
            .rx = 
...
static const hl_timer_mapping_t s_hl_timer_mapping =
{
    .supportedmask      = (0 << hl_timer1) | (0 << hl_timer2) | (1 << hl_timer3) | (1 << hl_timer4) | 
                          (0 << hl_timer5) | (1 << hl_timer6) | (1 << hl_timer7) | (0 << hl_timer8),
};
...
static const hl_spi_mapping_t s_hl_spi_mapping =
{
    .supportedmask      = (1 << hl_spi1) | (1 << hl_spi2) ,
    .gpiomap            =
    { 
       {    // hl_spi1 
            .sck = 
        ...
        {   // hl_spi2 
            .sck = 
            {
                .gpio   = { .port = hl_gpio_portI,      .pin = hl_gpio_pin1 }, 
                .af32   = GPIO_AF_SPI2        
            }, 
            .miso = 
            {
            ...
            .mosi = 
            {
                .gpio   = { .port = hl_gpio_portI,      .pin = hl_gpio_pin3 }, 
                .af32   = GPIO_AF_SPI2               
            }             
        },         
    } 
