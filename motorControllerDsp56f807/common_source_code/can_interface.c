...
#define CAN_TEMP16 ikk
    ...
    VERSION == 0x0219 || VERSION == 0x0250 || VERSION == 0x0251 || VERSION == 0x0252 || VERSION == 0x0254 || VERSION == 0x0257 
			...
			else if (_canmsg.CAN_ID_class == ICUBCANPROTO_CLASS_POLLING_MOTORCONTROL)
			{
				...
				HANDLE_MSG (ICUBCANPROTO_POL_MC_CMD__CONTROLLER_RUN, CAN_CONTROLLER_RUN_HANDLER)
				HANDLE_MSG (ICUBCANPROTO_POL_MC_CMD__CONTROLLER_IDLE, CAN_CONTROLLER_IDLE_HANDLER)
				...
				HANDLE_MSG (ICUBCANPROTO_POL_MC_CMD__ENABLE_PWM_PAD, CAN_ENABLE_PWM_PAD_HANDLER)
				HANDLE_MSG (ICUBCANPROTO_POL_MC_CMD__DISABLE_PWM_PAD, CAN_DISABLE_PWM_PAD_HANDLER)
