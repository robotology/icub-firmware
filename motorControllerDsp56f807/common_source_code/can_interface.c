...
#define CAN_TEMP16 ikk
			...
			else if (_canmsg.CAN_ID_class == CLASS_POLLING_DSP)
			{
				...
				HANDLE_MSG (CAN_SET_DEBUG_PARAM_1, CAN_SET_DEBUG_PARAM_1_HANDLER) // TO BE REMOVED
				HANDLE_MSG (CAN_GET_DEBUG_PARAM_1, CAN_GET_DEBUG_PARAM_1_HANDLER) // TO BE REMOVED
				HANDLE_MSG (CAN_SET_DEBUG_PARAM_2, CAN_SET_DEBUG_PARAM_2_HANDLER) // TO BE REMOVED
				HANDLE_MSG (CAN_GET_DEBUG_PARAM_2, CAN_GET_DEBUG_PARAM_2_HANDLER) // TO BE REMOVED
				HANDLE_MSG (CAN_SET_DEBUG_PARAM_3, CAN_SET_DEBUG_PARAM_3_HANDLER) // TO BE REMOVED
				HANDLE_MSG (CAN_GET_DEBUG_PARAM_3, CAN_GET_DEBUG_PARAM_3_HANDLER) // TO BE REMOVED
				HANDLE_MSG (CAN_SET_DEBUG_PARAM_4, CAN_SET_DEBUG_PARAM_4_HANDLER) // TO BE REMOVED
				HANDLE_MSG (CAN_GET_DEBUG_PARAM_4, CAN_GET_DEBUG_PARAM_4_HANDLER) // TO BE REMOVED
