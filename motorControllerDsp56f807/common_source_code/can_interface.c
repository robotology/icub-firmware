...
#define CAN_TEMP16 ikk
    ...
    VERSION == 0x0219 || VERSION == 0x0250 || VERSION == 0x0251 || VERSION == 0x0252 || VERSION == 0x0254 || VERSION == 0x0257 
			...
			else if (_canmsg.CAN_ID_class == CLASS_POLLING_DSP)
			{
				...
				HANDLE_MSG (CAN_SET_TORQUE_SOURCE, CAN_SET_TORQUE_SOURCE_HANDLER)
				...
				HANDLE_MSG (CAN_SET_OPTICAL_ENC_RATIO, CAN_SET_OPTICAL_ENC_RATIO_HANDLER)
				HANDLE_MSG (CAN_SET_POS_STICTION_PARAMS, CAN_SET_POS_STICTION_PARAMS_HANDLER)
				HANDLE_MSG (CAN_GET_POS_STICTION_PARAMS, CAN_GET_POS_STICTION_PARAMS_HANDLER)
				HANDLE_MSG (CAN_SET_TORQUE_STICTION_PARAMS, CAN_SET_TORQUE_STICTION_PARAMS_HANDLER)
				HANDLE_MSG (CAN_GET_TORQUE_STICTION_PARAMS, CAN_GET_TORQUE_STICTION_PARAMS_HANDLER)
				
				HANDLE_MSG (CAN_SET_BACKEMF_PARAMS, CAN_SET_BACKEMF_PARAMS_HANDLER)
				HANDLE_MSG (CAN_GET_BACKEMF_PARAMS, CAN_GET_BACKEMF_PARAMS_HANDLER)

				HANDLE_MSG (CAN_SET_MODEL_PARAMS, CAN_SET_MODEL_PARAMS_HANDLER)
				HANDLE_MSG (CAN_GET_MODEL_PARAMS, CAN_GET_MODEL_PARAMS_HANDLER)
				HANDLE_MSG (CAN_SET_OPENLOOP_PARAMS, CAN_SET_OPENLOOP_PARAMS_HANDLER)
				HANDLE_MSG (CAN_GET_OPENLOOP_PARAMS, CAN_GET_OPENLOOP_PARAMS_HANDLER)
