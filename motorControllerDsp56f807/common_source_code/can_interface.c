...
#if VERSION == 0x0119 || VERSION == 0x0150 || VERSION == 0x0151 || VERSION == 0x0152 || VERSION == 0x0154 || VERSION == 0x0157 || VERSION == 0x0140 
     || VERSION == 0x0147 || VERSION==0x0250 || VERSION == 0x0251 || VERSION==0x0257 || VERSION==0x0252 || VERSION==0x0254  
