...
extern Int32 _max_position_enc[JN];     // max allowed position for encoder while controlling with absolute position sensors
extern Int32 _min_position_enc[JN];     // min allowed position for encoder while controlling with absolute position sensors
