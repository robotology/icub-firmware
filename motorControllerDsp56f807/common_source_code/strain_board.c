...
void init_strain (void)
{
	...
	//default listening channels for all firmware versions 
		...
		{
		  	_selected_strain_id[0] = WDT_JNT_STRAIN_12;
		    _selected_strain_id[1] = WDT_JNT_STRAIN_12;
	  	...
	  	{
		  	_selected_strain_id[0] = WDT_JNT_STRAIN_11;
		  	_selected_strain_id[1] = WDT_JNT_STRAIN_11;
		  	_selected_strain_chan[0] = 2;
		    _selected_strain_chan[1] = 3;	  		
	  	}  
		...
		{	
			_selected_strain_id[0] = WDT_JNT_STRAIN_12; //wrist pronosupination
	  		_selected_strain_id[1] = WDT_JNT_STRAIN_11; //wrist pitch disabled
	  		_selected_strain_id[2] = WDT_JNT_STRAIN_11; //wrist yaw   disabled
		...
		{
			_selected_strain_id[0] = WDT_JNT_STRAIN_12; //wrist pronosupination
	  		_selected_strain_id[1] = WDT_JNT_STRAIN_11; //@@@TODO differential 1 for icubV2
	  		_selected_strain_id[2] = WDT_JNT_STRAIN_11; //@@@TODO differential wrist 2 for icubV2
	  		_selected_strain_id[3] = -1;                //fingers disabled
	  		_selected_strain_chan[0] = 4;
	  		_selected_strain_chan[1] = 0; 
	  		_selected_strain_chan[2] = 1;
