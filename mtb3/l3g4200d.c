...
#define L3G_I2C_CHANNEL 0x00 //for the palm
#define L3G_I2C_SDANUM 0x02
...
{
	unsigned char rbuf;
	L3GI2COps.i2c_read(L3G_I2C_CHANNEL,L3G_I2C_SDANUM, L3G_I2C_ADDR,reg, &rbuf );
...
{
	L3GI2COps.i2c_burst(L3G_I2C_CHANNEL, L3G_I2C_SDANUM, L3G_I2C_ADDR,reg|0x80, naxis, data);
}
