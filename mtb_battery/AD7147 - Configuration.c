...
void ConfigAD7147(unsigned char Channel, unsigned int i,unsigned int pw_control_val, unsigned int * convalue)
{
	...
	ConfigBuffer[STAGE_COMPLETE_INT_EN]=0x7ff;//0x800;//0x0001;//0x0001;
...
void ConfigAD7147_ALL(unsigned char Channel,unsigned int i,unsigned int pw_control_val, unsigned int *convalue)
{
	...
	//=============================================
	ConfigBuffer[0]=0xFFAA;//0xFFFF; // 1 2 3 4
	ConfigBuffer[1]=0x3FFF;//0x3FFF;
	ConfigBuffer[2]=convalue[1];
	ConfigBuffer[3]=0x2626;
	ConfigBuffer[4]=50;
	ConfigBuffer[5]=50;
	ConfigBuffer[6]=100;
	...
	//=============================================
	ConfigBuffer[0]=0xEAFF;//0xFFFF; // 5 6 7 9
	ConfigBuffer[1]=0x3FF2;//0x3FFF;
	ConfigBuffer[2]=convalue[1];
	ConfigBuffer[3]=0x2626;
	ConfigBuffer[4]=50;
	ConfigBuffer[5]=50;
	...
	//=============================================
	ConfigBuffer[0]=0xFFFF;//0xFFFF; // 8 10 11 12
	ConfigBuffer[1]=0x3EAB;//0x3FFF;
	ConfigBuffer[2]=convalue[1];
	ConfigBuffer[3]=0x2626;
	ConfigBuffer[4]=50;
	ConfigBuffer[5]=50;
	...
	//Calibration configuration
	ConfigBuffer[AMB_COMP_CTRL0]=0x220;//0x220;
	ConfigBuffer[AMB_COMP_CTRL1]=0x14C8;//0x14c8
	ConfigBuffer[AMB_COMP_CTRL2]=0x0;//0xBFF;//0x0832;
	//Interrupt configuration
	ConfigBuffer[STAGE_LOW_INT_EN]=0x0000;
	ConfigBuffer[STAGE_HIGH_INT_EN]=0x0000;
	ConfigBuffer[STAGE_COMPLETE_INT_EN]=0x007;//0x0001;
	ConfigBuffer[STAGE_LOW_LIMIT_INT]=0x0000;
	ConfigBuffer[STAGE_HIGH_LIMIT_INT]=0x0000;
