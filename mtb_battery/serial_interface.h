...
#define SERIAL_TX_SOFTWARE_BUFFER_SIZE 10
#define SERIAL_BOARD_ID 1
#define CURRENT_BOARD_TYPE       6   //DSPic

// CAN RX message buffer
#define SERIAL_RX_SOFTWARE_BUFFER_SIZE 10
...
void COM_Init();
unsigned char COM_send(unsigned int MessageID,unsigned char FrameType,unsigned char Length,unsigned char *Data);
void COM_interruptTx (void);
void COM_interruptRx (void);
int  COM_getRxbufferIndex();
void COM_RxbufferIndex_dec(); //canRxBufferIndex --
int COM_handleRx    (unsigned int board_id);
